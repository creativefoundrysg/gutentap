import { createElementBlock as Z, openBlock as F, normalizeClass as Wt, renderSlot as Bl, createCommentVNode as it, defineComponent as _r, h as pn, Teleport as bf, ref as qs, getCurrentInstance as wf, watchEffect as kf, nextTick as xf, unref as Cf, onBeforeUnmount as Ks, onMounted as zc, reactive as Hc, markRaw as Vc, customRef as Sf, Fragment as Ct, renderList as St, withModifiers as Te, createElementVNode as Ke, createTextVNode as Mf, toDisplayString as Tf, resolveComponent as hr, createBlock as Ze, createVNode as je, withCtx as Me, createSlots as Af, withKeys as Of } from "vue";
const qr = (n, e) => {
...
}, Nf = ["aria-label", "data-tooltip", "title", "innerHTML"];
function Df(n, e, t, r, i, o) {
  return F(), Z("button", {
    type: "button",
    class: Wt(["w-full flex p-1 flex-row items-center text-slate-600 rounded gap-2 hover:bg-slate-100", t.active ? t.activeClass : ""]),
    "aria-label": t.label,
...
const Rf = /* @__PURE__ */ qr(Ef, [["render", Df]]), Lf = {
  computed: {
    hasDropdown() {
...
}, If = { class: "group text-sm relative" };
function Pf(n, e, t, r, i, o) {
  return F(), Z("div", If, [
    Bl(n.$slots, "default"),
    o.hasDropdown ? (F(), Z("div", {
      key: 0,
      class: Wt(["z-10 bg-white shadow py-2 group-focus-within:block hidden overflow-hidden whitespace-nowrap absolute bottom-full sm:bottom-auto sm:top-full mt-4 rounded border border-slate-400", t.align == "left" ? "left-0" : "right-0"])
    }, [
      Bl(n.$slots, "dropdown")
    ], 2)) : it("", !0)
  ]);
}
const Bf = /* @__PURE__ */ qr(Lf, [["render", Pf]]), zf = {
  props: {
    content: {
      type: String,
      required: !1
...
}, Hf = ["aria-label", "title", "innerHTML"];
function Vf(n, e, t, r, i, o) {
  return F(), Z("button", {
    class: Wt(["w-full flex py-1 pl-2 pr-6 flex-row items-center text-slate-600 gap-2 hover:bg-slate-100", t.active ? t.activeClass : ""]),
    "aria-label": t.label,
    title: t.label,
    innerHTML: t.content
  }, null, 10, Hf);
}
const Ff = /* @__PURE__ */ qr(zf, [["render", Vf]]);
function ye(n) {
  this.content = n;
}
ye.prototype = {
...
function Fc(n, e, t) {
  for (let r = 0; ; r++) {
    ...
    if (i.content.size || o.content.size) {
      let s = Fc(i.content, o.content, t + 1);
      if (s != null)
        return s;
    }
    t += i.nodeSize;
...
function $c(n, e, t, r) {
  for (let i = n.childCount, o = e.childCount; ; ) {
    ...
    if (s.content.size || l.content.size) {
      let c = $c(s.content, l.content, t - 1, r - 1);
      if (c)
        return c;
    }
    t -= a, r -= a;
...
class M {
  ...
  */
  insertAt(e, t) {
    let r = Wc(this.content, e + this.openStart, t);
  ...
  */
  removeBetween(e, t) {
    return new M(jc(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function _c(n, e, t, r) {
  ...
  if (i == e.index(r) && r < n.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
      ...
      return gn(s, l.cut(0, n.parentOffset).append(t.content).append(l.cut(e.parentOffset)));
    } else {
      let { start: s, end: l } = jf(t, n);
      return gn(o, Kc(n, s, l, e, r));
    }
  else return gn(o, Ri(n, e, r));
}
function qc(n, e) {
...
function br(n, e, t, r) {
  ...
  n && (o = n.index(t), n.depth > t ? o++ : n.textOffset && (mn(n.nodeAfter, r), o++));
  for (let l = o; l < s; l++)
    mn(i.child(l), r);
...
function Kc(n, e, t, r, i) {
  let o = n.depth > i && as(n, e, i + 1), s = r.depth > i && as(t, r, i + 1), l = [];
  return br(null, n, i, l), o && s && e.index(i) == t.index(i) ? (qc(o, s), mn(gn(o, Kc(n, e, t, r, i + 1)), l)) : (o && mn(gn(o, Ri(n, e, i + 1)), l), br(e, t, i, l), s && mn(gn(s, Ri(t, r, i + 1)), l)), br(r, null, i, l), new x(l);
}
function Ri(n, e, t) {
  let r = [];
  if (br(null, n, t, r), n.depth > t) {
    let i = as(n, e, t + 1);
    mn(gn(i, Ri(n, e, t + 1)), r);
  }
...
let yn = class cs {
  ...
  */
  hasMarkup(e, t, r) {
    return this.type == e && Ni(this.attrs, t || e.defaultAttrs || _f) && G.sameSet(this.marks, r || G.none);
  }
  /**
  ...
  */
  copy(e = null) {
    return e == this.content ? this : new cs(this.type, this.attrs, e, this.marks);
  }
  /**
  ...
  */
  mark(e) {
    return e == this.marks ? this : new cs(this.type, this.attrs, this.content, e);
  }
  /**
  ...
  */
  replace(e, t, r) {
    return $f(this.resolve(e), this.resolve(t), r);
  }
  /**
...
function Yf(n) {
  if (n.eat("(")) {
    ...
    let e = Gf(n, n.next).map((t) => (n.inline == null ? n.inline = t.isInline : n.inline != t.isInline && n.err("Mixing inline and block content"), { type: "name", value: t }));
...
let Vl = class Zc {
  ...
  */
  constructor(e, t, r) {
    this.name = e, this.schema = t, this.spec = r, this.markSet = null, this.groups = r.group ? r.group.split(" ") : [], this.attrs = Qc(r.attrs), this.defaultAttrs = Yc(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(r.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  computeAttrs(e) {
    return !e && this.defaultAttrs ? this.defaultAttrs : Xc(this.attrs, e);
  }
  /**
  ...
  */
  create(e = null, t, r) {
    ...
    return new yn(this, this.computeAttrs(e), x.from(t), G.setFrom(r));
  }
  /**
  ...
  */
  createChecked(e = null, t, r) {
    return t = x.from(t), this.checkContent(t), new yn(this, this.computeAttrs(e), t, G.setFrom(r));
  }
  /**
  ...
  */
  createAndFill(e = null, t, r) {
    ...
    return o ? new yn(this, e, t.append(o), G.setFrom(r)) : null;
  }
  /**
  ...
  */
  static compile(e, t) {
    ...
    e.forEach((o, s) => r[o] = new Zc(o, t, s));
...
class ao {
  ...
  */
  constructor(e, t, r, i) {
    this.name = e, this.rank = t, this.schema = r, this.spec = i, this.attrs = Qc(i.attrs), this.excluded = null;
    let o = Yc(this.attrs);
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new G(this, Xc(this.attrs, e));
  }
  /**
  @internal
  */
  static compile(e, t) {
    ...
    return e.forEach((o, s) => r[o] = new ao(o, i++, t, s)), r;
  }
  /**
...
class th {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = ye.from(e.nodes), t.marks = ye.from(e.marks || {}), this.nodes = Vl.compile(this.spec.nodes, this), this.marks = ao.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
    for (let i in this.nodes) {
      ...
      o.markSet = l == "_" ? null : l ? Fl(this, l.split(" ")) : l == "" || !o.inlineContent ? [] : null;
    }
    for (let i in this.marks) {
      let o = this.marks[i], s = o.spec.excludes;
      o.excluded = s == null ? [o] : s == "" ? [] : Fl(this, s.split(" "));
    }
  ...
  */
  text(e, t) {
    ...
    return new Ii(r, r.defaultAttrs, e, G.setFrom(t));
  }
  /**
  ...
  */
  constructor(e, t) {
    this.schema = e, this.rules = t, this.tags = [], this.styles = [], t.forEach((r) => {
      nh(r) ? this.tags.push(r) : rh(r) && this.styles.push(r);
  ...
  */
  matchTag(e, t, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let o = this.tags[i];
      if (sh(e, o.tag) && (o.namespace === void 0 || e.namespaceURI == o.namespace) && (!o.context || t.matchesContext(o.context))) {
        if (o.getAttrs) {
          let s = o.getAttrs(e);
          if (s === !1)
            continue;
  ...
  */
  static schemaRules(e) {
    ...
    for (let i in e.marks) {
      ...
      o && o.forEach((s) => {
        r(s = Wl(s)), s.mark || s.ignore || s.clearMark || (s.mark = i);
      });
    }
    for (let i in e.nodes) {
      let o = e.nodes[i].spec.parseDOM;
      o && o.forEach((s) => {
        r(s = Wl(s)), s.node || s.ignore || s.mark || (s.node = i);
      });
    }
    return t;
  }
...
const ed = {
  ...
  style: !0,
  title: !0
}, td = { ol: !0, ul: !0 }, Pi = 1, Bi = 2, ki = 4;
function $l(n, e, t) {
  return e != null ? (e ? Pi : 0) | (e === "full" ? Bi : 0) : n && n.whitespace == "pre" ? Pi | Bi : t & -5;
}
class ci {
  constructor(e, t, r, i, o, s, l) {
    this.type = e, this.attrs = t, this.marks = r, this.pendingMarks = i, this.solid = o, this.options = l, this.content = [], this.activeMarks = G.none, this.stashMarks = [], this.match = s || (l & ki ? null : e.contentMatch);
  }
  findWrapping(e) {
    if (!this.match) {
      if (!this.type)
  ...
  applyPending(e) {
    for (let t = 0, r = this.pendingMarks; t < r.length; t++) {
      let i = r[t];
      (this.type ? this.type.allowsMarkType(i.type) : ah(i.type, e)) && !i.isInSet(this.activeMarks) && (this.activeMarks = i.addToSet(this.activeMarks), this.pendingMarks = i.removeFromSet(this.pendingMarks));
    }
  }
  inlineContext(e) {
    return this.type ? this.type.inlineContent : this.content.length ? this.content[0].isInline : e.parentNode && !ed.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class jl {
  constructor(e, t, r) {
    this.parser = e, this.options = t, this.isOpen = r, this.open = 0;
    let i = t.topNode, o, s = $l(null, t.preserveWhitespace, 0) | (r ? ki : 0);
    i ? o = new ci(i.type, i.attrs, G.none, G.none, !0, t.topMatch || i.type.contentMatch, s) : r ? o = new ci(null, null, G.none, G.none, !0, null, s) : o = new ci(e.schema.topNodeType, null, G.none, G.none, !0, null, s), this.nodes = [o], this.find = t.findPositions, this.needsBlock = !1;
  }
  get top() {
  ...
  addTextNode(e) {
    ...
    if (r.options & Bi || r.inlineContext(e) || /[^ \t\r\n\u000c]/.test(t)) {
      if (r.options & Pi)
        r.options & Bi ? t = t.replace(/\r\n?/g, `
`) : t = t.replace(/\r?\n|\r/g, " ");
...
`));
  ...
  enterInner(e, t = null, r = !1, i) {
    ...
    o.options & ki && o.content.length == 0 && (s |= ki), this.nodes.push(new ci(e, t, o.activeMarks, o.pendingMarks, r, null, s)), this.open++;
  }
  ...
  addPendingMark(e) {
    let t = ch(e, this.top.pendingMarks);
...
function oh(n) {
  for (let e = n.firstChild, t = null; e; e = e.nextSibling) {
    ...
    r && td.hasOwnProperty(r) && t ? (t.appendChild(e), e = t) : r == "li" ? t = e : r && (t = null);
  }
}
function sh(n, e) {
...
class ut {
  ...
  */
  serializeNodeInner(e, t) {
    let { dom: r, contentDOM: i } = ut.renderSpec(Do(t), this.nodes[e.type.name](e));
    if (i) {
      if (e.isLeaf)
  ...
  */
  serializeMark(e, t, r = {}) {
    ...
    return i && ut.renderSpec(Do(r), i(e, t));
  }
  /**
...
const nd = 65535, rd = Math.pow(2, 16);
function dh(n, e) {
  return n + e * rd;
}
function ql(n) {
...
class ds {
  ...
  */
  get deletedBefore() {
    return (this.delInfo & (id | xi)) > 0;
  }
  /**
  True when the token after the mapped position was deleted.
  */
  get deletedAfter() {
    return (this.delInfo & (od | xi)) > 0;
  }
  /**
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        if (r)
          return h;
        let p = e == (t < 0 ? a : u) ? null : dh(l / 3, e - a), g = e == a ? od : e == u ? id : xi;
        return (t < 0 ? e != a : e != u) && (g |= sd), new ds(h, g, p);
      }
      i += d - c;
    }
    return r ? e + i : new ds(e + i, 0, null);
  }
  /**
  @internal
  */
  touches(e, t) {
    let r = 0, i = ql(t), o = this.inverted ? 2 : 1, s = this.inverted ? 1 : 2;
    for (let l = 0; l < this.ranges.length; l += 3) {
...
function Us(n, e, t) {
  ...
  for (let i = 0; i < n.childCount; i++) {
    let o = n.child(i);
    o.content.size && (o = o.copy(Us(o.content, e, o))), o.isInline && (o = e(o, t, i)), r.push(o);
  }
...
class _t extends Ce {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = e.resolve(this.from), i = r.node(r.sharedDepth(this.to)), o = new M(Us(t.content, (s, l) => !s.isAtom || !l.type.allowsMarkType(this.mark.type) ? s : s.mark(this.mark.addToSet(s.marks)), i), t.openStart, t.openEnd);
...
class ft extends Ce {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = new M(Us(t.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e), t.openStart, t.openEnd);
...
class ce extends Ce {
  ...
  */
  ...
  apply(e) {
    return this.structure && us(e, this.from, this.to) ? de.fail("Structure replace would overwrite content") : de.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
...
function fh(n, e, t, r) {
  ...
  n.doc.nodesBetween(e, t, (a, c, d) => {
    ...
    if (!r.isInSet(u) && d.type.allowsMarkType(r.type)) {
      ...
      l && l.to == f ? l.to = h : o.push(l = new _t(f, h, r));
    }
...
function ld(n, e, t, r = t.contentMatch, i = !0) {
...
function sr(n) {
  ...
  for (let r = n.depth; ; --r) {
    ...
    if (r < n.depth && i.canReplace(o, s, t))
      return r;
    if (r == 0 || i.type.spec.isolating || !ph(i, o, s))
      break;
  }
  return null;
}
...
function Js(n, e, t = null, r = n) {
  let i = gh(n, e), o = i && yh(r, e);
  return o ? i.map(Kl).concat({ type: e, attrs: t }).concat(o.map(Kl)) : null;
}
function Kl(n) {
...
function bh(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (s, l) => {
    if (s.isTextblock && !s.hasMarkup(r, i) && xh(n.doc, n.mapping.slice(o).map(l), r)) {
      let a = null;
      if (r.schema.linebreakReplacement) {
        let f = r.whitespace == "pre", h = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
        f && !h ? a = !1 : !f && h && (a = !0);
      }
      a === !1 && kh(n, s, l, o), ld(n, n.mapping.slice(o).map(l, 1), r, void 0, a === null);
      let c = n.mapping.slice(o), d = c.map(l, 1), u = c.map(l + s.nodeSize, 1);
      return n.step(new pe(d, u, d + 1, u - 1, new M(x.from(r.create(i, null, s.marks)), 0, 0), 1, !0)), a === !0 && wh(n, s, l, o), !1;
    }
  });
}
function wh(n, e, t, r) {
...
function co(n, e, t = -1) {
  ...
  for (let i = r.depth; ; i--) {
    let o, s, l = r.index(i);
    if (i == r.depth ? (o = r.nodeBefore, s = r.nodeAfter) : t > 0 ? (o = r.node(i + 1), l++, s = r.node(i).maybeChild(l)) : (o = r.node(i).maybeChild(l - 1), s = r.node(i + 1)), o && !o.isTextblock && ad(o, s) && r.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function uo(n, e, t = e, r = M.empty) {
  if (e == t && !r.size)
    return null;
  let i = n.resolve(e), o = n.resolve(t);
  return dd(i, o, r) ? new ce(e, t, r) : new Ah(i, o, r).fit();
}
function dd(n, e, t) {
...
class Ah {
  ...
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let i, o = null;
        r ? (o = Lo(this.unplaced.content, r - 1).firstChild, i = o.content) : i = this.unplaced.content;
        let s = i.firstChild;
  ...
  openMore() {
    let { content: e, openStart: t, openEnd: r } = this.unplaced, i = Lo(e, t);
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: r, inject: i, wrap: o }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!m)
        break;
      c++, (c > 1 || a == 0 || g.content.size) && (u = m, d.push(ud(g.mark(f.allowedMarks(g.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
  ...
  findCloseLevel(e) {
    e: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
      let { match: r, type: i } = this.frontier[t], o = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), s = Io(e, t, i, r, o);
      if (s) {
        for (let l = t - 1; l >= 0; l--) {
...
function ud(n, e, t) {
  if (e <= 0)
    return n;
  let r = n.content;
  return e > 1 && (r = r.replaceChild(0, ud(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0))), e > 0 && (r = n.type.contentMatch.fillBefore(r).append(r), t <= 0 && (r = r.append(n.type.contentMatch.matchFragment(r).fillBefore(x.empty, !0)))), n.copy(r);
}
    ...
    if (p)
      for (let g = 0; g < s.length; g++) {
        ...
        if (w.canReplaceWith(C, C, p.type, p.marks))
          return n.replace(i.before(m), y ? o.after(m) : t, new M(fd(r.content, 0, r.openStart, h), h, r.openEnd));
      }
  }
...
class Nr extends Ce {
  ...
  */
  ...
  invert(e) {
    return new Nr(this.attr, e.attrs[this.attr]);
  }
  map(e) {
    return this;
  }
  ...
  static fromJSON(e, t) {
    ...
    return new Nr(t.attr, t.value);
  }
}
Ce.jsonID("docAttr", Nr);
...
class I {
  ...
  */
  replace(e, t = M.empty) {
    ...
    for (let l = 0; l < s.length; l++) {
      ...
      e.replaceRange(d.map(a.pos), d.map(c.pos), l ? M.empty : t), l == 0 && Gl(e, o, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  /**
  ...
  */
  replaceWith(e, t) {
    ...
    for (let o = 0; o < i.length; o++) {
      ...
      o ? e.deleteRange(c, d) : (e.replaceRangeWith(c, d, t), Gl(e, r, t.isInline ? -1 : 1));
    }
  }
  /**
  ...
  */
  static atEnd(e) {
    return Hn(e, e, e.content.size, e.childCount, -1) || new Ue(e);
  }
  /**
...
let Ul = !1;
function Jl(n) {
  !Ul && !n.parent.inlineContent && (Ul = !0, console.warn("TextSelection endpoint not pointing into a node with inline content (" + n.parent.type.name + ")"));
}
class L extends I {
  /**
  ...
  */
  ...
  getBookmark() {
    return new fo(this.anchor, this.head);
  }
  toJSON() {
...
class fo {
  ...
  map(e) {
    return new fo(e.map(this.anchor), e.map(this.head));
  }
  resolve(e) {
...
class Ih extends Gs {
  ...
  */
  setSelection(e) {
    ...
    return this.curSelection = e, this.curSelectionFor = this.steps.length, this.updated = (this.updated | Yl) & -3, this.storedMarks = null, this;
  }
  /**
  ...
  */
  setStoredMarks(e) {
    return this.storedMarks = e, this.updated |= Xl, this;
  }
  /**
  ...
  */
  scrollIntoView() {
    return this.updated |= Ql, this;
  }
  /**
  True when this transaction has had `scrollIntoView` called on it.
  */
  get scrolledIntoView() {
    return (this.updated & Ql) > 0;
  }
}
function Zl(n, e) {
...
class vr {
  constructor(e, t, r) {
    this.name = e, this.init = Zl(t.init, r), this.apply = Zl(t.apply, r);
  }
}
const Ph = [
  new vr("doc", {
...
class jn {
  ...
  */
  static create(e) {
    let t = new Bo(e.doc ? e.doc.type.schema : e.schema, e.plugins), r = new jn(t);
  ...
  */
  reconfigure(e) {
    let t = new Bo(this.schema, e.plugins), r = t.fields, i = new jn(t);
  ...
  */
  static fromJSON(e, t, r) {
    ...
    let i = new Bo(e.schema, e.plugins), o = new jn(i);
    return i.fields.forEach((s) => {
      if (s.name == "doc")
        o.doc = yn.fromJSON(e.schema, t.doc);
...
function ea(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : dt(n))) {
      let o = n.parentNode;
      if (!o || o.nodeType != 1 || Kr(n) || zh.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = ve(n) + (i < 0 ? 0 : 1), n = o;
...
const pt = typeof navigator < "u" ? navigator : null, ta = typeof document < "u" ? document : null, Zt = pt && pt.userAgent || "", hs = /Edge\/(\d+)/.exec(Zt), yd = /MSIE \d/.exec(Zt), ps = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Zt), Le = !!(yd || ps || hs), Ut = yd ? document.documentMode : ps ? +ps[1] : hs ? +hs[1] : 0, nt = !Le && /gecko\/(\d+)/i.test(Zt);
nt && +(/Firefox\/(\d+)/.exec(Zt) || [0, 0])[1];
const ms = !Le && /Chrome\/(\d+)/.exec(Zt), Ae = !!ms, Wh = ms ? +ms[1] : 0, Oe = !Le && !!pt && /Apple Computer/.test(pt.vendor), Zn = Oe && (/Mobile\/\w+/.test(Zt) || !!pt && pt.maxTouchPoints > 2), _e = Zn || (pt ? /Mac/.test(pt.platform) : !1), _h = pt ? /Win/.test(pt.platform) : !1, et = /Android \d/.test(Zt), Ur = !!ta && "webkitFontSmoothing" in ta.documentElement.style, qh = Ur ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Kh(n) {
...
function na(n, e, t) {
  ...
  for (let s = t || n.dom; s; s = Dr(s)) {
    if (s.nodeType != 1)
      continue;
    let l = s, a = l == o.body, c = a ? Kh(o) : Uh(l), d = 0, u = 0;
...
function Jh(n) {
  ...
  return { refDOM: r, refTop: i, stack: vd(n.dom) };
}
function vd(n) {
  let e = [], t = n.ownerDocument;
  for (let r = n; r && (e.push({ dom: r, top: r.scrollTop, left: r.scrollLeft }), n != t); r = Dr(r))
    ;
  return e;
}
...
function wd(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? Xh(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: o } : wd(t, i);
}
function Xh(n, e) {
...
function Zh(n, e, t) {
  let { node: r, offset: i } = wd(e, t), o = -1;
...
function tp(n, e) {
  let t = n.dom.ownerDocument, r, i = 0, o = jh(t, e.left, e.top);
  o && ({ node: r, offset: i } = o);
  ...
  if (!s || !n.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
    ...
    if (!Xs(e, c) || (s = kd(n.dom, e, c), !s))
      return null;
  }
  if (Oe)
    for (let c = s; r && c; c = Dr(c))
  ...
  if (s = Qh(s, e), r) {
    ...
    let c;
    Ur && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = ep(n, r, i, e));
  }
  l == null && (l = Zh(n, s, e));
...
const np = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function xd(n, e, t) {
  let { node: r, offset: i, atom: o } = n.docView.domFromPos(e, t < 0 ? -1 : 1), s = Ur || nt;
  if (r.nodeType == 3)
    if (s && (np.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = Bt(At(r, i, i), t);
      if (nt && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let c = Bt(At(r, i - 1, i - 1), -1);
        if (c.top == a.top) {
          let d = Bt(At(r, i, i + 1), -1);
          if (d.top != a.top)
      ...
      return t < 0 && !i ? (c++, d = -1) : t >= 0 && i == r.nodeValue.length ? (a--, d = 1) : t < 0 ? a-- : c++, pr(Bt(At(r, a, c), d), d < 0);
    }
  if (!n.state.doc.resolve(e - (o || 0)).parent.inlineContent) {
    if (o == null && i && (t < 0 || i == dt(r))) {
      let a = r.childNodes[i - 1];
      if (a.nodeType == 1)
        return Ho(a.getBoundingClientRect(), !1);
    }
    if (o == null && i < dt(r)) {
      let a = r.childNodes[i];
      if (a.nodeType == 1)
        return Ho(a.getBoundingClientRect(), !0);
    }
    return Ho(r.getBoundingClientRect(), t >= 0);
  }
  if (o == null && i && (t < 0 || i == dt(r))) {
  ...
  return pr(Bt(r.nodeType == 3 ? At(r) : r, -t), t >= 0);
}
function pr(n, e) {
  if (n.width == 0)
    return n;
...
function op(n, e, t) {
  ...
  return !ip.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? o : s : Cd(n, e, () => {
...
let ia = null, oa = null, sa = !1;
function sp(n, e, t) {
  return ia == e && oa == t ? sa : (ia = e, oa = t, sa = t == "up" || t == "down" ? rp(n, e, t) : op(n, e, t));
}
const Je = 0, la = 1, un = 2, mt = 3;
class Jr {
  constructor(e, t, r, i) {
...
`), d && h == f.nodeValue.length)
    ...
    if (!(i || d && Oe) && Cn(l.node, l.offset, c.anchorNode, c.anchorOffset) && Cn(a.node, a.offset, c.focusNode, c.focusOffset))
      return;
    let u = !1;
    if ((c.extend || e == t) && !d) {
  ...
  markDirty(e, t) {
    for (let r = 0, i = 0; i < this.children.length; i++) {
      ...
      if (r == s ? e <= s && t >= r : e < s && t > r) {
        ...
        if (e >= l && t <= a) {
          this.dirty = e == r || t == s ? un : la, e == l && t == a && (o.contentLost || o.dom.parentNode != this.contentDOM) ? o.dirty = mt : o.markDirty(e - l, t - l);
          return;
        } else
          o.dirty = o.dom == o.contentDOM && o.dom.parentNode == this.contentDOM && !o.children.length ? un : mt;
      }
      r = s;
    }
    this.dirty = un;
...
class Sn extends Jr {
  ...
  static create(e, t, r, i) {
    ...
    return (!s || !s.dom) && (s = ut.renderSpec(document, t.type.spec.toDOM(t, r))), new Sn(e, t, s.dom, s.contentDOM || s.dom);
  }
  parseRule() {
  ...
  slice(e, t, r) {
    let i = Sn.create(this.parent, this.mark, !0, r), o = this.children, s = this.size;
    t < s && (o = vs(o, t, s, r)), e > 0 && (o = vs(o, 0, e, r));
...
class Jt extends Jr {
  ...
  static create(e, t, r, i, o, s) {
    ...
    } else d || ({ dom: d, contentDOM: u } = ut.renderSpec(document, t.type.spec.toDOM(t)));
    !u && !t.isText && d.nodeName != "BR" && (d.hasAttribute("contenteditable") || (d.contentEditable = "false"), t.type.spec.draggable && (d.draggable = !0));
    let f = d;
    return d = Od(d, r, t), c ? a = new ap(e, t, r, i, d, u || null, f, c, o, s + 1) : t.isText ? new po(e, t, r, i, d, f, o) : new Jt(e, t, r, i, d, u || null, f, o, s + 1);
  }
  parseRule() {
  ...
  matchesNode(e, t, r) {
    return this.dirty == Je && e.eq(this.node) && ys(t, this.outerDeco) && r.eq(this.innerDeco);
  }
  get size() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let r = this.node.inlineContent, i = t, o = e.composing ? this.localCompositionInfo(e, t) : null, s = o && o.pos > -1 ? o : null, l = o && o.pos < 0, a = new dp(this, s && s.node, e);
    hp(this.node, this.innerDeco, (c, d, u) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == un) && (s && this.protectLocalComposition(e, s), Td(this.contentDOM, this.children, e), Zn && pp(this.dom));
  }
  ...
  protectLocalComposition(e, { node: t, pos: r, text: i }) {
    ...
    e.input.compositionNodes.push(s), this.children = vs(this.children, r, r + i.length, e, s);
  }
  ...
  updateOuterDeco(e) {
    ...
    this.dom = Ad(this.dom, this.nodeDOM, gs(this.outerDeco, this.node, t), gs(e, this.node, t)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
function aa(n, e, t, r, i) {
  Od(r, e, n);
  let o = new Jt(void 0, n, e, t, r, r, r, i, 0);
...
class po extends Jt {
  ...
  update(e, t, r, i) {
    return this.dirty == mt || this.dirty != Je && !this.inParent() || !e.sameMarkup(this.node) ? !1 : (this.updateOuterDeco(t), (this.dirty != Je || e.text != this.node.text) && e.text != this.nodeDOM.nodeValue && (this.nodeDOM.nodeValue = e.text, i.trackWrites == this.nodeDOM && (i.trackWrites = null)), this.node = e, this.dirty = Je, !0);
  }
  inParent() {
  ...
  slice(e, t, r) {
    ...
    return new po(this.parent, i, this.outerDeco, this.innerDeco, o, o, r);
  }
  markDirty(e, t) {
...
function Td(n, e, t) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (s instanceof Sn) {
      ...
      Td(s.contentDOM, s.children, t), r = a ? a.nextSibling : n.firstChild;
    }
  }
  for (; r; )
    r = ca(r), i = !0;
...
function Od(n, e, t) {
  return Ad(n, n, fn, gs(e, t, n.nodeType != 1));
}
function ys(n, e) {
  if (n.length != e.length)
    return !1;
...
class dp {
  constructor(e, t, r) {
    this.lock = t, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = up(e.node.content, e);
  }
  ...
  syncToMarks(e, t, r) {
    ...
    for (; i < s && (i == o - 1 ? this.top : this.stack[i + 1 << 1]).matchesMark(e[i]) && e[i].type.spec.spanning !== !1; )
      i++;
    for (; i < o; )
      this.destroyRest(), this.top.dirty = Je, this.index = this.stack.pop(), this.top = this.stack.pop(), o--;
    for (; o < e.length; ) {
      ...
      if (l > -1)
        ...
        let a = Sn.create(this.top, e[o], t, r);
  ...
  updateNodeAt(e, t, r, i, o) {
    ...
    return s.dirty == mt && s.dom == s.contentDOM && (s.dirty = un), s.update(e, t, r, o) ? (this.destroyBetween(this.index, i), this.index++, !0) : !1;
  }
  ...
  updateNextNode(e, t, r, i, o, s) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof Jt) {
        ...
        if (c != null && c != o)
          return !1;
        let d = a.dom, u, f = this.isLocked(d) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != mt && ys(t, a.outerDeco));
        ...
        if (!f && (u = this.recreateWrapper(a, e, t, r, i, s)))
          return this.top.children[this.index] = u, u.contentDOM && (u.dirty = un, u.updateChildren(i, s + 1), u.dirty = Je), this.changed = !0, this.index++, !0;
        break;
      }
    }
    return !1;
  ...
  recreateWrapper(e, t, r, i, o, s) {
    if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content))
      return null;
    let l = Jt.create(this.top, t, r, i, o, s);
    if (l.contentDOM) {
  ...
  addNode(e, t, r, i, o) {
    let s = Jt.create(this.top, e, t, r, i, o);
...
function Qs(n, e = null) {
  ...
  if (ho(t)) {
    for (a = l; i && !i.node; )
      i = i.parent;
    let d = i.node;
    if (i && d.isAtom && R.isSelectable(d) && i.parent && !(d.isInline && Fh(t.focusNode, t.focusOffset, i.dom))) {
      let u = i.posBefore;
...
function Dt(n, e = !1) {
  ...
  if (Nd(n, t), !!Ed(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      da && !(t instanceof L) && (t.$from.parent.inlineContent || (o = ua(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (s = ua(n, t.to))), n.docView.setSelection(r, i, n.root, e), da && (o && fa(o), s && fa(s)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && gp(n));
    }
    n.domObserver.setCurSelection(), n.domObserver.connectSelection();
  }
}
const da = Oe || Ae && Wh < 63;
function ua(n, e) {
...
function yp(n) {
  ...
  i ? t.setEnd(r.parentNode, ve(r) + 1) : t.setEnd(r, 0), t.collapse(!1), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && Le && Ut <= 11 && (r.disabled = !0, r.disabled = !1);
}
function Nd(n, e) {
  if (e instanceof R) {
...
function ma(n, e, t) {
  ...
  if (r instanceof L)
    if (t.indexOf("s") > -1) {
      ...
      return zt(n, new L(r.$anchor, s));
    } else if (r.empty) {
      if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
        let i = bs(n.state, e);
        return i && i instanceof R ? zt(n, i) : !1;
      } else if (!(_e && t.indexOf("m") > -1)) {
        let i = r.$head, o = i.textOffset ? null : e < 0 ? i.nodeBefore : i.nodeAfter, s;
        if (!o || o.isText)
          return !1;
        let l = e < 0 ? i.pos - o.nodeSize : i.pos;
        return o.isAtom || (s = n.docView.descAt(l)) && !s.contentDOM ? R.isSelectable(o) ? zt(n, new R(e < 0 ? n.state.doc.resolve(i.pos - o.nodeSize) : i)) : Ur ? zt(n, new L(n.state.doc.resolve(e < 0 ? l : l + o.nodeSize))) : !1 : !1;
      }
    } else return !1;
  else {
    if (r instanceof R && r.node.isInline)
      return zt(n, new L(e > 0 ? r.$to : r.$from));
    {
      let i = bs(n.state, e);
      return i ? zt(n, i) : !1;
    }
...
function bp(n) {
  ...
  if (!t)
    return;
  let i, o, s = !1;
  for (nt && t.nodeType == 1 && r < zi(t) && kr(t.childNodes[r], -1) && (s = !0); ; )
    if (r > 0) {
      if (t.nodeType != 1)
        break;
      {
...
function ws(n, e, t) {
  if (e.nodeType != 3) {
    let o, s;
    (s = kp(e, t)) ? (e = s, t = 0) : (o = xp(e, t)) && (e = o, t = o.nodeValue.length);
  }
...
function ga(n, e) {
  ...
  if (!(Ae || _h) && t.parent.inlineContent) {
...
function ya(n, e, t) {
  ...
  if (!i.parent.inlineContent) {
    let s = e < 0 ? i : o, l = r instanceof Ue ? I.near(s, e) : I.findFrom(s, e);
    return l ? zt(n, l) : !1;
  }
  return !1;
}
...
function Cp(n) {
  ...
  if (e && e.nodeType == 1 && t == 0 && e.firstChild && e.firstChild.contentEditable == "false") {
    let r = e.firstChild;
    ba(n, r, "true"), setTimeout(() => ba(n, r, "false"), 20);
  }
  return !1;
}
function Sp(n) {
...
function Mp(n, e) {
  let t = e.keyCode, r = Sp(e);
  if (t == 8 || _e && t == 72 && r == "c")
    return va(n, -1) || Pn(n, -1);
  if (t == 46 && !e.shiftKey || _e && t == 68 && r == "c")
    return va(n, 1) || Pn(n, 1);
  if (t == 13 || t == 27)
    return !0;
  if (t == 37 || _e && t == 66 && r == "c") {
    let i = t == 37 ? ga(n, n.state.selection.from) == "ltr" ? -1 : 1 : -1;
    return ma(n, i, r) || Pn(n, i);
  } else if (t == 39 || _e && t == 70 && r == "c") {
    let i = t == 39 ? ga(n, n.state.selection.from) == "ltr" ? 1 : -1 : 1;
    return ma(n, i, r) || Pn(n, i);
  } else {
    if (t == 38 || _e && t == 80 && r == "c")
      return ya(n, -1, r) || Pn(n, -1);
    if (t == 40 || _e && t == 78 && r == "c")
      return Cp(n) || ya(n, 1, r) || Pn(n, 1);
...
function Ld(n, e) {
  ...
  let s = n.someProp("clipboardSerializer") || ut.fromSchema(n.state.schema), l = Vd(), a = l.createElement("div");
...
`))), 0, 0) : M.empty;
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || Yn.fromSchema(n.state.schema)).parseSlice(s, {
    ...
    context: i,
    ruleFromNode(f) {
      return f.nodeName == "BR" && !f.nextSibling && f.parentNode && !Tp.test(f.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), d)
    l = Np(wa(l, +d[1], +d[2]), d[4]);
  else if (l = M.maxOpen(Ap(l.content, i), !0), l.openStart || l.openEnd) {
    let u = 0, f = 0;
...
const Tp = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
function Ap(n, e) {
  if (n.childCount < 2)
    return n;
  for (let t = e.depth; t >= 0; t--) {
    ...
    if (n.forEach((l) => {
      ...
      if (!a)
        return s = null;
      if (c = s.length && o.length && Bd(a, o, l, s[s.length - 1], 0))
        s[s.length - 1] = c;
      else {
        s.length && (s[s.length - 1] = zd(s[s.length - 1], o.length));
        let d = Pd(l, a);
...
function Bd(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    let o = Bd(n, e, t, r.lastChild, i + 1);
    if (o)
      return r.copy(r.content.replaceChild(r.childCount - 1, o));
    if (r.contentMatchAt(r.childCount).matchType(i == n.length - 1 ? t.type : n[i + 1]))
      return r.copy(r.content.append(x.from(Pd(t, n, i + 1))));
  }
}
function zd(n, e) {
  if (e == 0)
    return n;
  let t = n.content.replaceChild(n.childCount - 1, zd(n.lastChild, e - 1)), r = n.contentMatchAt(n.childCount).fillBefore(x.empty, !0);
  return n.copy(t.append(r));
}
function ks(n, e, t, r, i, o) {
  let s = e < 0 ? n.firstChild : n.lastChild, l = s.content;
  return n.childCount > 1 && (o = 0), i < r - 1 && (l = ks(l, e, t, r, i + 1, o)), i >= t && (l = e < 0 ? s.contentMatchAt(0).fillBefore(l, o <= i).append(l) : l.append(s.contentMatchAt(s.childCount).fillBefore(x.empty, !0))), n.replaceChild(e < 0 ? 0 : n.childCount - 1, s.copy(l));
}
function wa(n, e, t) {
  return e < n.openStart && (n = new M(ks(n.content, -1, e, n.openStart, 0, n.openEnd), e, n.openEnd)), t < n.openEnd && (n = new M(ks(n.content, 1, t, n.openEnd, 0, 0), n.openStart, t)), n;
}
const Hd = {
  thead: ["table"],
  tbody: ["table"],
...
let ka = null;
function Vd() {
  return ka || (ka = document.implementation.createHTMLDocument("title"));
}
function Op(n) {
  let e = /^(\s*<meta [^>]*>)*/.exec(n);
  e && (n = n.slice(e[0].length));
  let t = Vd().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(n), i;
  if ((i = r && Hd[r[1].toLowerCase()]) && (n = i.map((o) => "<" + o + ">").join("") + n + i.map((o) => "</" + o + ">").reverse().join("")), t.innerHTML = n, i)
    for (let o = 0; o < i.length; o++)
...
const Ee = {}, Ne = {}, Dp = { touchstart: !0, touchmove: !0 };
class Rp {
  constructor() {
...
function Lp(n) {
  for (let e in Ee) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      Pp(n, r) && !el(n, r) && (n.editable || !(r.type in Ne)) && t(n, r);
...
function xs(n) {
  n.someProp("handleDOMEvents", (e) => {
    for (let t in e)
      n.input.eventHandlers[t] || n.dom.addEventListener(t, n.input.eventHandlers[t] = (r) => el(n, r));
  });
}
function el(n, e) {
...
function Bp(n, e) {
  !el(n, e) && Ee[e.type] && (n.editable || !(e.type in Ne)) && Ee[e.type](n, e);
}
Ne.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !$d(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(et && Ae && t.keyCode == 13)))
    if (t.keyCode != 229 && n.domObserver.forceFlush(), Zn && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey) {
      let r = Date.now();
      n.input.lastIOSEnter = r, n.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
        n.input.lastIOSEnter == r && (n.someProp("handleKeyDown", (i) => i(n, ln(13, "Enter"))), n.input.lastIOSEnter = 0);
      }, 200);
    } else n.someProp("handleKeyDown", (r) => r(n, t)) || Mp(n, t) ? t.preventDefault() : Kt(n, "key");
};
Ne.keyup = (n, e) => {
...
Ne.keypress = (n, e) => {
  let t = e;
  if ($d(n, t) || !t.charCode || t.ctrlKey && !t.altKey || _e && t.metaKey)
    return;
...
function Hp(n, e) {
  ...
  return r && r.isAtom && R.isSelectable(r) ? (Gn(n, new R(t)), !0) : !1;
}
function Vp(n, e) {
  if (e == -1)
    return !1;
  ...
  return i != null ? (Gn(n, R.create(n.state.doc, i)), !0) : !1;
}
function Fp(n, e, t, r, i) {
  return tl(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? Vp(n, t) : Hp(n, t));
}
function $p(n, e, t, r) {
  return tl(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function jp(n, e, t, r) {
  return tl(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || Wp(n, t, r);
}
function Wp(n, e, t) {
  if (t.button != 0)
    return !1;
  let r = n.state.doc;
  if (e == -1)
    return r.inlineContent ? (Gn(n, L.create(r, 0, r.content.size)), !0) : !1;
  let i = r.resolve(e);
  for (let o = i.depth + 1; o > 0; o--) {
    let s = o > i.depth ? i.nodeAfter : i.node(o), l = i.before(o);
    if (s.inlineContent)
      Gn(n, L.create(r, l + 1, l + 1 + s.content.size));
...
const Fd = _e ? "metaKey" : "ctrlKey";
Ee.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = nl(n), i = Date.now(), o = "singleClick";
  i - n.input.lastClick.time < 500 && zp(t, n.input.lastClick) && !t[Fd] && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o };
  let s = n.posAtCoords(mo(t));
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new _p(n, s, t, !!r)) : (o == "doubleClick" ? $p : jp)(n, s.pos, s.inside, t) ? t.preventDefault() : Kt(n, "pointer"));
};
class _p {
  constructor(e, t, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(mo(e))), this.updateAllowDefault(e), this.allowDefault || !t ? Kt(this.view, "pointer") : Fp(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    Ae && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (Gn(this.view, I.near(this.view.state.doc.resolve(t.pos))), e.preventDefault()) : Kt(this.view, "pointer");
  }
  move(e) {
...
Ee.touchstart = (n) => {
  n.input.lastTouch = Date.now(), nl(n), Kt(n, "pointer");
};
Ee.touchmove = (n) => {
  n.input.lastTouch = Date.now(), Kt(n, "pointer");
};
Ee.contextmenu = (n) => nl(n);
function $d(n, e) {
...
Ne.compositionstart = Ne.compositionupdate = (n) => {
  if (!n.composing) {
    ...
    else if (Hi(n), nt && e.selection.empty && t.parentOffset && !t.textOffset && t.nodeBefore.marks.length) {
...
Ne.compositionend = (n, e) => {
  n.composing && (n.input.composing = !1, n.input.compositionEndedAt = e.timeStamp, n.input.compositionPendingChanges = n.domObserver.pendingRecords().length ? n.input.compositionID : 0, n.input.compositionNode = null, n.input.compositionPendingChanges && Promise.resolve().then(() => n.domObserver.flush()), n.input.compositionID++, jd(n, 20));
};
function jd(n, e) {
...
function Kp(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = Hh(e.focusNode, e.focusOffset), r = Vh(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let i = r.pmViewDesc;
...
function Hi(n, e = !1) {
  if (!(et && n.domObserver.flushingSoon >= 0)) {
    if (n.domObserver.forceFlush(), Wd(n), e || n.docView && n.docView.dirty) {
      let t = Qs(n);
...
const Rr = Le && Ut < 15 || Zn && qh < 604;
Ee.copy = Ne.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let o = Rr ? null : t.clipboardData, s = r.content(), { dom: l, text: a } = Ld(n, s);
...
Ne.paste = (n, e) => {
  ...
  r && Lr(n, _d(r), r.getData("text/html"), i, t) ? t.preventDefault() : Yp(n, t);
};
class qd {
  constructor(e, t, r) {
...
const Kd = _e ? "altKey" : "ctrlKey";
Ee.dragstart = (n, e) => {
  let t = e, r = n.input.mouseDown;
  if (r && r.done(), !t.dataTransfer)
    return;
  let i = n.state.selection, o = i.empty ? null : n.posAtCoords(mo(t)), s;
  ...
  let l = (s || n.state.selection).content(), { dom: a, text: c, slice: d } = Ld(n, l);
  t.dataTransfer.clearData(), t.dataTransfer.setData(Rr ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Rr || t.dataTransfer.setData("text/plain", c), n.dragging = new qd(d, !t[Kd], s);
};
Ee.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
Ne.drop = (n, e) => {
  ...
  if (n.dragging = null, !t.dataTransfer)
    return;
  let i = n.posAtCoords(mo(t));
  if (!i)
    return;
  let o = n.state.doc.resolve(i.pos), s = r && r.slice;
  s ? n.someProp("transformPasted", (p) => {
    s = p(s, n);
  }) : s = Id(n, _d(t.dataTransfer), Rr ? null : t.dataTransfer.getData("text/html"), !1, o);
  let l = !!(r && !t[Kd]);
  ...
  if (!s)
    return;
  t.preventDefault();
  let a = s ? cd(n.state.doc, o.pos, s) : o.pos;
  a == null && (a = o.pos);
  let c = n.state.tr;
  if (l) {
    let { node: p } = r;
  ...
  if (u && R.isSelectable(s.content.firstChild) && h.nodeAfter && h.nodeAfter.sameMarkup(s.content.firstChild))
    ...
    c.mapping.maps[c.mapping.maps.length - 1].forEach((g, m, y, w) => p = w), c.setSelection(Zs(n, h, c.doc.resolve(p)));
  }
...
Ee.beforeinput = (n, e) => {
  if (Ae && et && e.inputType == "deleteContentBackward") {
    n.domObserver.flushSoon();
    let { domChangeCount: r } = n.input;
    setTimeout(() => {
      if (n.input.domChangeCount != r || (n.dom.blur(), n.focus(), n.someProp("handleKeyDown", (o) => o(n, ln(8, "Backspace")))))
        return;
...
class Vi {
  ...
  eq(e) {
    return this == e || e instanceof Vi && (this.spec.key && this.spec.key == e.spec.key || this.toDOM == e.toDOM && Ir(this.spec, e.spec));
  }
  destroy(e) {
...
class rl {
  ...
  eq(e) {
    return this == e || e instanceof rl && Ir(this.attrs, e.attrs) && Ir(this.spec, e.spec);
  }
  destroy() {
  }
}
...
class Q {
  ...
  */
  static create(e, t) {
    return t.length ? Fi(t, e, 0, vn) : we;
  }
  /**
  ...
  */
  map(e, t, r) {
    return this == we || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, r || vn);
  }
  /**
  @internal
  */
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? Xp(this.children, s || [], e, t, r, i, o) : s ? new Q(s.sort(bn), Vn) : we;
  }
  /**
    ...
    e.forEach((l, a) => {
      ...
      if (d = Jd(t, l, c)) {
        for (i || (i = this.children.slice()); o < i.length && i[o] < a; )
          o += 3;
        i[o] == a ? i[o + 2] = i[o + 2].addInner(l, d, c + 1) : i.splice(o, 0, a, a + l.nodeSize, Fi(d, l, c + 1, vn)), o += 3;
      }
    });
    let s = Ud(o ? Gd(t) : t, -r);
    for (let l = 0; l < s.length; l++)
      s[l].type.valid(e, s[l]) || s.splice(l--, 1);
    return new Q(s.length ? this.local.concat(s).sort(bn) : this.local, i || this.children);
  }
  /**
...
class Ft {
  ...
  forChild(e, t) {
    ...
    for (let i = 0; i < this.members.length; i++) {
      ...
      o != we && (o instanceof Ft ? r = r.concat(o.members) : r.push(o));
    }
    return Ft.from(r);
  }
  eq(e) {
  ...
  static from(e) {
    switch (e.length) {
      ...
      case 1:
        return e[0];
      default:
        return new Ft(e.every((t) => t instanceof Q) ? e : e.reduce((t, r) => t.concat(r instanceof Q ? r : r.members), []));
    }
  }
}
function Xp(n, e, t, r, i, o, s) {
  ...
  if (a) {
    let c = Qp(l, n, e, t, i, o, s), d = Fi(c, r, 0, s);
    e = d.local;
...
function Fi(n, e, t, r) {
  ...
  e.forEach((l, a) => {
    ...
    if (c) {
      o = !0;
      let d = Fi(c, l, t + a + 1, r);
      d != we && i.push(a, a + l.nodeSize, d);
    }
  });
  let s = Ud(o ? Gd(n) : n, -t).sort(bn);
  for (let l = 0; l < s.length; l++)
  ...
  for (let t = 0; t < e.length - 1; t++) {
    ...
    if (r.from != r.to)
      for (let i = t + 1; i < e.length; i++) {
        let o = e[i];
        if (o.from == r.from) {
          o.to != r.to && (e == n && (e = n.slice()), e[i] = o.copy(o.from, r.to), xa(e, i + 1, o.copy(r.to, o.to)));
          continue;
        } else {
          o.from < r.to && (e == n && (e = n.slice()), e[t] = r.copy(r.from, o.from), xa(e, i, r.copy(o.from, r.to)));
          break;
        }
      }
  }
...
function Fo(n) {
  ...
  return n.someProp("decorations", (t) => {
    let r = t(n.state);
    r && r != we && e.push(r);
  }), n.cursorWrapper && e.push(Q.create(n.state.doc, [n.cursorWrapper.deco])), Ft.from(e);
}
const Zp = {
  childList: !0,
  characterData: !0,
...
class nm {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new tm(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
      Le && Ut <= 11 && r.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
  ...
  onSelectionChange() {
    if (pa(this.view)) {
      if (this.suppressingSelectionUpdates)
        return Dt(this.view);
      if (Le && Ut <= 11 && !this.view.state.selection.empty) {
  ...
  ignoreSelectionChange(e) {
    ...
    for (let o = e.focusNode; o; o = Dr(o))
      t.add(o);
    for (let o = e.anchorNode; o; o = Dr(o))
      if (t.has(o)) {
        r = o;
        break;
      }
  ...
  flush() {
    ...
    t.length && (this.queue = []);
    let r = e.domSelectionRange(), i = !this.suppressingSelectionUpdates && !this.currentSelection.eq(r) && pa(e) && !this.ignoreSelectionChange(r), o = -1, s = -1, l = !1, a = [];
    if (e.editable)
    ...
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && ho(r) && (c = Qs(e)) && c.eq(I.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Dt(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), rm(e)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Dt(e), this.currentSelection.set(r));
  }
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      if (Le && Ut <= 11 && e.addedNodes.length)
        for (let d = 0; d < e.addedNodes.length; d++) {
      ...
      return { from: l, to: c };
    } else return e.type == "attributes" ? { from: r.posAtStart - r.border, to: r.posAtEnd + r.border } : {
      from: r.posAtStart,
      to: r.posAtEnd,
...
function om(n, e, t) {
  ...
  if (d && n.dom.contains(d.nodeType == 1 ? d : d.parentNode) && (c = [{ node: d, offset: a.anchorOffset }], ho(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), Ae && n.input.lastKeyCode === 8)
    for (let m = o; m > i; m--) {
...
function am(n, e, t, r, i) {
  ...
  if (n.input.compositionPendingChanges = 0, e < 0) {
    let A = n.input.lastSelectionTime > Date.now() - 50 ? n.input.lastSelectionOrigin : null, B = Qs(n, A);
    if (B && !n.state.selection.eq(B)) {
      if (Ae && et && n.input.lastKeyCode === 13 && Date.now() - 100 < n.input.lastKeyCodeTime && n.someProp("handleKeyDown", ($) => $(n, ln(13, "Enter"))))
        return;
  ...
  let a = n.state.selection, c = om(n, e, t), d = n.state.doc, u = d.slice(c.from, c.to), f, h;
  n.input.lastKeyCode === 8 && Date.now() - 100 < n.input.lastKeyCodeTime ? (f = n.state.selection.to, h = "end") : (f = n.state.selection.from, h = "start"), n.input.lastKeyCode = null;
  let p = um(u.content, c.doc.content, c.from, f, h);
  if ((Zn && n.input.lastIOSEnter > Date.now() - 225 || et) && i.some((A) => A.nodeType == 1 && !lm.test(A.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (A) => A(n, ln(13, "Enter")))) {
  ...
  n.input.domChangeCount++, n.state.selection.from < n.state.selection.to && p.start == p.endB && n.state.selection instanceof L && (p.start > n.state.selection.from && p.start <= n.state.selection.from + 2 && n.state.selection.from >= c.from ? p.start = n.state.selection.from : p.endA < n.state.selection.to && p.endA >= n.state.selection.to - 2 && n.state.selection.to <= c.to && (p.endB += n.state.selection.to - p.endA, p.endA = n.state.selection.to)), Le && Ut <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == "  " && (p.start--, p.endA--, p.endB--);
  ...
  if ((Zn && n.input.lastIOSEnter > Date.now() - 225 && (!w || i.some((A) => A.nodeName == "DIV" || A.nodeName == "P")) || !w && g.pos < c.doc.content.size && !g.sameParent(m) && (C = I.findFrom(c.doc.resolve(g.pos + 1), 1, !0)) && C.head == m.pos) && n.someProp("handleKeyDown", (A) => A(n, ln(13, "Enter")))) {
    n.input.lastIOSEnter = 0;
    return;
  }
  if (n.state.selection.anchor > p.start && dm(d, p.start, p.endA, g, m) && n.someProp("handleKeyDown", (A) => A(n, ln(8, "Backspace")))) {
    et && Ae && n.domObserver.suppressSelectionUpdates();
    return;
  }
  Ae && et && p.endB == p.start && (n.input.lastAndroidDelete = Date.now()), et && !w && g.start() != m.start() && m.parentOffset == 0 && g.depth == m.depth && c.sel && c.sel.anchor == c.sel.head && c.sel.head == p.endA && (p.endB -= 2, m = c.doc.resolveNoCache(p.endB - c.from), setTimeout(() => {
    n.someProp("handleKeyDown", function(A) {
      return A(n, ln(13, "Enter"));
    });
  }, 20));
  let v = p.start, T = p.endA, b, O, z;
  if (w) {
    if (g.pos == m.pos)
      Le && Ut <= 11 && g.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => Dt(n), 20)), b = n.state.tr.delete(v, T), O = d.resolve(p.start).marksAcross(d.resolve(p.endA));
    else if (
      // Adding or removing a mark
      p.endA == p.endB && (z = cm(g.parent.content.cut(g.parentOffset, m.parentOffset), y.parent.content.cut(y.parentOffset, p.endA - y.start())))
    )
  ...
  if (b || (b = n.state.tr.replace(v, T, c.doc.slice(p.start - c.from, p.endB - c.from))), c.sel) {
    let A = Ta(n, b.doc, c.sel);
    A && !(Ae && et && n.composing && A.empty && (p.start != p.endB || n.input.lastAndroidDelete < Date.now() - 100) && (A.head == v || A.head == b.mapping.map(T) - 1) || Le && A.empty && A.head == v) && b.setSelection(A);
  }
  O && b.ensureMarks(O), o && b.setMeta("composition", o), n.dispatch(b.scrollIntoView());
}
function Ta(n, e, t) {
  return Math.max(t.anchor, t.head) > e.content.size ? null : Zs(n, e.resolve(t.anchor), e.resolve(t.head));
}
function cm(n, e) {
...
function dm(n, e, t, r, i) {
  ...
  if (o.parentOffset < o.parent.content.size || !o.parent.isTextblock)
    return !1;
  let s = n.resolve($o(o, !0, !0));
  return !s.parent.isTextblock || s.pos > t || $o(s, !0, !1) < t ? !1 : r.parent.content.cut(r.parentOffset).eq(s.parent.content);
}
function $o(n, e, t) {
...
class fm {
  ...
  */
  constructor(e, t) {
    this._root = null, this.focused = !1, this.trackWrites = null, this.mounted = !1, this.markCursor = null, this.cursorWrapper = null, this.lastSelectedViewDesc = void 0, this.input = new Rp(), this.prevDirectPlugins = [], this.pluginViews = [], this.requiresGeckoHackNode = !1, this.dragging = null, this._props = t, this.state = t.state, this.directPlugins = t.plugins || [], this.directPlugins.forEach(Ra), this.dispatch = this.dispatch.bind(this), this.dom = e && e.mount || document.createElement("div"), e && (e.appendChild ? e.appendChild(this.dom) : typeof e == "function" ? e(this.dom) : e.mount && (this.mounted = !0)), this.editable = Na(this), Ea(this), this.nodeViews = Da(this), this.docView = aa(this.state.doc, Oa(this), Fo(this), this.dom, this), this.domObserver = new nm(this, (r, i, o, s) => am(this, r, i, o, s)), this.domObserver.start(), Lp(this), this.updatePluginViews();
  }
  /**
  Holds `true` when a
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    e.storedMarks && this.composing && (Wd(this), s = !0), this.state = e;
    let l = i.plugins != e.plugins || this._props.plugins != t.plugins;
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let h = Da(this);
      pm(h, this.nodeViews) && (this.nodeViews = h, o = !0);
    }
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && xs(this), this.editable = Na(this), Ea(this);
    let a = Fo(this), c = Oa(this), d = i.plugins != e.plugins && !i.doc.eq(e.doc) ? "reset" : e.scrollToSelection > i.scrollToSelection ? "to selection" : "preserve", u = o || !this.docView.matchesNode(e.doc, c, a);
    (u || !e.selection.eq(i.selection)) && (s = !0);
    let f = d == "preserve" && s && this.dom.style.overflowAnchor == null && Jh(this);
    if (s) {
      this.domObserver.stop();
      let h = u && (Le || Ae) && !this.composing && !i.selection.empty && !e.selection.empty && hm(i.selection, e.selection);
      if (u) {
        let p = Ae ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = Kp(this)), (o || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = aa(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (h = !0);
      }
      h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && vp(this)) ? Dt(this, h) : (Nd(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((r = this.dragging) === null || r === void 0) && r.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), d == "reset" ? this.dom.scrollTop = 0 : d == "to selection" ? this.scrollToSelection() : f && Gh(f);
  }
  /**
  @internal
  */
  scrollToSelection() {
    ...
    if (!this.someProp("handleScrollToSelection", (t) => t(this))) if (this.state.selection instanceof R) {
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new qd(e.slice, e.move, i < 0 ? void 0 : R.create(this.state.doc, i));
  }
  someProp(e, t) {
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && Yh(this.dom), Dt(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (Ip(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], Fo(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, Bh());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return Oe && this.root.nodeType === 11 && $h(this.dom.ownerDocument) == this.dom && im(this, e) || e;
  }
  /**
  @internal
  */
...
for (var be = 0; be < 10; be++) Yt[48 + be] = Yt[96 + be] = String(be);
for (var be = 1; be <= 24; be++) Yt[be + 111] = "F" + be;
for (var be = 65; be <= 90; be++)
  Yt[be] = String.fromCharCode(be + 32), $i[be] = String.fromCharCode(be);
for (var jo in Yt) $i.hasOwnProperty(jo) || ($i[jo] = Yt[jo]);
function ym(n) {
  var e = mm && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || gm && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? $i : Yt)[n.keyCode] || n.key || "Unidentified";
  return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
const vm = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function bm(n) {
...
function km(n) {
  return new te({ props: { handleKeyDown: ol(n) } });
}
function ol(n) {
  let e = wm(n);
  return function(t, r) {
    let i = ym(r), o, s = e[Wo(i, r)];
    ...
    if (i.length == 1 && i != " ") {
      ...
      if ((r.shiftKey || r.altKey || r.metaKey || i.charCodeAt(0) > 127) && (o = Yt[r.keyCode]) && o != i) {
        let l = e[Wo(o, r)];
        if (l && l(t.state, t.dispatch, t))
          return !0;
      }
...
const Xd = (n, e, t) => {
  ...
  let o = i.nodeBefore;
  if (!o.type.spec.isolating && su(n, i, e))
    return !0;
  if (r.parent.content.size == 0 && (er(o, "end") || R.isSelectable(o))) {
    let s = uo(n.doc, r.before(), r.after(), M.empty);
...
const Am = (n, e) => {
  ...
  if (!t.parent.type.spec.code || !t.sameParent(r))
    return !1;
  let i = t.node(-1), o = t.indexAfter(-1), s = cl(i.contentMatchAt(o));
  ...
  if (t instanceof Ue || r.parent.inlineContent || i.parent.inlineContent)
    return !1;
  let o = cl(i.parent.contentMatchAt(i.indexAfter()));
  if (!o || !o.isTextblock)
    return !1;
  if (e) {
...
function Om(n) {
  return (e, t) => {
    ...
    if (!r.parent.isBlock)
      return !1;
    if (t) {
      let o = i.parentOffset == i.parent.content.size, s = e.tr;
      (e.selection instanceof L || e.selection instanceof Ue) && s.deleteSelection();
      let l = r.depth == 0 ? null : cl(r.node(-1).contentMatchAt(r.indexAfter(-1))), a = o && l ? [{ type: l }] : void 0, c = Nt(s.doc, s.mapping.map(r.pos), 1, a);
      if (!a && !c && Nt(s.doc, s.mapping.map(r.pos), 1, l ? [{ type: l }] : void 0) && (l && (a = [{ type: l }]), c = !0), c && (s.split(s.mapping.map(r.pos), 1, a), !o && !r.parentOffset && r.parent.type != l)) {
        let d = s.mapping.map(r.before()), u = s.doc.resolve(d);
        l && r.node(-1).canReplaceWith(u.index(), u.index() + 1, l) && s.setNodeMarkup(s.mapping.map(r.before()), l);
      }
      t(s.scrollIntoView());
    }
    return !0;
...
function Dm(n, e, t) {
  ...
  return !r || !i || !r.type.compatibleContent(i.type) ? !1 : !r.content.size && e.parent.canReplace(o - 1, o) ? (t && t(n.tr.delete(e.pos - r.nodeSize, e.pos).scrollIntoView()), !0) : !e.parent.canReplace(o, o + 1) || !(i.isTextblock || Qt(n.doc, e.pos)) ? !1 : (t && t(n.tr.clearIncompatible(e.pos, r.type, r.contentMatchAt(r.childCount)).join(e.pos).scrollIntoView()), !0);
}
function su(n, e, t) {
...
function Pm(n, e = null) {
  return function(t, r) {
    ...
    if (s.depth >= 2 && i.node(s.depth - 1).type.compatibleContent(n) && s.startIndex == 0) {
      ...
      a = new Li(d, d, s.depth), s.endIndex < s.parent.childCount && (s = new Li(i, t.doc.resolve(o.end(s.depth)), s.depth)), l = !0;
    }
    let c = Js(a, n, e, s);
    return c ? (r && r(Bm(t.tr, s, c, l, n).scrollIntoView()), !0) : !1;
  };
}
function Bm(n, e, t, r, i) {
  ...
  for (let d = e.startIndex, u = e.endIndex, f = !0; d < u; d++, f = !1)
    !f && Nt(n.doc, a, l) && (n.split(a, l), a += 2 * l), a += c.child(d).nodeSize;
  return n;
}
function zm(n) {
  return function(e, t) {
    let { $from: r, $to: i } = e.selection, o = r.blockRange(i, (s) => s.childCount > 0 && s.firstChild.type == n);
    return o ? t ? r.node(o.depth - 1).type == n ? Hm(e, t, n, o) : Vm(e, t, o) : !0 : !1;
  };
}
function Hm(n, e, t, r) {
  let i = n.tr, o = r.end, s = r.$to.end(r.depth);
  o < s && (i.step(new pe(o - 1, s, o, s, new M(x.from(t.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new Li(i.doc.resolve(r.$from.pos), i.doc.resolve(s), r.depth));
  const l = sr(r);
  if (l == null)
    return !1;
  i.lift(r, l);
...
function au(n) {
  const e = [], { nodeExtensions: t, markExtensions: r } = vo(n), i = [...t, ...r], o = {
    default: null,
    rendered: !0,
    renderHTML: null,
    parseHTML: null,
  ...
  return n.style ? n : {
    ...
    getAttrs: (t) => {
      ...
      const i = e.reduce((o, s) => {
        const l = s.attribute.parseHTML ? s.attribute.parseHTML(t) : Wm(t.getAttribute(s.name));
        return l == null ? o : {
          ...o,
          [s.name]: l
        };
...
function _m(n, e) {
  var t;
  const r = au(n), { nodeExtensions: i, markExtensions: o } = vo(n), s = (t = i.find((c) => E(c, "topNode"))) === null || t === void 0 ? void 0 : t.name, l = Object.fromEntries(i.map((c) => {
    ...
    p && (h.parseDOM = p.map((m) => Ia(m, d)));
    const g = E(c, "renderHTML", u);
    return g && (h.toDOM = (m) => g({
      mark: m,
      HTMLAttributes: Cs(m, d)
    })), [c.name, h];
  }));
  return new th({
    topNode: s,
...
function di(n) {
  ...
  return s.forEach((f) => {
    ...
    if (!h)
      return;
    const p = a.state.tr, g = go({
      state: a.state,
      transaction: p
    }), m = {
      from: r - (h[0].length - o.length),
      to: i
    }, { commands: y, chain: w, can: C } = new yo({
      editor: t,
      state: g
    });
    f.handler({
...
function Ym(n) {
  const { editor: e, state: t, from: r, to: i, rule: o, pasteEvent: s, dropEvent: l } = n, { commands: a, chain: c, can: d } = new yo({
    editor: e,
    state: t
  }), u = [];
  ...
  return t.map((d) => new te({
    ...
    appendTransaction: (u, f, h) => {
      ...
      if (!g && !m && !w)
        return;
      if (w) {
        const { from: T, text: b } = y, O = T + b.length, z = Xm(b);
        return a({
          rule: d,
          state: h,
          from: T,
...
class Wn {
  constructor(e, t) {
    this.splittableMarks = [], this.editor = t, this.extensions = Wn.resolve(e), this.schema = _m(this.extensions, t), this.setupExtensions();
  }
  /**
   ...
   */
  static resolve(e) {
    const t = Wn.sort(Wn.flatten(e)), r = Zm(t.map((i) => i.name));
   ...
   */
  get plugins() {
    const { editor: e } = this, t = Wn.sort([...this.extensions].reverse()), r = [], i = [], o = t.map((s) => {
      const l = {
        name: s.name,
        options: s.options,
        storage: s.storage,
        editor: e,
        type: _o(s.name, this.schema)
      ...
      Ba(s, e.options.enableInputRules) && f && r.push(...f());
      const h = E(s, "addPasteRules", l);
      Ba(s, e.options.enablePasteRules) && h && i.push(...h());
...
function wo(n, e) {
  const t = { ...n };
  return qo(n) && qo(e) && Object.keys(e).forEach((r) => {
    qo(e[r]) ? r in n ? t[r] = wo(n[r], e[r]) : Object.assign(t, { [r]: e[r] }) : Object.assign(t, { [r]: e[r] });
  }), t;
}
class oe {
  constructor(e = {}) {
  ...
  configure(e = {}) {
    const t = this.extend();
    return t.parent = this.parent, t.options = wo(this.options, e), t.storage = H(E(t, "addStorage", {
      name: t.name,
      options: t.options
    })), t;
  }
...
const tg = oe.create({
      ...
      new te({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: n } = this, { state: e, schema: t } = n, { doc: r, selection: i } = e, { ranges: o } = i, s = Math.min(...o.map((d) => d.$from.pos)), l = Math.max(...o.map((d) => d.$to.pos)), a = fu(t);
            return uu(r, { from: s, to: l }, {
...
}), ng = () => ({ editor: n, view: e }) => (requestAnimationFrame(() => {
  var t;
  n.isDestroyed || (e.dom.blur(), (t = window == null ? void 0 : window.getSelection()) === null || t === void 0 || t.removeAllRanges());
}), !0), rg = (n = !1) => ({ commands: e }) => e.setContent("", n), ig = () => ({ state: n, tr: e, dispatch: t }) => {
...
}, og = (n) => (e) => n(e), sg = () => ({ state: n, dispatch: e }) => iu(n, e), lg = (n, e) => ({ editor: t, tr: r }) => {
  ...
  return !1;
}, dg = (n) => ({ tr: e, dispatch: t }) => {
  const { from: r, to: i } = n;
  return t && e.delete(r, i), !0;
}, ug = () => ({ state: n, dispatch: e }) => sl(n, e), fg = () => ({ commands: n }) => n.keyboardShortcut("Enter"), hg = () => ({ state: n, dispatch: e }) => Am(n, e);
function ji(n, e, t = { strict: !0 }) {
  const r = Object.keys(e);
  return r.length ? r.every((i) => t.strict ? e[i] === n[i] : ul(e[i]) ? e[i].test(n[i]) : e[i] === n[i]) : !0;
}
function Ss(n, e, t = {}) {
  return n.find((r) => r.type === e && ji(r.attrs, t));
}
function pg(n, e, t = {}) {
  return !!Ss(n, e, t);
}
function fl(n, e, t = {}) {
  ...
  for (Ss([...r.node.marks], e, t); o > 0 && i.isInSet(n.parent.child(o - 1).marks); )
    o -= 1, s -= n.parent.child(o).nodeSize;
  for (; l < n.parent.childCount && pg([...n.parent.child(l).marks], e, t); )
...
const mg = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  const o = en(n, r.schema), { doc: s, selection: l } = t, { $from: a, from: c, to: d } = l;
  if (i) {
    const u = fl(a, o, e);
...
const yg = (n = null, e = {}) => ({ editor: t, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
  ...
  if (o && n === null && !hl(t.state.selection))
    return s(), !0;
  const l = hu(i.doc, n) || t.state.selection, a = t.state.selection.eq(l);
  return o && (a || i.setSelection(l), a && i.storedMarks && i.setStoredMarks(i.storedMarks), s()), !0;
}, vg = (n, e) => (t) => n.every((r, i) => e(r, { ...t, index: i })), bg = (n, e) => ({ tr: t, commands: r }) => r.insertContentAt({ from: t.selection.from, to: t.selection.to }, n, e), pu = (n) => {
  const e = n.childNodes;
  for (let t = e.length - 1; t >= 0; t -= 1) {
    const r = e[t];
    r.nodeType === 3 && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? n.removeChild(r) : r.nodeType === 1 && pu(r);
  }
  return n;
};
function za(n) {
...
function Wi(n, e, t) {
  ...
  if (r)
    try {
      ...
      return console.warn("[tiptap warn]: Invalid content.", "Passed value:", n, "Error:", o), Wi("", e, t);
    }
  if (i) {
    const o = Yn.fromSchema(e);
    return t.slice ? o.parseSlice(za(n), t.parseOptions).content : o.parse(za(n), t.parseOptions);
  }
  return Wi("", e, t);
}
function wg(n, e, t) {
...
const kg = (n) => n.toString().startsWith("<"), xg = (n, e, t) => ({ tr: r, dispatch: i, editor: o }) => {
  if (i) {
    t = {
      parseOptions: {},
      updateSelection: !0,
    ...
    let f;
    c ? (Array.isArray(e) ? f = e.map((h) => h.text || "").join("") : typeof e == "object" && e && e.text ? f = e.text : f = e, r.insertText(f, l, a)) : (f = s, r.replaceWith(l, a, f)), t.updateSelection && wg(r, r.steps.length - 1, -1), t.applyInputRules && r.setMeta("applyInputRules", { from: l, text: f }), t.applyPasteRules && r.setMeta("applyPasteRules", { from: l, text: f });
  }
  return !0;
}, Cg = () => ({ state: n, dispatch: e }) => Sm(n, e), Sg = () => ({ state: n, dispatch: e }) => Mm(n, e), Mg = () => ({ state: n, dispatch: e }) => Xd(n, e), Tg = () => ({ state: n, dispatch: e }) => tu(n, e), Ag = () => ({ tr: n, state: e, dispatch: t }) => {
  try {
    const r = co(e.doc, e.selection.$from.pos, -1);
    return r == null ? !1 : (n.join(r, 2), t && t(n), !0);
  } catch {
    return !1;
  }
}, Og = () => ({ state: n, dispatch: e, tr: t }) => {
  try {
...
}, Eg = () => ({ state: n, dispatch: e }) => xm(n, e), Ng = () => ({ state: n, dispatch: e }) => Cm(n, e);
function mu() {
...
const Rg = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
  const o = Dg(n).split(/-(?!$)/), s = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
function Pr(n, e, t = {}) {
  ...
  const a = i - r, c = l.filter((u) => s ? s.name === u.node.type.name : !0).filter((u) => ji(u.node.attrs, t, { strict: !1 }));
  return o ? !!c.length : c.reduce((u, f) => u + f.to - f.from, 0) >= a;
}
const Lg = (n, e = {}) => ({ state: t, dispatch: r }) => {
  const i = ge(n, t.schema);
  return Pr(t, i, e) ? Tm(t, r) : !1;
}, Ig = () => ({ state: n, dispatch: e }) => ou(n, e), Pg = (n) => ({ state: e, dispatch: t }) => {
  const r = ge(n, e.schema);
  return zm(r)(e, t);
}, Bg = () => ({ state: n, dispatch: e }) => ru(n, e);
function ko(n, e) {
...
const zg = (n, e) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return l ? (l === "node" && (o = ge(n, r.schema)), l === "mark" && (s = en(n, r.schema)), i && t.selection.ranges.forEach((a) => {
    r.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, d) => {
      o && o === c.type && t.setNodeMarkup(d, void 0, Ha(c.attrs, e)), s && c.marks.length && c.marks.forEach((u) => {
        s === u.type && t.addMark(d, d + c.nodeSize, s.create(Ha(u.attrs, e)));
      });
    });
  }), !0) : !1;
}, Hg = () => ({ tr: n, dispatch: e }) => (e && n.scrollIntoView(), !0), Vg = () => ({ tr: n, commands: e }) => e.setTextSelection({
  from: 0,
  to: n.doc.content.size
}), Fg = () => ({ state: n, dispatch: e }) => Zd(n, e), $g = () => ({ state: n, dispatch: e }) => nu(n, e), jg = () => ({ state: n, dispatch: e }) => Nm(n, e), Wg = () => ({ state: n, dispatch: e }) => Lm(n, e), _g = () => ({ state: n, dispatch: e }) => Rm(n, e);
function gu(n, e, t = {}) {
  return Wi(n, e, { slice: !1, parseOptions: t });
}
const qg = (n, e = !1, t = {}) => ({ tr: r, editor: i, dispatch: o }) => {
  const { doc: s } = r, l = gu(n, i.schema, t);
...
function vu(n, e) {
  ...
  return t === "node" ? Xg(n, e) : t === "mark" ? xo(n, e) : {};
}
...
function Ms(n, e, t = {}) {
  ...
  if (r)
    return !!(n.storedMarks || n.selection.$from.marks()).filter((u) => o ? o.name === u.type.name : !0).find((u) => ji(u.attrs, t, { strict: !1 }));
  let s = 0;
  const l = [];
  if (i.forEach(({ $from: u, $to: f }) => {
    ...
    return !1;
  const a = l.filter((u) => o ? o.name === u.mark.type.name : !0).filter((u) => ji(u.mark.attrs, t, { strict: !1 })).reduce((u, f) => u + f.to - f.from, 0), c = l.filter((u) => o ? u.mark.type !== o && u.mark.type.excludes(o) : !0).reduce((u, f) => u + f.to - f.from, 0);
  return (a > 0 ? a + c : a) >= s;
}
function t1(n, e, t = {}) {
  if (!e)
    return Pr(n, null, t) || Ms(n, null, t);
  const r = ko(e, n.schema);
  return r === "node" ? Pr(n, e, t) : r === "mark" ? Ms(n, e, t) : !1;
}
function Va(n, e) {
  const { nodeExtensions: t } = vo(e), r = t.find((s) => s.name === n);
  if (!r)
    return !1;
  const i = {
    name: r.name,
...
const o1 = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return i1(r, t, a);
}, s1 = (n, e) => ({ tr: t }) => (t.setMeta(n, e), !0), l1 = (n, e = {}) => ({ state: t, dispatch: r, chain: i }) => {
  const o = ge(n, t.schema);
  return o.isTextblock ? i().command(({ commands: s }) => La(o, e)(t) ? !0 : s.clearNodes()).command(({ state: s }) => La(o, e)(s, r)).run() : (console.warn('[tiptap warn]: Currently "setNode()" only supports text block nodes.'), !1);
...
const u1 = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  const { selection: o, doc: s } = e, { $from: l, $to: a } = o, c = i.extensionManager.attributes, d = Ci(c, l.node().type.name, l.node().attrs);
  if (o instanceof R && o.node.isBlock)
    return !l.parentOffset || !Nt(s, l.pos) ? !1 : (r && (n && Fa(t, i.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
  if (!l.parent.isBlock)
    return !1;
  if (r) {
    const u = a.parentOffset === a.parent.content.size;
    o instanceof L && e.deleteSelection();
    const f = l.depth === 0 ? void 0 : Ug(l.node(-1).contentMatchAt(l.indexAfter(-1)));
    let h = u && f ? [
      {
        type: f,
        attrs: d
      }
    ] : void 0, p = Nt(e.doc, e.mapping.map(l.pos), 1, h);
    if (!h && !p && Nt(e.doc, e.mapping.map(l.pos), 1, f ? [{ type: f }] : void 0) && (p = !0, h = f ? [
      {
        type: f,
        attrs: d
      }
  ...
  return !0;
}, f1 = (n) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  var o;
  ...
  if (l.parent.content.size === 0 && l.node(-1).childCount === l.indexAfter(-1)) {
    ...
    if (r) {
      ...
      const w = l.indexAfter(-1) < l.node(-2).childCount ? 1 : l.indexAfter(-2) < l.node(-3).childCount ? 2 : 3, C = Ci(u, l.node().type.name, l.node().attrs), v = ((o = s.contentMatch.defaultType) === null || o === void 0 ? void 0 : o.createAndFill(C)) || void 0;
  ...
  const f = a.pos === l.end() ? d.contentMatchAt(0).defaultType : null, h = Ci(u, d.type.name, d.attrs), p = Ci(u, l.node().type.name, l.node().attrs);
...
}, h1 = (n, e, t, r = {}) => ({ editor: i, tr: o, state: s, dispatch: l, chain: a, commands: c, can: d }) => {
  ...
  if (!C)
    return !1;
  const T = ml((b) => Va(b.type.name, u))(g);
  if (C.depth >= 1 && T && C.depth - T.depth <= 1) {
    if (T.node.type === h)
      return c.liftListItem(p);
    if (Va(T.node.type.name, u) && h.validContent(T.node.content) && l)
      return a().command(() => (o.setNodeMarkup(T.pos, h), !0)).command(() => Ko(o, h)).command(() => Uo(o, h)).run();
  }
  return !t || !v || !l ? a().command(() => d().wrapInList(h, r) ? !0 : c.clearNodes()).wrapInList(h, r).command(() => Ko(o, h)).command(() => Uo(o, h)).run() : a().command(() => {
    const b = d().wrapInList(h, r), O = v.filter((z) => f.includes(z.type.name));
    return o.ensureMarks(O), b ? !0 : c.clearNodes();
  }).wrapInList(h, r).command(() => Ko(o, h)).command(() => Uo(o, h)).run();
}, p1 = (n, e = {}, t = {}) => ({ state: r, commands: i }) => {
  const { extendEmptyMarkRange: o = !1 } = t, s = en(n, r.schema);
  return Ms(r, s, e) ? i.unsetMark(s, { extendEmptyMarkRange: o }) : i.setMark(s, e);
}, m1 = (n, e, t = {}) => ({ state: r, commands: i }) => {
  const o = ge(n, r.schema), s = ge(e, r.schema);
  return Pr(r, o, t) ? i.setNode(s) : i.setNode(o, t);
}, g1 = (n, e = {}) => ({ state: t, commands: r }) => {
  const i = ge(n, t.schema);
  return Pr(t, i, e) ? r.lift(i) : r.wrapIn(i, e);
}, y1 = () => ({ state: n, dispatch: e }) => {
  const t = n.plugins;
  for (let r = 0; r < t.length; r += 1) {
    const i = t[r];
    let o;
...
}, b1 = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  var o;
  const { extendEmptyMarkRange: s = !1 } = e, { selection: l } = t, a = en(n, r.schema), { $from: c, empty: d, ranges: u } = l;
  if (!i)
    return !0;
  if (d && s) {
    let { from: f, to: h } = l;
    const p = (o = c.marks().find((m) => m.type === a)) === null || o === void 0 ? void 0 : o.attrs, g = fl(c, a, p);
...
var C1 = /* @__PURE__ */ Object.freeze({
  ...
  joinItemBackward: Ag,
  joinItemForward: Og,
  joinTextblockBackward: Eg,
  joinTextblockForward: Ng,
  keyboardShortcut: Rg,
  lift: Lg,
  liftEmptyBlock: Ig,
  liftListItem: Pg,
  ...
  scrollIntoView: Hg,
  selectAll: Vg,
  selectNodeBackward: Fg,
  selectNodeForward: $g,
  selectParentNode: jg,
  selectTextblockEnd: Wg,
  selectTextblockStart: _g,
  setContent: qg,
  setMark: o1,
  setMeta: s1,
  setNode: l1,
  ...
  get children() {
    ...
    return this.node.content.forEach((t, r) => {
      ...
      if (!i && s.depth <= this.depth)
        return;
      const l = new an(s, this.editor, i, i ? t : null);
      i && (l.actualDepth = this.depth + 1), e.push(new an(s, this.editor, i, i ? t : null));
    }), e;
  }
  get firstChild() {
...
let D1 = class extends $m {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = N1(E1, this.options.injectNonce));
  }
  /**
   ...
   */
  createView() {
    const e = gu(this.options.content, this.schema, this.options.parseOptions), t = hu(e, this.options.autofocus);
  ...
  return new bo({
    ...
    handler: ({ state: e, range: t, match: r }) => {
      ...
      if (s) {
        ...
        if (gl(t.from, t.to, e.doc).filter((h) => h.mark.type.excluded.find((g) => g === n.type && g !== h.mark.type)).filter((h) => h.to > c).length)
          return null;
...
function R1(n) {
  return new bo({
    ...
    handler: ({ state: e, range: t, match: r }) => {
      ...
      } else r[0] && o.insert(s - 1, n.type.create(i)).delete(o.mapping.map(s), o.mapping.map(l));
      o.scrollIntoView();
    }
  });
}
...
function Br(n) {
  return new bo({
    ...
    handler: ({ state: e, range: t, match: r, chain: i }) => {
      const o = H(n.getAttributes, void 0, r) || {}, s = e.tr.delete(t.from, t.to), a = s.doc.resolve(t.from).blockRange(), c = a && Js(a, n.type, o);
      if (!c)
        return null;
      ...
      d && d.type === n.type && Qt(s.doc, t.from - 1) && (!n.joinPredicate || n.joinPredicate(r, d)) && s.join(t.from - 1);
    }
  });
}
class Be {
  ...
  configure(e = {}) {
    const t = this.extend();
    return t.options = wo(this.options, e), t.storage = H(E(t, "addStorage", {
      name: t.name,
      options: t.options
    })), t;
  }
  ...
  return new du({
    ...
    handler: ({ state: e, range: t, match: r, pasteEvent: i }) => {
      ...
      if (l) {
        ...
        if (gl(t.from, t.to, e.doc).filter((p) => p.mark.type.excluded.find((m) => m === n.type && m !== p.mark.type)).filter((p) => p.to > u).length)
          return null;
...
var Ie = "top", Ye = "bottom", Xe = "right", Pe = "left", yl = "auto", Gr = [Ie, Ye, Xe, Pe], tr = "start", zr = "end", P1 = "clippingParents", wu = "viewport", mr = "popper", B1 = "reference", $a = /* @__PURE__ */ Gr.reduce(function(n, e) {
  return n.concat([e + "-" + tr, e + "-" + zr]);
}, []), ku = /* @__PURE__ */ [].concat(Gr, [yl]).reduce(function(n, e) {
  return n.concat([e, e + "-" + tr, e + "-" + zr]);
}, []), z1 = "beforeRead", H1 = "read", V1 = "afterRead", F1 = "beforeMain", $1 = "main", j1 = "afterMain", W1 = "beforeWrite", _1 = "write", q1 = "afterWrite", K1 = [z1, H1, V1, F1, $1, j1, W1, _1, q1];
function gt(n) {
...
function U1(n) {
  ...
  Object.keys(e.elements).forEach(function(t) {
    ...
    !Ge(o) || !gt(o) || (Object.assign(o.style, r), Object.keys(i).forEach(function(s) {
      var l = i[s];
...
function J1(n) {
  ...
  return Object.assign(e.elements.popper.style, t.popper), e.styles = t, e.elements.arrow && Object.assign(e.elements.arrow.style, t.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !Ge(i) || !gt(i) || (Object.assign(i.style, l), Object.keys(o).forEach(function(a) {
        i.removeAttribute(a);
      }));
    });
  };
...
var wn = Math.max, _i = Math.min, nr = Math.round;
function As() {
...
function rr(n, e, t) {
  ...
  e && Ge(n) && (i = n.offsetWidth > 0 && nr(r.width) / n.offsetWidth || 1, o = n.offsetHeight > 0 && nr(r.height) / n.offsetHeight || 1);
  var s = Tn(n) ? Ve(n) : window, l = s.visualViewport, a = !Cu() && t, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, d = (r.top + (a && l ? l.offsetTop : 0)) / o, u = r.width / i, f = r.height / o;
  return {
    width: u,
    height: f,
    top: d,
...
function Co(n) {
  return gt(n) === "html" ? n : (
    ...
    (vl(n) ? n.host : null) || // ShadowRoot detected
    // $FlowFixMe[incompatible-call]: HTMLElement is a Node
    tn(n)
  );
}
function ja(n) {
  return !Ge(n) || // https://github.com/popperjs/popper-core/issues/837
  Rt(n).position === "fixed" ? null : n.offsetParent;
}
function Y1(n) {
  ...
  var i = Co(n);
  for (vl(i) && (i = i.host); Ge(i) && ["html", "body"].indexOf(gt(i)) < 0; ) {
    var o = Rt(i);
...
function Yr(n) {
  for (var e = Ve(n), t = ja(n); t && G1(t) && Rt(t).position === "static"; )
    t = ja(t);
  return t && (gt(t) === "html" || gt(t) === "body" && Rt(t).position === "static") ? e : t || Y1(n) || e;
}
function wl(n) {
...
var Q1 = function(e, t) {
  ...
  })) : e, Tu(typeof e != "number" ? e : Au(e, Gr));
};
function Z1(n) {
  var e, t = n.state, r = n.name, i = n.options, o = t.elements.arrow, s = t.modifiersData.popperOffsets, l = ht(t.placement), a = wl(l), c = [Pe, Xe].indexOf(l) >= 0, d = c ? "height" : "width";
  if (!(!o || !s)) {
    var u = Q1(i.padding, t), f = bl(o), h = a === "y" ? Ie : Pe, p = a === "y" ? Ye : Xe, g = t.rects.reference[d] + t.rects.reference[a] - s[a] - t.rects.popper[d], m = s[a] - t.rects.reference[a], y = Yr(o), w = y ? a === "y" ? y.clientHeight || 0 : y.clientWidth || 0 : 0, C = g / 2 - m / 2, v = u[h], T = w - f[d] - u[p], b = w / 2 - f[d] / 2 + C, O = xr(v, b, T), z = a;
    t.modifiersData[r] = (e = {}, e[z] = O, e.centerOffset = O - b, e);
  }
}
function e0(n) {
  var e = n.state, t = n.options, r = t.element, i = r === void 0 ? "[data-popper-arrow]" : r;
  i != null && (typeof i == "string" && (i = e.elements.popper.querySelector(i), !i) || Su(e.elements.popper, i) && (e.elements.arrow = i));
}
const t0 = {
  name: "arrow",
  enabled: !0,
...
function Wa(n) {
  ...
  if (c) {
    var b = Yr(t), O = "clientHeight", z = "clientWidth";
    if (b === Ve(t) && (b = tn(t), Rt(b).position !== "static" && l === "absolute" && (O = "scrollHeight", z = "scrollWidth")), b = b, i === Ie || (i === Pe || i === Xe) && o === zr) {
      v = Ye;
...
function s0(n) {
  ...
  return o && c.forEach(function(d) {
    d.addEventListener("scroll", t.update, ui);
  }), l && a.addEventListener("resize", t.update, ui), function() {
    o && c.forEach(function(d) {
      d.removeEventListener("scroll", t.update, ui);
    }), l && a.removeEventListener("resize", t.update, ui);
  };
}
const l0 = {
  name: "eventListeners",
...
function xl(n) {
  return rr(tn(n)).left + kl(n).scrollLeft;
}
function d0(n, e) {
  var t = Ve(n), r = tn(n), i = t.visualViewport, o = r.clientWidth, s = r.clientHeight, l = 0, a = 0;
  if (i) {
...
function u0(n) {
  var e, t = tn(n), r = kl(n), i = (e = n.ownerDocument) == null ? void 0 : e.body, o = wn(t.scrollWidth, t.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0), s = wn(t.scrollHeight, t.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0), l = -r.scrollLeft + xl(n), a = -r.scrollTop;
  return Rt(i || t).direction === "rtl" && (l += wn(t.clientWidth, i ? i.clientWidth : 0) - o), {
    width: o,
    height: s,
    x: l,
    y: a
...
function Cl(n) {
  var e = Rt(n), t = e.overflow, r = e.overflowX, i = e.overflowY;
  return /auto|scroll|overlay|hidden/.test(t + i + r);
}
function Ou(n) {
  return ["html", "body", "#document"].indexOf(gt(n)) >= 0 ? n.ownerDocument.body : Ge(n) && Cl(n) ? n : Ou(Co(n));
}
function Cr(n, e) {
  var t;
  e === void 0 && (e = []);
  var r = Ou(n), i = r === ((t = n.ownerDocument) == null ? void 0 : t.body), o = Ve(r), s = i ? [o].concat(o.visualViewport || [], Cl(r) ? r : []) : r, l = e.concat(s);
  return i ? l : (
...
function qa(n, e, t) {
  return e === wu ? Os(d0(n, t)) : Tn(e) ? f0(e, t) : Os(u0(tn(n)));
}
function h0(n) {
  var e = Cr(Co(n)), t = ["absolute", "fixed"].indexOf(Rt(n).position) >= 0, r = t && Ge(n) ? Yr(n) : n;
  return Tn(r) ? e.filter(function(i) {
    return Tn(i) && Su(i, r) && gt(i) !== "body";
  }) : [];
}
function p0(n, e, t, r) {
  var i = e === "clippingParents" ? h0(n) : [].concat(e), o = [].concat(i, [t]), s = o[0], l = o.reduce(function(a, c) {
    var d = qa(n, c, r);
    return a.top = wn(d.top, a.top), a.right = _i(d.right, a.right), a.bottom = _i(d.bottom, a.bottom), a.left = wn(d.left, a.left), a;
  }, qa(n, s, r));
...
function Hr(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, o = t.strategy, s = o === void 0 ? n.strategy : o, l = t.boundary, a = l === void 0 ? P1 : l, c = t.rootBoundary, d = c === void 0 ? wu : c, u = t.elementContext, f = u === void 0 ? mr : u, h = t.altBoundary, p = h === void 0 ? !1 : h, g = t.padding, m = g === void 0 ? 0 : g, y = Tu(typeof m != "number" ? m : Au(m, Gr)), w = f === mr ? B1 : mr, C = n.rects.popper, v = n.elements[p ? w : f], T = p0(Tn(v) ? v : v.contextElement || tn(n.elements.popper), a, d, s), b = rr(n.elements.reference), O = Eu({
    reference: b,
    element: C,
    placement: i
  }), z = Os(Object.assign({}, C, O)), A = f === mr ? z : b, B = {
  ...
  if (f === mr && V) {
    ...
    Object.keys(B).forEach(function(_) {
      var ae = [Xe, Ye].indexOf(_) >= 0 ? 1 : -1, X = [Ie, Ye].indexOf(_) >= 0 ? "y" : "x";
      B[_] += $[X] * ae;
    });
  }
  return B;
...
function m0(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = t.boundary, o = t.rootBoundary, s = t.padding, l = t.flipVariations, a = t.allowedAutoPlacements, c = a === void 0 ? ku : a, d = ir(r), u = d ? l ? $a : $a.filter(function(p) {
    return ir(p) === d;
  }) : Gr, f = u.filter(function(p) {
...
function y0(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, d = t.boundary, u = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, g = t.allowedAutoPlacements, m = e.options.placement, y = ht(m), w = y === m, C = a || (w || !p ? [Si(m)] : g0(m)), v = [m].concat(C).reduce(function(vt, Qe) {
      return vt.concat(ht(Qe) === yl ? m0(e, {
        placement: Qe,
        boundary: d,
        rootBoundary: u,
        padding: c,
      ...
      var V = v[B], $ = ht(V), _ = ir(V) === tr, ae = [Ie, Ye].indexOf($) >= 0, X = ae ? "width" : "height", U = Hr(e, {
        placement: V,
        boundary: d,
        rootBoundary: u,
        altBoundary: f,
        padding: c
      }), J = ae ? _ ? Xe : Pe : _ ? Ye : Ie;
      T[X] > b[X] && (J = Si(J));
      var W = Si(J), se = [];
    ...
    if (z)
      for (var ne = p ? 3 : 1, De = function(Qe) {
        var bt = v.find(function(En) {
          var wt = O.get(En);
          if (wt)
            return wt.slice(0, Qe).every(function(Nn) {
              return Nn;
            });
        });
        if (bt)
...
function Ua(n) {
  return [Ie, Xe, Ye, Pe].some(function(e) {
    return n[e] >= 0;
  });
}
function b0(n) {
  var e = n.state, t = n.name, r = e.rects.reference, i = e.rects.popper, o = e.modifiersData.preventOverflow, s = Hr(e, {
    elementContext: "reference"
  }), l = Hr(e, {
    altBoundary: !0
  }), a = Ka(s, r), c = Ka(l, i, o), d = Ua(a), u = Ua(c);
  e.modifiersData[t] = {
...
function k0(n, e, t) {
  ...
  return s = s || 0, l = (l || 0) * i, [Pe, Xe].indexOf(r) >= 0 ? {
    x: l,
    y: s
  } : {
    x: s,
...
function x0(n) {
  var e = n.state, t = n.options, r = n.name, i = t.offset, o = i === void 0 ? [0, 0] : i, s = ku.reduce(function(d, u) {
    return d[u] = k0(u, e.rects, o), d;
...
function A0(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, d = t.altBoundary, u = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, g = p === void 0 ? 0 : p, m = Hr(e, {
    boundary: a,
    rootBoundary: c,
    padding: u,
    altBoundary: d
  }), y = ht(e.placement), w = ir(e.placement), C = !w, v = wl(y), T = T0(v), b = e.modifiersData.popperOffsets, O = e.rects.reference, z = e.rects.popper, A = typeof g == "function" ? g(Object.assign({}, e.rects, {
    placement: e.placement
  })) : g, B = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
  ...
  if (b) {
    if (o) {
      var _, ae = v === "y" ? Ie : Pe, X = v === "y" ? Ye : Xe, U = v === "y" ? "height" : "width", J = b[v], W = J + m[ae], se = J - m[X], ne = h ? -z[U] / 2 : 0, De = w === tr ? O[U] : z[U], fe = w === tr ? -z[U] : -O[U], Fe = e.elements.arrow, vt = h && Fe ? bl(Fe) : {
        width: 0,
        height: 0
      }, Qe = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Mu(), bt = Qe[ae], En = Qe[X], wt = xr(0, O[U], vt[U]), Nn = C ? O[U] / 2 - ne - wt - bt - B.mainAxis : De - wt - bt - B.mainAxis, Lt = C ? -O[U] / 2 + ne + wt + En + B.mainAxis : fe + wt + En + B.mainAxis, Dn = e.elements.arrow && Yr(e.elements.arrow), Xr = Dn ? v === "y" ? Dn.clientTop || 0 : Dn.clientLeft || 0 : 0, ar = (_ = V == null ? void 0 : V[v]) != null ? _ : 0, Qr = J + Nn - ar - Xr, Zr = J + Lt - ar, cr = xr(h ? _i(W, Qr) : W, J, h ? wn(se, Zr) : se);
      b[v] = cr, $[v] = cr - J;
    }
    if (l) {
      var dr, ei = v === "x" ? Ie : Pe, ti = v === "x" ? Ye : Xe, kt = b[T], It = T === "y" ? "height" : "width", ur = kt + m[ei], nn = kt - m[ti], fr = [Ie, Pe].indexOf(y) !== -1, ni = (dr = V == null ? void 0 : V[T]) != null ? dr : 0, ri = fr ? ur : kt - O[It] - z[It] - ni + B.altAxis, ii = fr ? kt + O[It] + z[It] - ni - B.altAxis : nn, oi = h && fr ? X1(ri, kt, ii) : xr(h ? ri : ur, kt, h ? ii : nn);
      b[T] = oi, $[T] = oi - kt;
    }
    e.modifiersData[r] = $;
  }
...
function R0(n, e, t) {
  t === void 0 && (t = !1);
  var r = Ge(e), i = Ge(e) && D0(e), o = tn(e), s = rr(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  Cl(o)) && (l = N0(e)), Ge(e) ? (a = rr(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = xl(o))), {
...
function z0(n) {
  n === void 0 && (n = {});
  var e = n, t = e.defaultModifiers, r = t === void 0 ? [] : t, i = e.defaultOptions, o = i === void 0 ? Ja : i;
    ...
    var d = {
      ...
      setOptions: function(y) {
        ...
        g(), d.options = Object.assign({}, o, d.options, w), d.scrollParents = {
          reference: Tn(l) ? Cr(l) : l.contextElement ? Cr(l.contextElement) : [],
          popper: Cr(a)
        };
        var C = I0(B0([].concat(r, d.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ga(w, C)) {
            d.rects = {
              reference: R0(w, Yr(C), d.options.strategy === "fixed"),
              popper: bl(C)
...
var H0 = [l0, M0, o0, xu, C0, v0, O0, t0, w0], V0 = /* @__PURE__ */ z0({
  defaultModifiers: H0
}), F0 = "tippy-box", Nu = "tippy-content", $0 = "tippy-backdrop", Du = "tippy-arrow", Ru = "tippy-svg-arrow", sn = {
  passive: !0,
  capture: !0
}, Lu = function() {
...
function U0(n) {
  return Sl(n, "NodeList");
}
function J0(n) {
  return Sl(n, "MouseEvent");
}
function G0(n) {
  return !!(n && n._tippy && n._tippy.reference === n);
}
function Y0(n) {
  return Vr(n) ? [n] : U0(n) ? qi(n) : Array.isArray(n) ? n : qi(document.querySelectorAll(n));
}
function Go(n, e) {
...
function Q0(n, e) {
  ...
  return n.every(function(i) {
    var o = i.popperRect, s = i.popperState, l = i.props, a = l.interactiveBorder, c = K0(s.placement), d = s.modifiersData.offset;
    if (!d)
      return !0;
...
function Z0() {
  ct.isTouch || (ct.isTouch = !0, window.performance && document.addEventListener("mousemove", Pu));
}
function Pu() {
  var n = performance.now();
  n - tc < 20 && (ct.isTouch = !1, document.removeEventListener("mousemove", Pu)), tc = n;
}
function ey() {
...
function ty() {
  document.addEventListener("touchstart", Z0, sn), window.addEventListener("blur", ey);
}
var ny = typeof window < "u" && typeof document < "u", ry = ny ? (
  // @ts-ignore
  !!window.msCrypto
) : !1;
function Bn(n) {
...
var Fr;
process.env.NODE_ENV !== "production" && oy();
function oy() {
  Fr = /* @__PURE__ */ new Set();
}
function Ot(n, e) {
  if (n && !Fr.has(e)) {
    var t;
    Fr.add(e), (t = console).warn.apply(t, Bu(e));
  }
}
function Es(n, e) {
  if (n && !Fr.has(e)) {
    var t;
    Fr.add(e), (t = console).error.apply(t, Bu(e));
  }
}
function sy(n) {
  var e = !n, t = Object.prototype.toString.call(n) === "[object Object]" && !n.addEventListener;
  Es(e, ["tippy() was passed", "`" + String(n) + "`", "as its targets (first) argument. Valid types are: String, Element,", "Element[], or NodeList."].join(" ")), Es(t, ["tippy() was passed a plain object which is not supported as an argument", "for virtual positioning. Use props.getReferenceClientRect instead."].join(" "));
}
var zu = {
  animateFill: !1,
  followCursor: !1,
  ...
  triggerTarget: null
}, zu, ly), ay = Object.keys(He), cy = function(e) {
  process.env.NODE_ENV !== "production" && Vu(e, []);
  var t = Object.keys(e);
...
function dy(n, e) {
  var t = e ? Object.keys(Hu(Object.assign({}, He, {
    plugins: e
  }))) : ay, r = t.reduce(function(i, o) {
...
function rc(n, e) {
  var t = Object.assign({}, e, {
    content: Iu(e.content, [n])
  }, e.ignoreAttributes ? {} : dy(n, e.plugins));
...
function Vu(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = W0(He, Object.keys(zu)), o = !j0(i, r);
...
function ic(n) {
  var e = Sr();
  return n === !0 ? e.className = Du : (e.className = Ru, Vr(n) ? e.appendChild(n) : Ns(e, n)), e;
}
function oc(n, e) {
  Vr(e.content) ? (Ns(n, ""), n.appendChild(e.content)) : typeof e.content != "function" && (e.allowHTML ? Ns(n, e.content) : n.textContent = e.content);
}
function Ds(n) {
  var e = n.firstElementChild, t = qi(e.children);
  return {
    box: e,
    content: t.find(function(r) {
      return r.classList.contains(Nu);
    }),
    arrow: t.find(function(r) {
      return r.classList.contains(Du) || r.classList.contains(Ru);
    }),
    backdrop: t.find(function(r) {
      return r.classList.contains($0);
    })
  };
}
function Fu(n) {
  var e = Sr(), t = Sr();
  t.className = F0, t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1");
  var r = Sr();
  r.className = Nu, r.setAttribute("data-state", "hidden"), oc(r, n.props), e.appendChild(t), t.appendChild(r), i(n.props, n.props);
  function i(o, s) {
    var l = Ds(e), a = l.box, c = l.content, d = l.arrow;
    s.theme ? a.setAttribute("data-theme", s.theme) : a.removeAttribute("data-theme"), typeof s.animation == "string" ? a.setAttribute("data-animation", s.animation) : a.removeAttribute("data-animation"), s.inertia ? a.setAttribute("data-inertia", "") : a.removeAttribute("data-inertia"), a.style.maxWidth = typeof s.maxWidth == "number" ? s.maxWidth + "px" : s.maxWidth, s.role ? a.setAttribute("role", s.role) : a.removeAttribute("role"), (o.content !== s.content || o.allowHTML !== s.allowHTML) && oc(c, n.props), s.arrow ? d ? o.arrow !== s.arrow && (a.removeChild(d), a.appendChild(ic(s.arrow))) : a.appendChild(ic(s.arrow)) : d && a.removeChild(d);
  }
  return {
    popper: e,
    onUpdate: i
...
var fy = 1, fi = [], Xo = [];
function hy(n, e) {
  var t = rc(n, Object.assign({}, He, Hu(Qa(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, d, u, f, h = [], p = Ya(Qr, t.interactiveDebounce), g, m = fy++, y = null, w = q0(t.plugins), C = {
  ...
  if (!t.render)
    return process.env.NODE_ENV !== "production" && Es(!0, "render() function has not been supplied."), v;
  ...
  return Dn(), ne(), J(), W("onCreate", [v]), t.showOnCreate && ur(), b.addEventListener("mouseenter", function() {
  ...
  function U(k) {
    return v.state.isMounted && !v.state.isVisible || ct.isTouch || d && d.type === "focus" ? 0 : Jo(v.props.delay, k ? 0 : 1, He.delay);
  }
  function J(k) {
  ...
  function se() {
    var k = v.props.aria;
    if (k.content) {
      var N = "aria-" + k.content, P = b.id, q = Fn(v.props.triggerTarget || n);
  ...
  function ne() {
    if (!(A || !v.props.aria.expanded)) {
      var k = Fn(v.props.triggerTarget || n);
  ...
  function De() {
    ae().removeEventListener("mousemove", p), fi = fi.filter(function(k) {
      return k !== p;
    });
  }
  function fe(k) {
    if (!(ct.isTouch && (a || k.type === "mousedown"))) {
      ...
      if (!(v.props.interactive && ec(b, N))) {
        if (Fn(v.props.triggerTarget || n).some(function(P) {
          return ec(P, N);
        })) {
  ...
  function Qe() {
    var k = ae();
    k.addEventListener("mousedown", fe, !0), k.addEventListener("touchend", fe, sn), k.addEventListener("touchstart", vt, sn), k.addEventListener("touchmove", Fe, sn);
  }
  function bt() {
    var k = ae();
    k.removeEventListener("mousedown", fe, !0), k.removeEventListener("touchend", fe, sn), k.removeEventListener("touchstart", vt, sn), k.removeEventListener("touchmove", Fe, sn);
  }
  function En(k, N) {
    Nn(k, function() {
  ...
  function Nn(k, N) {
    var P = X().box;
    function q(j) {
      j.target === P && (Yo(P, "remove", q), N());
    }
    if (k === 0)
      return N();
    Yo(P, "remove", u), Yo(P, "add", q), u = q;
  }
  function Lt(k, N, P) {
    P === void 0 && (P = !1);
    var q = Fn(v.props.triggerTarget || n);
    q.forEach(function(j) {
  ...
  function Dn() {
    V() && (Lt("touchstart", ar, {
      ...
      passive: !0
    })), _0(v.props.trigger).forEach(function(k) {
      if (k !== "manual")
        switch (Lt(k, ar), k) {
          case "mouseenter":
            Lt("mouseleave", Zr);
  ...
  function ar(k) {
    ...
    if (!(!v.state.isEnabled || dr(k) || l)) {
      ...
      d = k, g = k.currentTarget, ne(), !v.state.isVisible && J0(k) && fi.forEach(function(j) {
        return j(k);
      }), k.type === "click" && (v.props.trigger.indexOf("mouseenter") < 0 || s) && v.props.hideOnClick !== !1 && v.state.isVisible ? P = !0 : ur(k), k.type === "click" && (s = !P), P && !q && nn(k);
    }
  }
  function Qr(k) {
    var N = k.target, P = _().contains(N) || b.contains(N);
    if (!(k.type === "mousemove" && P)) {
      var q = It().concat(b).map(function(j) {
        var Se, $e = j._tippy, Rn = (Se = $e.popperInstance) == null ? void 0 : Se.state;
        return Rn ? {
  ...
  function cr(k) {
    v.props.trigger.indexOf("focusin") < 0 && k.target !== _() || v.props.interactive && k.relatedTarget && b.contains(k.relatedTarget) || nn(k);
  }
  function dr(k) {
  ...
  function ei() {
    ti();
    var k = v.props, N = k.popperOptions, P = k.placement, q = k.offset, j = k.getReferenceClientRect, Se = k.moveTransition, $e = $() ? Ds(b).arrow : null, Rn = j ? {
      ...
      fn: function(si) {
        ...
        if ($()) {
          ...
          ["placement", "reference-hidden", "escaped"].forEach(function(li) {
            li === "placement" ? Ao.setAttribute("data-placement", Ln.placement) : Ln.attributes.popper["data-popper-" + li] ? Ao.setAttribute("data-" + li, "") : Ao.removeAttribute("data-" + li);
    ...
    }), rn.push.apply(rn, (N == null ? void 0 : N.modifiers) || []), v.popperInstance = V0(Rn, b, Object.assign({}, N, {
      placement: P,
      onFirstUpdate: f,
      modifiers: rn
    }));
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function It() {
    return qi(b.querySelectorAll("[data-tippy-root]"));
  }
  function ur(k) {
    v.clearDelayTimeouts(), k && W("onTrigger", [v, k]), Qe();
  ...
  function ii(k) {
    if (process.env.NODE_ENV !== "production" && Ot(v.state.isDestroyed, Bn("setProps")), !v.state.isDestroyed) {
      W("onBeforeUpdate", [v, k]), Xr();
      var N = v.props, P = rc(n, Object.assign({}, N, Qa(k), {
        ignoreAttributes: !0
      }));
      v.props = P, Dn(), N.interactiveDebounce !== P.interactiveDebounce && (De(), p = Ya(Qr, P.interactiveDebounce)), N.triggerTarget && !P.triggerTarget ? Fn(N.triggerTarget).forEach(function(q) {
        q.removeAttribute("aria-expanded");
      }) : P.triggerTarget && n.removeAttribute("aria-expanded"), ne(), J(), O && O(N, P), v.popperInstance && (ei(), It().forEach(function(q) {
  ...
  function hf() {
    process.env.NODE_ENV !== "production" && Ot(v.state.isDestroyed, Bn("show"));
    var k = v.state.isVisible, N = v.state.isDestroyed, P = !v.state.isEnabled, q = ct.isTouch && !v.props.touch, j = Jo(v.props.duration, 0, He.duration);
    if (!(k || N || P || q) && !_().hasAttribute("disabled") && (W("onShow", [v], !1), v.props.onShow(v) !== !1)) {
      if (v.state.isVisible = !0, $() && (b.style.visibility = "visible"), J(), Qe(), v.state.isMounted || (b.style.transition = "none"), $()) {
        var Se = X(), $e = Se.box, Rn = Se.content;
        Go([$e, Rn], 0);
      }
      f = function() {
        var rn;
        if (!(!v.state.isVisible || c)) {
          if (c = !0, b.offsetHeight, b.style.transition = v.props.moveTransition, $() && v.props.animation) {
            var To = X(), si = To.box, Ln = To.content;
            Go([si, Ln], j), Za([si, Ln], "visible");
          }
          se(), ne(), Xa(Xo, v), (rn = v.popperInstance) == null || rn.forceUpdate(), W("onMount", [v]), v.props.animation && $() && wt(j, function() {
  ...
  function pf() {
    process.env.NODE_ENV !== "production" && Ot(v.state.isDestroyed, Bn("hide"));
    var k = !v.state.isVisible, N = v.state.isDestroyed, P = !v.state.isEnabled, q = Jo(v.props.duration, 1, He.duration);
    if (!(k || N || P) && (W("onHide", [v], !1), v.props.onHide(v) !== !1)) {
      if (v.state.isVisible = !1, v.state.isShown = !1, c = !1, s = !1, $() && (b.style.visibility = "hidden"), De(), bt(), J(!0), $()) {
        ...
        v.props.animation && (Go([Se, $e], q), Za([Se, $e], "hidden"));
      }
      se(), ne(), v.props.animation ? $() && En(q, v.unmount) : v.unmount();
    }
  }
  function mf(k) {
    process.env.NODE_ENV !== "production" && Ot(v.state.isDestroyed, Bn("hideWithInteractivity")), ae().addEventListener("mousemove", p), Xa(fi, p), p(k);
  }
  function gf() {
    process.env.NODE_ENV !== "production" && Ot(v.state.isDestroyed, Bn("unmount")), v.state.isVisible && v.hide(), v.state.isMounted && (ti(), It().forEach(function(k) {
      k._tippy.unmount();
    }), b.parentNode && b.parentNode.removeChild(b), Xo = Xo.filter(function(k) {
      return k !== v;
    }), v.state.isMounted = !1, W("onHidden", [v]));
  }
  function yf() {
    process.env.NODE_ENV !== "production" && Ot(v.state.isDestroyed, Bn("destroy")), !v.state.isDestroyed && (v.clearDelayTimeouts(), v.unmount(), Xr(), delete n._tippy, v.state.isDestroyed = !0, W("onDestroy", [v]));
  }
}
function On(n, e) {
  e === void 0 && (e = {});
  var t = He.plugins.concat(e.plugins || []);
  process.env.NODE_ENV !== "production" && (sy(n), Vu(e, t)), ty();
  var r = Object.assign({}, e, {
    plugins: t
  }), i = Y0(n);
  if (process.env.NODE_ENV !== "production") {
    var o = Vr(r.content), s = i.length > 1;
...
class py {
  constructor({ editor: e, element: t, view: r, tippyOptions: i = {}, updateDelay: o = 250, shouldShow: s }) {
    this.preventHide = !1, this.shouldShow = ({ view: l, state: a, from: c, to: d }) => {
      const { doc: u, selection: f } = a, { empty: h } = f, p = !u.textBetween(c, d).length && hl(a.selection), g = this.element.contains(document.activeElement);
...
class my {
  ...
  update(e, t) {
    ...
    (i = this.tippy) === null || i === void 0 || i.setProps({
      getReferenceClientRect: ((o = this.tippyOptions) === null || o === void 0 ? void 0 : o.getReferenceClientRect) || (() => bu(e, c, d))
    }), this.show();
  }
  show() {
    var e;
...
const gy = _r({
  ...
  setup(n, { slots: e }) {
    ...
    return zc(() => {
      ...
      var r;
      return pn("div", { ref: t }, (r = e.default) === null || r === void 0 ? void 0 : r.call(e));
    };
  }
});
function sc(n) {
...
class yy extends D1 {
  constructor(e = {}) {
    return super(e), this.vueRenderers = Hc(/* @__PURE__ */ new Map()), this.contentComponent = null, this.reactiveState = sc(this.view.state), this.reactiveExtensionStorage = sc(this.extensionStorage), this.on("transaction", () => {
...
const vy = _r({
  ...
  setup(n) {
    ...
    return kf(() => {
      const r = n.editor;
      r && r.options.element && e.value && xf(() => {
...
class by {
  constructor(e, { props: t = {}, editor: r }) {
    if (this.id = Math.floor(Math.random() * 4294967295).toString(), this.editor = r, this.component = Vc(e), this.teleportElement = document.createElement("div"), this.element = this.teleportElement, this.props = Hc(t), this.editor.vueRenderers.set(this.id, this), this.editor.contentComponent) {
...
const wy = /^\s*>\s$/, Wu = le.create({
...
}), ky = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, xy = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, Cy = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, Sy = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, My = Be.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Ty.name, this.editor.getAttributes(lc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), Oy = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))$/, Ey = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))/g, Ny = Be.create({
  name: "code",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  dragover(e) {
    ...
    if (t && !o) {
      ...
      if (this.editorView.dragging && this.editorView.dragging.slice) {
        let l = cd(this.editorView.state.doc, s, this.editorView.dragging.slice);
        l != null && (s = l);
      }
...
function Fy() {
  return new te({
    props: {
      ...
      handleClick: jy,
      handleKeyDown: $y,
      handleDOMEvents: { beforeinput: Wy }
    }
  });
}
const $y = ol({
...
`;
  ...
  addInputRules() {
    return this.options.levels.map((n) => Ts({
...
var Ki = 200, me = function() {
};
me.prototype.append = function(e) {
  return e.length ? (e = me.from(e), !this.length && e || e.length < Ki && this.leafAppend(e) || this.length < Ki && e.leafPrepend(this) || this.appendInner(e)) : this;
};
...
me.from = function(e) {
  return e instanceof me ? e : e && e.length ? new _u(e) : me.empty;
};
var _u = /* @__PURE__ */ function(n) {
  function e(r) {
...
class tt {
  ...
  popEvent(e, t) {
    ...
    return this.items.forEach((u, f) => {
      ...
      if (i) {
        ...
        s.maybeStep(u.step);
      if (u.selection)
        return l = i ? u.selection.map(i.slice(o)) : u.selection, a = new tt(this.items.slice(0, r).append(d.reverse().concat(c)), this.eventCount - 1), !1;
  ...
  addTransform(e, t, r, i) {
    ...
    let c = s - r.depth;
    return c > Xy && (l = Yy(l, c), s -= c), new tt(l.append(o), s);
  }
  remapping(e, t) {
    let r = new Un();
  ...
  addMaps(e) {
    return this.eventCount == 0 ? this : new tt(this.items.append(e.map((t) => new ot(t))), this.eventCount);
  }
  ...
  rebased(e, t) {
    ...
    let d = this.items.slice(0, i).append(c).append(r), u = new tt(d, l);
    return u.emptyItemCount() > Gy && (u = u.compress(this.items.length - r.length)), u;
  }
  emptyItemCount() {
    let e = 0;
  ...
  compress(e = this.items.length) {
    ...
    }, this.items.length, 0), new tt(me.from(i.reverse()), o);
  }
}
tt.empty = new tt(me.empty, 0);
function Yy(n, e) {
  let t;
...
function Qy(n, e, t, r) {
  ...
  t.getMeta(tv) && (n = new Ht(n.done, n.undone, null, 0, -1));
  let s = t.getMeta("appendedTransaction");
  if (t.steps.length == 0)
    return n;
  if (s && s.getMeta(kn))
    return s.getMeta(kn).redo ? new Ht(n.done.addTransform(t, void 0, r, Mi(e)), n.undone, cc(t.mapping.maps[t.steps.length - 1]), n.prevTime, n.prevComposition) : new Ht(n.done, n.undone.addTransform(t, void 0, r, Mi(e)), null, n.prevTime, n.prevComposition);
  if (t.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !s && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !Zy(t, n.prevRanges)), c = s ? Qo(n.prevRanges, t.mapping) : cc(t.mapping.maps[t.steps.length - 1]);
    return new Ht(n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, Mi(e)), tt.empty, c, t.time, l ?? n.prevComposition);
  } else return (o = t.getMeta("rebased")) ? new Ht(n.done.rebased(t, o), n.undone.rebased(t, o), Qo(n.prevRanges, t.mapping), n.prevTime, n.prevComposition) : new Ht(n.done.addMaps(t.mapping.maps), n.undone.addMaps(t.mapping.maps), Qo(n.prevRanges, t.mapping), n.prevTime, n.prevComposition);
}
function Zy(n, e) {
  if (!e)
    return !1;
...
function ev(n, e, t) {
  let r = Mi(e), i = kn.get(e).spec.config, o = (t ? n.undone : n.done).popEvent(e, r);
  if (!o)
    return null;
...
const kn = new ue("history"), tv = new ue("closeHistory");
function nv(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    state: {
      init() {
        return new Ht(tt.empty, tt.empty, null, 0, -1);
      },
      apply(e, t, r) {
        return Qy(t, r, e, n);
      }
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let r = t.inputType, i = r == "historyUndo" ? Ku : r == "historyRedo" ? Uu : null;
...
const Ku = qu(!1, !0), Uu = qu(!0, !0), rv = oe.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
  ...
  addCommands() {
    return {
      ...
      redo: () => ({ state: n, dispatch: e }) => Uu(n, e)
    };
  },
  addProseMirrorPlugins() {
    return [
...
}), ov = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, sv = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, lv = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, av = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, cv = Be.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(uv.name, this.editor.getAttributes(uc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (n = Br({
      ...
      keepMarks: this.options.keepMarks,
      keepAttributes: this.options.keepAttributes,
      getAttributes: (e) => ({ start: +e[1], ...this.editor.getAttributes(uc.name) }),
      joinPredicate: (e, t) => t.childCount + t.attrs.start === +e[1],
      editor: this.editor
    })), [
      n
...
}), pv = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, mv = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, gv = Be.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addExtensions() {
    ...
    const w = [];
    return this.options.blockquote !== !1 && w.push(Wu.configure((n = this.options) === null || n === void 0 ? void 0 : n.blockquote)), this.options.bold !== !1 && w.push(My.configure((e = this.options) === null || e === void 0 ? void 0 : e.bold)), this.options.bulletList !== !1 && w.push(Ay.configure((t = this.options) === null || t === void 0 ? void 0 : t.bulletList)), this.options.code !== !1 && w.push(Ny.configure((r = this.options) === null || r === void 0 ? void 0 : r.code)), this.options.codeBlock !== !1 && w.push(Ly.configure((i = this.options) === null || i === void 0 ? void 0 : i.codeBlock)), this.options.document !== !1 && w.push(Iy.configure((o = this.options) === null || o === void 0 ? void 0 : o.document)), this.options.dropcursor !== !1 && w.push(zy.configure((s = this.options) === null || s === void 0 ? void 0 : s.dropcursor)), this.options.gapcursor !== !1 && w.push(qy.configure((l = this.options) === null || l === void 0 ? void 0 : l.gapcursor)), this.options.hardBreak !== !1 && w.push(Ky.configure((a = this.options) === null || a === void 0 ? void 0 : a.hardBreak)), this.options.heading !== !1 && w.push(Uy.configure((c = this.options) === null || c === void 0 ? void 0 : c.heading)), this.options.history !== !1 && w.push(rv.configure((d = this.options) === null || d === void 0 ? void 0 : d.history)), this.options.horizontalRule !== !1 && w.push(iv.configure((u = this.options) === null || u === void 0 ? void 0 : u.horizontalRule)), this.options.italic !== !1 && w.push(cv.configure((f = this.options) === null || f === void 0 ? void 0 : f.italic)), this.options.listItem !== !1 && w.push(dv.configure((h = this.options) === null || h === void 0 ? void 0 : h.listItem)), this.options.orderedList !== !1 && w.push(fv.configure((p = this.options) === null || p === void 0 ? void 0 : p.orderedList)), this.options.paragraph !== !1 && w.push(hv.configure((g = this.options) === null || g === void 0 ? void 0 : g.paragraph)), this.options.strike !== !1 && w.push(gv.configure((m = this.options) === null || m === void 0 ? void 0 : m.strike)), this.options.text !== !1 && w.push(yv.configure((y = this.options) === null || y === void 0 ? void 0 : y.text)), w;
  }
}), bv = "ö", wv = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5تصالات6رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", or = (n, e) => {
  for (const t in e)
    n[t] = e[t];
  return n;
}, Rs = "numeric", Ls = "ascii", Is = "alpha", Ti = "asciinumeric", pi = "alphanumeric", Ps = "domain", Ju = "emoji", kv = "scheme", xv = "slashscheme", hc = "whitespace";
function Cv(n, e) {
  return n in e || (e[n] = []), e[n];
}
function hn(n, e, t) {
  e[Rs] && (e[Ti] = !0, e[pi] = !0), e[Ls] && (e[Ti] = !0, e[Is] = !0), e[Ti] && (e[pi] = !0), e[Is] && (e[pi] = !0), e[pi] && (e[Ps] = !0), e[Ju] && (e[Ps] = !0);
  for (const r in e) {
    const i = Cv(r, t);
...
Re.prototype = {
  ...
  tr(n, e, t, r) {
    r = r || Re.groups;
    let i;
    return e && e.j ? i = e : (i = new Re(e), t && r && hn(e, t, r)), this.jr.push([n, i]), i;
  },
  /**
...
const D = (n, e, t, r, i) => n.ta(e, t, r, i), We = (n, e, t, r, i) => n.tr(e, t, r, i), pc = (n, e, t, r, i) => n.ts(e, t, r, i), S = (n, e, t, r, i) => n.tt(e, t, r, i), Mt = "WORD", Bs = "UWORD", $r = "LOCALHOST", zs = "TLD", Hs = "UTLD", Ai = "SCHEME", $n = "SLASH_SCHEME", Tl = "NUM", Gu = "WS", Al = "NL", _n = "OPENBRACE", Mr = "OPENBRACKET", Tr = "OPENANGLEBRACKET", Ar = "OPENPAREN", cn = "CLOSEBRACE", qn = "CLOSEBRACKET", Kn = "CLOSEANGLEBRACKET", dn = "CLOSEPAREN", Ui = "AMPERSAND", Ji = "APOSTROPHE", Gi = "ASTERISK", Vt = "AT", Yi = "BACKSLASH", Xi = "BACKTICK", Qi = "CARET", $t = "COLON", Ol = "COMMA", Zi = "DOLLAR", st = "DOT", eo = "EQUALS", El = "EXCLAMATION", lt = "HYPHEN", to = "PERCENT", no = "PIPE", ro = "PLUS", io = "POUND", oo = "QUERY", Nl = "QUOTE", Dl = "SEMI", at = "SLASH", Or = "TILDE", so = "UNDERSCORE", Yu = "EMOJI", lo = "SYM";
...
const zn = /[a-z]/, es = new RegExp("\\p{L}", "u"), ts = new RegExp("\\p{Emoji}", "u"), ns = /\d/, mc = /\s/, gc = `
`, Mv = "️", Tv = "‍";
let mi = null, gi = null;
function Av(n) {
  n === void 0 && (n = []);
  ...
  Re.groups = e;
  const t = new Re();
  mi == null && (mi = yc(bv)), gi == null && (gi = yc(wv)), S(t, "'", Ji), S(t, "{", _n), S(t, "[", Mr), S(t, "<", Tr), S(t, "(", Ar), S(t, "}", cn), S(t, "]", qn), S(t, ">", Kn), S(t, ")", dn), S(t, "&", Ui), S(t, "*", Gi), S(t, "@", Vt), S(t, "`", Xi), S(t, "^", Qi), S(t, ":", $t), S(t, ",", Ol), S(t, "$", Zi), S(t, ".", st), S(t, "=", eo), S(t, "!", El), S(t, "-", lt), S(t, "%", to), S(t, "|", no), S(t, "+", ro), S(t, "#", io), S(t, "?", oo), S(t, '"', Nl), S(t, "/", at), S(t, ";", Dl), S(t, "~", Or), S(t, "_", so), S(t, "\\", Yi);
  const r = We(t, ns, Tl, {
    [Rs]: !0
  });
  We(r, ns, r);
  ...
  const a = S(l, Tv);
  We(a, ts, l);
  const c = [[zn, i]], d = [[zn, null], [es, o]];
  for (let u = 0; u < mi.length; u++)
    Pt(t, mi[u], zs, Mt, c);
  for (let u = 0; u < gi.length; u++)
    Pt(t, gi[u], Hs, Bs, d);
  hn(zs, {
    tld: !0,
    ascii: !0
    ...
    utld: !0,
    alpha: !0
  }, e), Pt(t, "file", Ai, Mt, c), Pt(t, "mailto", Ai, Mt, c), Pt(t, "http", $n, Mt, c), Pt(t, "https", $n, Mt, c), Pt(t, "ftp", $n, Mt, c), Pt(t, "ftps", $n, Mt, c), hn(Ai, {
    scheme: !0,
    ascii: !0
  }, e), hn($n, {
    slashscheme: !0,
  ...
  for (let u = 0; u < n.length; u++) {
    ...
    f.indexOf("-") >= 0 ? p[Ps] = !0 : zn.test(f) ? ns.test(f) ? p[Ti] = !0 : p[Ls] = !0 : p[Rs] = !0, pc(t, f, f, p);
  }
  return pc(t, "localhost", $r, {
    ascii: !0
  }), t.jd = new Re(lo), {
    start: t,
    tokens: or({
...
function Ov(n, e) {
  const t = Ev(e.replace(/[A-Z]/g, (l) => l.toLowerCase())), r = t.length, i = [];
  let o = 0, s = 0;
  for (; s < r; ) {
...
function Rl(n, e) {
  e === void 0 && (e = null);
  let t = or({}, jr);
  n && (t = or(t, n instanceof Rl ? n.o : n));
...
Rl.prototype = {
  ...
  get(n, e, t) {
    const r = e != null;
    let i = this.o[n];
    return i && (typeof i == "object" ? (i = t.t in i ? i[t.t] : jr[n], typeof i == "function" && r && (i = i(e, t))) : typeof i == "function" && r && (i = i(e, t.t, t)), i);
  },
  /**
...
Qu.prototype = {
  ...
  */
  toObject(n) {
    return n === void 0 && (n = jr.defaultProtocol), {
      type: this.t,
      value: this.toString(),
      isLink: this.isLink,
      href: this.toHref(n),
...
const bc = So("email", {
  ...
  */
  toHref(n) {
    return n === void 0 && (n = jr.defaultProtocol), this.hasProtocol() ? this.v : `${n}://${this.v}`;
  },
  /**
  ...
  hasProtocol() {
    const n = this.tk;
    return n.length >= 2 && n[0].t !== $r && n[1].t === $t;
  }
}), he = (n) => new Re(n);
function Dv(n) {
  let {
  ...
  const t = e.domain.concat([Ui, Gi, Vt, Yi, Xi, Qi, Zi, eo, lt, Tl, to, no, ro, io, at, lo, Or, so]), r = [Ji, Kn, cn, qn, dn, $t, Ol, st, El, Tr, _n, Mr, Ar, oo, Nl, Dl], i = [Ui, Ji, Gi, Yi, Xi, Qi, cn, Zi, eo, lt, _n, to, no, ro, io, oo, at, lo, Or, so], o = he(), s = S(o, Or);
  D(s, i, s), D(s, e.domain, s);
  const l = he(), a = he(), c = he();
  D(o, e.domain, l), D(o, e.scheme, a), D(o, e.slashscheme, c), D(l, i, s), D(l, e.domain, l);
  const d = S(l, Vt);
  S(s, Vt, d), S(a, Vt, d), S(c, Vt, d);
  const u = S(s, st);
  ...
  D(h, e.domain, f);
  const p = he(bc);
  D(h, e.tld, p), D(h, e.utld, p), S(d, $r, p);
  const g = S(f, lt);
  ...
  const C = he(on);
  D(w, e.tld, C), D(w, e.utld, C), D(C, e.domain, l), D(C, i, s), S(C, st, w), S(C, lt, y), S(C, Vt, d);
  const v = S(C, $t), T = he(on);
  D(v, e.numeric, T);
  const b = he(on), O = he();
  D(b, t, b), D(b, r, O), D(O, t, b), D(O, r, O), S(C, at, b), S(T, at, b);
  const z = S(a, $t), A = S(c, $t), B = S(A, at), V = S(B, at);
  ...
  const $ = S(b, _n), _ = S(b, Mr), ae = S(b, Tr), X = S(b, Ar);
  S(O, _n, $), S(O, Mr, _), S(O, Tr, ae), S(O, Ar, X), S($, cn, b), S(_, qn, b), S(ae, Kn, b), S(X, dn, b), S($, cn, b);
  const U = he(on), J = he(on), W = he(on), se = he(on);
  D($, t, U), D(_, t, J), D(ae, t, W), D(X, t, se);
  const ne = he(), De = he(), fe = he(), Fe = he();
  return D($, r), D(_, r), D(ae, r), D(X, r), D(U, t, U), D(J, t, J), D(W, t, W), D(se, t, se), D(U, r, U), D(J, r, J), D(W, r, W), D(se, r, se), D(ne, t, ne), D(De, t, J), D(fe, t, W), D(Fe, t, se), D(ne, r, ne), D(De, r, De), D(fe, r, fe), D(Fe, r, Fe), S(J, qn, b), S(W, Kn, b), S(se, dn, b), S(U, cn, b), S(De, qn, b), S(fe, Kn, b), S(Fe, dn, b), S(ne, dn, b), S(o, $r, C), S(o, Al, Nv), {
    start: o,
    tokens: Xu
  };
}
function Rv(n, e, t) {
  ...
  for (; i < r; ) {
    ...
    if (f < 0)
      ...
      s.length > 0 && (o.push(rs(wc, e, s)), s = []), i -= f, d -= f;
      const h = u.t, p = t.slice(i - d, i);
      o.push(rs(h, e, p));
    }
  }
  return s.length > 0 && o.push(rs(wc, e, s)), o;
}
function rs(n, e, t) {
  const r = t[0].s, i = t[t.length - 1].e, o = e.slice(r, i);
  return new n(o, t);
}
const Lv = typeof console < "u" && console && console.warn || (() => {
}), Iv = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", ee = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function kc(n, e) {
  if (e === void 0 && (e = !1), ee.initialized && Lv(`linkifyjs: already initialized - will not register custom scheme "${n}" ${Iv}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function Bv() {
  ee.scanner = Av(ee.customSchemes);
  for (let n = 0; n < ee.tokenQueue.length; n++)
    ee.tokenQueue[n][1]({
      scanner: ee.scanner
    });
  ee.parser = Dv(ee.scanner.tokens);
...
function Zu(n) {
  return ee.initialized || Bv(), Rv(ee.parser.start, n, Ov(ee.scanner.start, n));
}
function ef(n, e, t) {
...
function Hv(n) {
  return new te({
    ...
    appendTransaction: (e, t, r) => {
      ...
      if (!i || o)
        return;
      const { tr: s } = r, l = Kg(t.doc, [...e]);
      if (e1(l).forEach(({ newRange: c }) => {
        const d = Jg(r.doc, c, (h) => h.isTextblock);
        let u, f;
        if (d.length > 1 ? (u = d[0], f = r.doc.textBetween(u.pos, u.pos + u.node.nodeSize, void 0, " ")) : d.length && r.doc.textBetween(c.from, c.to, " ", " ").endsWith(" ") && (u = d[0], f = r.doc.textBetween(u.pos, c.to, void 0, " ")), u && f) {
          ...
          m.filter((y) => y.isLink).map((y) => ({
            ...
            gl(y.from, y.to, r.doc).some((w) => w.mark.type === n.type) || s.addMark(y.from, y.to, n.type.create({
              href: y.href
            }));
          });
        }
    ...
    props: {
      handleClick: (e, t, r) => {
        ...
        if (!l.find((f) => f.nodeName === "A"))
          return !1;
        const a = vu(e.state, n.type.name), c = r.target, d = (i = c == null ? void 0 : c.href) !== null && i !== void 0 ? i : a.href, u = (o = c == null ? void 0 : c.target) !== null && o !== void 0 ? o : a.target;
  ...
  return new te({
    ...
    props: {
      handlePaste: (e, t, r) => {
        ...
        const a = ef(l).find((c) => c.isLink && c.value === l);
...
const $v = Be.create({
    ...
    return [
      Xt({
        find: (n) => {
          const e = [];
          if (n) {
            const t = ef(n).filter((r) => r.isLink);
  ...
  addProseMirrorPlugins() {
    const n = [];
    return this.options.autolink && n.push(Hv({
      type: this.type,
      validate: this.options.validate
    })), this.options.openOnClick && n.push(Vv({
      type: this.type,
...
if (typeof WeakMap < "u") {
  ...
  Vs = (e) => n.get(e), Fs = (e, t) => (n.set(e, t), t);
} else {
  const n = [];
  let t = 0;
  Vs = (r) => {
...
function qv(n, e, t) {
  ...
  for (let i = 0; i < n.map.length; i++) {
    ...
    for (let c = 0; c < a.colspan; c++) {
      ...
      u != null && (!a.colwidth || a.colwidth[c] != u) && ((l || (l = Kv(a)))[c] = u);
    }
...
var Xv = class rf {
  ...
  map(e) {
    return new rf(e.map(this.anchor), e.map(this.head));
  }
  resolve(e) {
    const t = e.resolve(this.anchor), r = e.resolve(this.head);
    return t.parent.type.spec.tableRole == "row" && r.parent.type.spec.tableRole == "row" && t.index() < t.parent.childCount && r.index() < r.parent.childCount && Ll(t, r) ? new Y(t, r) : I.near(r, 1);
  }
};
function Qv(n) {
...
function tb(n, e, t) {
  ...
  } else r instanceof L && Zv(r) ? o = L.create(i, r.from) : r instanceof L && eb(r) && (o = L.create(i, r.$from.start(), r.$from.end()));
  return o && (e || (e = n.tr)).setSelection(o), e;
}
var nb = new ue("fix-tables");
function of(n, e, t, r) {
  ...
  e:
    for (let s = 0, l = 0; s < o; s++) {
      ...
      r(a, t), l < i && n.child(l).sameMarkup(a) ? of(n.child(l), a, t + 1, r) : a.nodesBetween(0, a.content.size, r, t + 1), t += a.nodeSize;
    }
}
function sf(n, e) {
  let t;
  const r = (i, o) => {
    i.type.spec.tableRole == "table" && (t = rb(n, i, o, t));
  };
  return e ? e.doc != n.doc && of(e.doc, n.doc, 0, r) : n.doc.descendants(r), t;
}
function rb(n, e, t, r) {
  const i = ie.get(e);
  if (!i.problems)
  ...
  return r.setMeta(nb, { fixTables: !0 });
}
function ib(n) {
  if (!n.size)
    return null;
...
function js(n, e) {
  ...
  return new Gs(t).replace(0, t.content.size, e).doc;
}
function sb({ width: n, height: e, rows: t }, r, i) {
  if (n != r) {
    const o = [], s = [];
...
function Sc(n, e, t, r, i) {
  ...
  lb(u, s, o, t, c, d, f) && h(), xc(u, s, o, t, a, c, l, f) && h(), xc(u, s, o, t, a, c, d, f) && h(), Cc(u, s, o, t, l, d, a, f) && h(), Cc(u, s, o, t, l, d, c, f) && h();
  for (let p = l; p < d; p++) {
...
var ab = ol({
  ...
  ArrowUp: yi("vert", -1),
  ArrowDown: yi("vert", 1),
  "Shift-ArrowLeft": vi("horiz", -1),
  "Shift-ArrowRight": vi("horiz", 1),
  "Shift-ArrowUp": vi("vert", -1),
  "Shift-ArrowDown": vi("vert", 1),
  Backspace: bi,
  "Mod-Backspace": bi,
  Delete: bi,
  "Mod-Delete": bi
...
function yi(n, e) {
  return (t, r, i) => {
    ...
    {
      const l = t.doc.resolve(s), a = tf(l, n, e);
      let c;
      return a ? c = I.near(a, 1) : e < 0 ? c = I.near(t.doc.resolve(l.before(-1)), -1) : c = I.near(t.doc.resolve(l.after(-1)), 1), Oi(t, r, c);
    }
  };
}
function vi(n, e) {
...
function db(n, e, t) {
  ...
  if (i instanceof Y) {
    ...
    return r = sb(r, l.right - l.left, l.bottom - l.top), Sc(n.state, n.dispatch, s, l, r), !0;
  } else if (r) {
...
function ub(n, e) {
  ...
  else if (e.shiftKey && r && (i = lr(n.state.selection.$anchor)) != null && ((t = is(n, e)) == null ? void 0 : t.pos) != i.pos)
    o(i, e), e.preventDefault();
  else if (!r)
    return;
  function o(a, c) {
    let d = is(n, c);
    const u = jt.getState(n.state) == null;
    if (!d || !Ll(a, d))
      if (u)
        d = a;
      else
    ...
    if (u || !n.state.selection.eq(f)) {
      ...
      u && h.setMeta(jt, a.pos), n.dispatch(h);
    }
  }
  function s() {
    n.root.removeEventListener("mouseup", s), n.root.removeEventListener("dragstart", s), n.root.removeEventListener("mousemove", l), jt.getState(n.state) != null && n.dispatch(n.state.tr.setMeta(jt, -1));
  }
  function l(a) {
    const c = a, d = jt.getState(n.state);
    let u;
    if (d != null)
      u = n.state.doc.resolve(d);
    else if (Mc(n, c.target) != r && (u = is(n, e), !u))
      return s();
    u && o(u, c);
  }
...
var fb = class {
  constructor(e, t) {
    this.node = e, this.cellMinWidth = t, this.dom = document.createElement("div"), this.dom.className = "tableWrapper", this.table = this.dom.appendChild(document.createElement("table")), this.colgroup = this.table.appendChild(document.createElement("colgroup")), Ws(e, this.colgroup, this.table, t), this.contentDOM = this.table.appendChild(document.createElement("tbody"));
  }
  update(e) {
    return e.type != this.node.type ? !1 : (this.node = e, Ws(e, this.colgroup, this.table, this.cellMinWidth), !0);
  }
  ignoreMutation(e) {
...
function hb({
  ...
  const i = new te({
    ...
    state: {
      init(o, s) {
        return i.spec.props.nodeViews[xe(s.schema).table.name] = (l, a) => new t(l, e, a), new pb(-1, !1);
      },
      apply(o, s) {
        return s.apply(o);
      }
...
var pb = class Ei {
  ...
  apply(e) {
    ...
    if (r && r.setHandle != null)
      return new Ei(r.setHandle, !1);
    if (r && r.setDragging !== void 0)
      return new Ei(t.activeHandle, r.setDragging);
    if (t.activeHandle > -1 && e.docChanged) {
      let i = e.mapping.map(t.activeHandle, -1);
      return $s(e.doc.resolve(i)) || (i = -1), new Ei(i, t.dragging);
    }
    return t;
  }
};
function mb(n, e, t, r, i) {
  ...
  if (o && !o.dragging) {
    ...
    if (s) {
      ...
      e.clientX - a <= t ? l = Tc(n, e, "left", t) : c - e.clientX <= t && (l = Tc(n, e, "right", t));
    }
    if (l != o.activeHandle) {
      if (!i && l !== -1) {
...
function gb(n) {
  ...
  e && e.activeHandle > -1 && !e.dragging && af(n, -1);
}
function yb(n, e, t) {
  var r;
  ...
  if (!o || o.activeHandle == -1 || o.dragging)
    return !1;
  const s = n.state.doc.nodeAt(o.activeHandle), l = vb(n, o.activeHandle, s.attrs);
  n.dispatch(
...
function wb(n, e, t) {
  ...
  for (let c = 0; c < o.height; c++) {
    ...
    if (f.colwidth && f.colwidth[h] == t)
      continue;
    const p = f.colwidth ? f.colwidth.slice() : xb(f.colspan);
...
function yt(n) {
  const e = n.selection, t = Mo(n), r = t.node(-1), i = t.start(-1), o = ie.get(r);
...
function cf(n, { map: e, tableStart: t, table: r }, i) {
  let o = i > 0 ? -1 : 0;
  Yv(e, r, i + o) && (o = i == 0 || i == e.width ? null : 0);
...
function Ab(n, e) {
  ...
  if (e) {
    ...
    if (t.left == 0 && t.right == t.map.width)
      return !1;
    for (let i = t.right - 1; Tb(r, t, i), i != t.left; i--) {
...
function df(n, { map: e, tableStart: t, table: r }, i) {
  var o;
  let s = t;
  for (let c = 0; c < i; c++)
  ...
  const l = [];
  let a = i > 0 ? -1 : 0;
  Ob(e, r, i + a) && (a = i == 0 || i == e.height ? null : 0);
...
function Lb({ width: n, height: e, map: t }, r) {
...
function Ec(n, e) {
  ...
  if (e) {
    ...
    if (o.setNodeMarkup(a + r.tableStart, null, {
      ...
      const d = a + 1 + c.content.size, u = Oc(c) ? a + 1 : d;
...
function Wr(n, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? Bb(n) : function(t, r) {
    if (!rt(t))
      return !1;
    if (r) {
      const i = xe(t.schema), o = yt(t), s = t.tr, l = Dc("row", o, i), a = Dc(
        "column",
        o,
        i
...
function Rc(n) {
  return function(e, t) {
    ...
    if (t) {
      ...
      t(
        e.tr.setSelection(L.between(i, Gv(i))).scrollIntoView()
      );
    }
    return !0;
  };
...
class $b {
  constructor(e, t) {
    this.node = e, this.cellMinWidth = t, this.dom = document.createElement("div"), this.dom.className = "tableWrapper", this.table = this.dom.appendChild(document.createElement("table")), this.colgroup = this.table.appendChild(document.createElement("colgroup")), Lc(e, this.colgroup, this.table, t), this.contentDOM = this.table.appendChild(document.createElement("tbody"));
  }
  update(e) {
    return e.type !== this.node.type ? !1 : (this.node = e, Lc(e, this.colgroup, this.table, this.cellMinWidth), !0);
  }
  ignoreMutation(e) {
    return e.type === "attributes" && (e.target === this.table || this.colgroup.contains(e.target));
  }
...
function _b(n, e, t, r, i) {
  const o = Wb(n), s = [], l = [];
  for (let c = 0; c < t; c += 1) {
    const d = Ic(o.cell);
    if (d && l.push(d), r) {
      const u = Ic(o.header_cell);
      u && s.push(u);
    }
  }
  const a = [];
...
const wi = ({ editor: n }) => {
  ...
  if (!qb(e))
    return !1;
  let t = 0;
  const r = yu(e.ranges[0].$from, (o) => o.type.name === "table");
  ...
  renderHTML({ node: n, HTMLAttributes: e }) {
    const { colgroup: t, tableWidth: r, tableMinWidth: i } = jb(n, this.options.cellMinWidth);
    return [
      "table",
      K(this.options.HTMLAttributes, e, {
  ...
  addCommands() {
    return {
      ...
      addColumnBefore: () => ({ state: n, dispatch: e }) => Sb(n, e),
      addColumnAfter: () => ({ state: n, dispatch: e }) => Mb(n, e),
      deleteColumn: () => ({ state: n, dispatch: e }) => Ab(n, e),
      addRowBefore: () => ({ state: n, dispatch: e }) => Eb(n, e),
      addRowAfter: () => ({ state: n, dispatch: e }) => Nb(n, e),
      deleteRow: () => ({ state: n, dispatch: e }) => Rb(n, e),
      deleteTable: () => ({ state: n, dispatch: e }) => Vb(n, e),
      mergeCells: () => ({ state: n, dispatch: e }) => Ec(n, e),
      splitCell: () => ({ state: n, dispatch: e }) => Nc(n, e),
      toggleHeaderColumn: () => ({ state: n, dispatch: e }) => Wr("column")(n, e),
      toggleHeaderRow: () => ({ state: n, dispatch: e }) => Wr("row")(n, e),
      toggleHeaderCell: () => ({ state: n, dispatch: e }) => zb(n, e),
      mergeOrSplit: () => ({ state: n, dispatch: e }) => Ec(n, e) ? !0 : Nc(n, e),
      setCellAttribute: (n, e) => ({ state: t, dispatch: r }) => Pb(n, e)(t, r),
      goToNextCell: () => ({ state: n, dispatch: e }) => Rc(1)(n, e),
      goToPreviousCell: () => ({ state: n, dispatch: e }) => Rc(-1)(n, e),
      fixTables: () => ({ state: n, dispatch: e }) => (e && sf(n), !0),
...
}), Zb = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, ew = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, tw = Be.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
...
}, sw = function({ view: n, dir: e, currentResolved: t }) {
  if (!t)
    return !1;
  let r = n.state.tr;
  const i = e === "DOWN", o = t.node(1) || t.nodeAfter, s = 0, l = t.node(s), a = t.start(s), c = uf(l, (m) => m);
  let d = c.indexOf(o);
  if (d == -1)
    return !1;
  let u = i ? d + 1 : d - 1;
...
function ff(n, e) {
  if (ss(n) && ss(e))
    for (const t in e)
      ss(e[t]) ? (n[t] || Object.assign(n, { [t]: {} }), ff(n[t], e[t])) : lw(e[t]) ? (n[t] || (n[t] = []), _s(n[t], e[t])) : Object.assign(n, { [t]: e[t] });
  return n;
}
const _s = function(n, e) {
  return e.forEach((t, r) => {
    !n || !n.find((i) => i.name == t.name) ? n.push(t) : ff(
  ...
  addCommands() {
    return {
      setBlockWidth: (n) => ({ commands: e, view: t }) => this.options.alignments.includes(n) ? (e.updateAttributes(Il(t).type.name, {
        blockWidth: n
      }), !0) : !1,
...
}), cw = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/, dw = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/g, uw = (n) => n.match(cw), Pc = (n) => n ? "https://www.youtube-nocookie.com/embed/" : "https://www.youtube.com/embed/", fw = (n) => {
  const {
    url: e,
    allowFullscreen: t,
    autoplay: r,
  ...
  addCommands() {
    return {
      setYoutubeVideo: (n) => ({ commands: e }) => uw(n.src) ? e.insertContent({
        type: this.name,
        attrs: n
      }) : !1
    };
...
const pw = oe.create({
  ...
  addCommands() {
    return {
      setVariant: (n) => ({ commands: e, view: t }) => (e.updateAttributes(Il(t).type.name, {
        variant: n
      }), !0),
...
const vw = new ue("suggestion");
function bw({ pluginKey: n = vw, editor: e, char: t = "@", allowSpaces: r = !1, allowedPrefixes: i = [" "], startOfLine: o = !1, decorationTag: s = "span", decorationClass: l = "suggestion", command: a = () => null, items: c = () => [], render: d = () => ({}), allow: u = () => !0, findSuggestionMatch: f = yw }) {
  let h;
...
}, xw = { class: "bg-white border border-slate-400 rounded overflow-hidden shadow" }, Cw = ["onClick"], Sw = ["innerHTML"], Mw = {
  key: 1,
  class: "p-2 text-slate-600 text-sm w-full"
};
function Tw(n, e, t, r, i, o) {
  return F(), Z("div", xw, [
    t.items.length ? (F(!0), Z(Ct, { key: 0 }, St(o.itemsWithInsertCommand, (s, l) => (F(), Z("button", {
      class: Wt(["flex flex-row gap-2 items-center w-full p-2 pr-12 text-slate-600 hover:bg-slate-50 text-sm", { "bg-slate-100": l === i.selectedIndex }]),
      key: l,
      ...
      Mf(" " + Tf(s.title), 1)
    ], 10, Cw))), 128)) : (F(), Z("div", Mw, "No result"))
  ]);
}
const Aw = /* @__PURE__ */ qr(kw, [["render", Tw]]);
function Ow(n) {
  return {
...
const Iw = {
  ...
  data() {
    return {
      ...
      editor: null,
      allBlockTools: _s(Ew(), this.blockTools),
      allInlineTools: _s(Nw(), this.inlineTools),
      allAlignmentTools: this.alignmentTools.length ? this.alignmentTools : Dw(),
      tableRowTools: Rw(),
      tableColumnTools: Lw(),
  ...
  mounted() {
    this.editor = new yy({
      extensions: [
        ...
        tw,
        ww.configure({
          suggestion: Ow(this.allBlockTools)
        }),
        $v.configure({
          openOnClick: !1
        }),
  ...
  methods: {
    ...
    getMenuCoords() {
      return nw(this.editor.view);
    },
    getTableRowMenuCoords() {
      return rw(this.editor.view);
    },
    getTableColumnMenuCoords() {
      return iw(this.editor.view);
    },
    startDragging(n) {
    ...
    getTopLevelNodeType() {
      var n;
      return (n = Il(this.editor.view)) == null ? void 0 : n.type.name;
    },
    canMoveNodeDown() {
...
}, Pw = { class: "gutentap" }, Bw = { class: "flex flex-row" }, zw = /* @__PURE__ */ Ke("svg", {
  width: "24",
  height: "24",
...
}, Fw = /* @__PURE__ */ Ke("div", { class: "p-3 uppercase text-gray-600 text-xs pb-1 tracking-wide" }, " Transform to ", -1), $w = {
  key: 1,
  ...
  Ww
], qw = ["disabled"], Kw = /* @__PURE__ */ Ke("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "24",
  height: "24",
  fill: "currentColor",
...
function Qw(n, e, t, r, i, o) {
  ...
  return F(), Z("div", Pw, [
    i.editor && i.tableRowTools ? (F(), Ze(c, {
      key: 0,
      editor: i.editor,
      ...
      default: Me(() => [
        je(a, null, {
          dropdown: Me(() => [
            (F(!0), Z(Ct, null, St(i.tableRowTools, (u) => (F(), Ze(l, {
    ...
    i.editor && i.tableColumnTools ? (F(), Ze(c, {
      key: 1,
      editor: i.editor,
      ...
      default: Me(() => [
        je(a, null, {
          dropdown: Me(() => [
            (F(!0), Z(Ct, null, St(i.tableColumnTools, (u) => (F(), Ze(l, {
    ...
    i.editor ? (F(), Ze(c, {
      ...
      class: Wt(["text-sm bg-white max-w-screen flex divide-x max-w-full divide-slate-400 flex-row border-slate-400 md:rounded border-t md:border", {
        ...
        return [
          Ke("div", Bw, [
            Ke("button", {
              ...
              class: Wt(["hidden md:block ml-1 my-2 hover:bg-slate-100 rounded", {
            ...
            !i.dragging && i.currentBlockTool ? (F(), Z("div", Vw, [
              je(a, null, Af({
                default: Me(() => {
                  var m, y, w;
                  return [
          ...
          i.dragging ? it("", !0) : (F(), Z("div", Jw, [
            (F(!0), Z(Ct, null, St(o.activeAlignmentTools, (m, y) => (F(), Ze(a, { key: y }, {
              dropdown: Me(() => [
                (F(!0), Z(Ct, null, St(m, (w) => (F(), Ze(l, {
                  key: w.title,
          ...
          !i.dragging && ((h = (f = i.currentBlockTool) == null ? void 0 : f.tools) != null && h.length) ? (F(), Z("div", Gw, [
          ...
          (g = i.currentBlockTool) != null && g.hasInlineTools && !i.dragging ? (F(), Z("div", Yw, [
            (F(!0), Z(Ct, null, St(i.allInlineTools, (m) => (F(), Ze(a, {
              align: "right",
              key: m.title
            }, {
              dropdown: Me(() => [
                (F(!0), Z(Ct, null, St(m.tools, (y) => (F(), Ze(l, {
                  key: y.name,
          ...
          i.editor && i.editor.can().deleteNode(i.topLevelNodeType) && !i.dragging ? (F(), Z("div", Xw, [
            je(a, { align: "right" }, {
              dropdown: Me(() => [
                je(l, {
                  ref: "deleteButton",
    ...
    je(d, {
      class: Wt(t.editorClass ?? "prose"),
      onKeydown: o.handleTyping,
      onKeyup: e[10] || (e[10] = Of((u) => i.isTyping = !1, ["esc"])),
      ref: "editor",
      editor: i.editor
    }, null, 8, ["class", "onKeydown", "editor"])
  ]);
}
const Zw = /* @__PURE__ */ qr(Iw, [["render", Qw]]), r2 = Zw;
export {
  r2 as GutenTap
};
