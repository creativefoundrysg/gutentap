import { createElementBlock as ce, openBlock as _, normalizeClass as un, renderSlot as jl, createCommentVNode as tt, defineComponent as Kr, h as mn, Teleport as Rf, ref as Us, getCurrentInstance as If, watchEffect as Lf, nextTick as Pf, unref as Bf, onBeforeUnmount as Js, onMounted as Uc, reactive as zf, markRaw as Hf, customRef as Vf, resolveComponent as hr, createBlock as et, createVNode as qe, withCtx as Ae, Fragment as Rt, renderList as It, withModifiers as Oe, createElementVNode as ve, createSlots as Ff, withKeys as $f } from "vue";
const fo = (n, e) => {
...
}, Wf = ["aria-label", "data-tooltip", "title", "innerHTML"];
function _f(n, e, t, r, i, o) {
  return _(), ce("button", {
    type: "button",
    class: un(["w-full flex p-1 flex-row items-center text-slate-600 rounded gap-2 hover:bg-slate-100", t.active ? t.activeClass : ""]),
    "aria-label": t.label,
...
const qf = /* @__PURE__ */ fo(jf, [["render", _f]]), Kf = {
  computed: {
    hasDropdown() {
...
function Jf(n, e, t, r, i, o) {
  return _(), ce("div", Uf, [
    jl(n.$slots, "default"),
    o.hasDropdown ? (_(), ce("div", {
      key: 0,
      class: un(["z-10 bg-white shadow py-2 group-focus-within:block hidden overflow-hidden whitespace-nowrap absolute bottom-full sm:bottom-auto sm:top-full mt-4 rounded border border-slate-400", t.align == "left" ? "left-0" : "right-0"])
    }, [
      jl(n.$slots, "dropdown")
    ], 2)) : tt("", !0)
  ]);
}
const Gf = /* @__PURE__ */ fo(Kf, [["render", Jf]]), Yf = {
  props: {
    content: {
      type: String,
      required: !1
...
}, Xf = ["aria-label", "title", "innerHTML"];
function Qf(n, e, t, r, i, o) {
  return _(), ce("button", {
    class: un(["w-full flex py-1 pl-2 pr-6 flex-row items-center text-slate-600 gap-2 hover:bg-slate-100", t.active ? t.activeClass : ""]),
    "aria-label": t.label,
    title: t.label,
    innerHTML: t.content
  }, null, 10, Xf);
}
const Zf = /* @__PURE__ */ fo(Yf, [["render", Qf]]);
function ye(n) {
  this.content = n;
}
ye.prototype = {
...
let G = class cs {
  ...
  */
  eq(e) {
    return this == e || this.type == e.type && Pi(this.attrs, e.attrs);
  }
  /**
...
class T {
  ...
  */
  removeBetween(e, t) {
    return new T(Yc(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function Qc(n, e, t, r) {
  ...
  if (i == e.index(r) && r < n.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
      ...
      let { start: s, end: l } = th(t, n);
      return yn(o, ed(n, s, l, e, r));
    }
...
function ed(n, e, t, r, i) {
  ...
  return br(null, n, i, l), o && s && e.index(i) == t.index(i) ? (Zc(o, s), gn(yn(o, ed(n, e, t, r, i + 1)), l)) : (o && gn(yn(o, zi(n, e, i + 1)), l), br(e, t, i, l), s && gn(yn(s, zi(t, r, i + 1)), l)), br(r, null, i, l), new x(l);
}
function zi(n, e, t) {
  let r = [];
...
const rh = 12, Wl = /* @__PURE__ */ new WeakMap();
class Hi {
  /**
...
let qt = class us {
  ...
  */
  hasMarkup(e, t, r) {
    return this.type == e && Pi(this.attrs, t || e.defaultAttrs || ih) && G.sameSet(this.marks, r || G.none);
  }
  /**
  ...
  */
  toString() {
    ...
    return this.content.size && (e += "(" + this.content.toStringInner() + ")"), td(this.marks, e);
  }
  /**
...
class Vi extends qt {
  ...
  */
  ...
  toString() {
    return this.type.spec.toDebugString ? this.type.spec.toDebugString(this) : td(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
  ...
  mark(e) {
    return e == this.marks ? this : new Vi(this.type, this.attrs, this.text, e);
  }
  withText(e) {
    return e == this.text ? this : new Vi(this.type, this.attrs, e, this.marks);
  }
...
let Kl = class ad {
  ...
  */
  constructor(e, t, r) {
    this.name = e, this.schema = t, this.spec = r, this.markSet = null, this.groups = r.group ? r.group.split(" ") : [], this.attrs = ld(e, r.attrs), this.defaultAttrs = id(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(r.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  computeAttrs(e) {
    return !e && this.defaultAttrs ? this.defaultAttrs : od(this.attrs, e);
  }
  /**
  ...
  */
  create(e = null, t, r) {
    ...
    return new qt(this, this.computeAttrs(e), x.from(t), G.setFrom(r));
  }
  /**
  ...
  */
  createChecked(e = null, t, r) {
    return t = x.from(t), this.checkContent(t), new qt(this, this.computeAttrs(e), t, G.setFrom(r));
  }
  /**
  ...
  */
  createAndFill(e = null, t, r) {
    ...
    return o ? new qt(this, e, t.append(o), G.setFrom(r)) : null;
  }
  /**
  ...
  */
  static compile(e, t) {
    ...
    e.forEach((o, s) => r[o] = new ad(o, t, s));
...
class ho {
  ...
  */
  constructor(e, t, r, i) {
    this.name = e, this.rank = t, this.schema = r, this.spec = i, this.attrs = ld(e, i.attrs), this.excluded = null;
    let o = id(this.attrs);
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new G(this, od(this.attrs, e));
  }
  /**
  @internal
  */
...
class cd {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = ye.from(e.nodes), t.marks = ye.from(e.marks || {}), this.nodes = Kl.compile(this.spec.nodes, this), this.marks = ho.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
  ...
  */
  text(e, t) {
    ...
    return new Vi(r, r.defaultAttrs, e, G.setFrom(t));
  }
  /**
  ...
  */
  matchTag(e, t, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let o = this.tags[i];
      if (wh(e, o.tag) && (o.namespace === void 0 || e.namespaceURI == o.namespace) && (!o.context || t.matchesContext(o.context))) {
        if (o.getAttrs) {
          let s = o.getAttrs(e);
          if (s === !1)
            continue;
...
const dd = {
  ...
  style: !0,
  title: !0
}, ud = { ol: !0, ul: !0 }, Nr = 1, fs = 2, Mi = 4;
function Jl(n, e, t) {
  return e != null ? (e ? Nr : 0) | (e === "full" ? fs : 0) : n && n.whitespace == "pre" ? Nr | fs : t & -5;
}
class di {
  constructor(e, t, r, i, o, s) {
    this.type = e, this.attrs = t, this.marks = r, this.solid = i, this.options = s, this.content = [], this.activeMarks = G.none, this.match = o || (s & Mi ? null : e.contentMatch);
  }
  findWrapping(e) {
    if (!this.match) {
      if (!this.type)
  ...
  inlineContext(e) {
    return this.type ? this.type.inlineContent : this.content.length ? this.content[0].isInline : e.parentNode && !dd.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class Gl {
  constructor(e, t, r) {
    this.parser = e, this.options = t, this.isOpen = r, this.open = 0, this.localPreserveWS = !1;
    let i = t.topNode, o, s = Jl(null, t.preserveWhitespace, 0) | (r ? Mi : 0);
    i ? o = new di(i.type, i.attrs, G.none, !0, t.topMatch || i.type.contentMatch, s) : r ? o = new di(null, null, G.none, !0, null, s) : o = new di(e.schema.topNodeType, null, G.none, !0, null, s), this.nodes = [o], this.find = t.findPositions, this.needsBlock = !1;
  }
  get top() {
...
`);
  ...
  addElement(e, t, r) {
    ...
    ud.hasOwnProperty(s) && this.parser.normalizeLists && bh(e);
    let a = this.options.ruleFromNode && this.options.ruleFromNode(e) || (l = this.parser.matchTag(e, this, r));
    e: if (a ? a.ignore : vh.hasOwnProperty(s))
...
`), t);
  ...
  enterInner(e, t, r, i = !1, o) {
    ...
    s.options & Mi && s.content.length == 0 && (l |= Mi);
    let a = G.none;
    return r = r.filter((c) => (s.type ? s.type.allowsMarkType(c.type) : Xl(c.type, e)) ? (a = c.addToSet(a), !1) : !0), this.nodes.push(new di(e, t, a, i, null, l)), this.open++, r;
  }
...
function bh(n) {
  for (let e = n.firstChild, t = null; e; e = e.nextSibling) {
    ...
    r && ud.hasOwnProperty(r) && t ? (t.appendChild(e), e = t) : r == "li" ? t = e : r && (t = null);
  }
}
function wh(n, e) {
...
class En {
  ...
  */
  serializeNodeInner(e, t) {
    let { dom: r, contentDOM: i } = Ti(Io(t), this.nodes[e.type.name](e), null, e.attrs);
    if (i) {
      if (e.isLeaf)
  ...
  */
  serializeMark(e, t, r = {}) {
    ...
    return i && Ti(Io(r), i(e, t), null, e.attrs);
  }
...
function kh(n) {
  let e = Zl.get(n);
  return e === void 0 && Zl.set(n, e = xh(n)), e;
}
function xh(n) {
  let e = null;
  function t(r) {
...
function Ti(n, e, t, r) {
  ...
  for (let u = d; u < e.length; u++) {
    ...
    if (f === 0) {
      ...
      let { dom: h, contentDOM: p } = Ti(n, f, t, r);
...
const fd = 65535, hd = Math.pow(2, 16);
function Ch(n, e) {
  return n + e * hd;
}
function ea(n) {
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        if (r)
          return h;
        let p = e == (t < 0 ? a : u) ? null : Ch(l / 3, e - a), g = e == a ? md : e == u ? pd : Ai;
        return (t < 0 ? e != a : e != u) && (g |= gd), new hs(h, g, p);
      }
      i += d - c;
    }
      ...
      if (r.length == t.marks.length) {
        for (let i = 0; i < t.marks.length; i++)
          if (!t.marks[i].isInSet(r))
            return new Wt(this.pos, t.marks[i]);
...
class pe extends Me {
  ...
  */
  static fromJSON(e, t) {
    ...
    return new pe(t.from, t.to, t.gapFrom, t.gapTo, T.fromJSON(e, t.slice), t.insert, !!t.structure);
  }
}
...
function Mh(n, e, t, r) {
  ...
  n.doc.nodesBetween(e, t, (a, c, d) => {
    ...
    if (!r.isInSet(u) && d.type.allowsMarkType(r.type)) {
      ...
      l && l.to == f ? l.to = h : o.push(l = new jt(f, h, r));
    }
...
function or(n) {
  ...
  for (let r = n.depth; ; --r) {
    ...
    if (r < n.depth && i.canReplace(o, s, t))
      return r;
    if (r == 0 || i.type.spec.isolating || !Ah(i, o, s))
      break;
  }
  return null;
}
function Oh(n, e, t) {
  ...
  n.step(new pe(a, c, s, l, new T(d.append(f), u, h), d.size - u, !0));
}
function Xs(n, e, t = null, r = n) {
  let i = Eh(n, e), o = i && Nh(r, e);
...
function Dh(n, e, t) {
  ...
  n.step(new pe(i, o, i, o, new T(r, 0, 0), t.length, !0));
}
function Rh(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (s, l) => {
    ...
    if (s.isTextblock && !s.hasMarkup(r, a) && Ih(n.doc, n.mapping.slice(o).map(l), r)) {
      let c = null;
      if (r.schema.linebreakReplacement) {
        let h = r.whitespace == "pre", p = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
        h && !p ? c = !1 : !h && p && (c = !0);
      }
      c === !1 && vd(n, s, l, o), Ys(n, n.mapping.slice(o).map(l, 1), r, void 0, c === null);
      let d = n.mapping.slice(o), u = d.map(l, 1), f = d.map(l + s.nodeSize, 1);
      return n.step(new pe(u, f, u + 1, f - 1, new T(x.from(r.create(a, null, s.marks)), 0, 0), 1, !0)), c === !0 && yd(n, s, l, o), !1;
    }
  });
}
function yd(n, e, t, r) {
...
function Lh(n, e, t, r, i) {
  ...
  n.step(new pe(e, e + o.nodeSize, e + 1, e + o.nodeSize - 1, new T(x.from(s), 0, 0), 1, !0));
}
...
function bd(n, e) {
  return !!(n && e && !n.isLeaf && Bh(n, e));
}
function po(n, e, t = -1) {
  let r = n.resolve(e);
  for (let i = r.depth; ; i--) {
    let o, s, l = r.index(i);
    if (i == r.depth ? (o = r.nodeBefore, s = r.nodeAfter) : t > 0 ? (o = r.node(i + 1), l++, s = r.node(i).maybeChild(l)) : (o = r.node(i).maybeChild(l - 1), s = r.node(i + 1)), o && !o.isTextblock && bd(o, s) && r.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function zh(n, e, t) {
  ...
  if (n.step(new de(c, a.map(e + t, -1), T.empty, !0)), r === !0) {
    ...
    yd(n, d.node(), d.before(), n.steps.length);
  }
  return n;
}
function Hh(n, e, t) {
...
function mo(n, e, t = e, r = T.empty) {
  ...
  return kd(i, o, r) ? new de(e, t, r) : new Vh(i, o, r).fit();
}
function kd(n, e, t) {
...
class Vh {
  ...
  fit() {
    ...
    let a = new T(o, s, l);
    return e > -1 ? new pe(r.pos, e, this.$to.pos, this.$to.end(), a, t) : a.size || r.pos != this.$to.pos ? new de(r.pos, i.pos, a) : null;
  }
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: r, inject: i, wrap: o }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!m)
        break;
      c++, (c > 1 || a == 0 || g.content.size) && (u = m, d.push(xd(g.mark(f.allowedMarks(g.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
...
function xd(n, e, t) {
  if (e <= 0)
    return n;
  let r = n.content;
  return e > 1 && (r = r.replaceChild(0, xd(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0))), e > 0 && (r = n.type.contentMatch.fillBefore(r).append(r), t <= 0 && (r = r.append(n.type.contentMatch.matchFragment(r).fillBefore(x.empty, !0)))), n.copy(r);
}
    ...
    if (p)
      for (let g = 0; g < s.length; g++) {
        ...
        if (w.canReplaceWith(C, C, p.type, p.marks))
          return n.replace(i.before(m), y ? o.after(m) : t, new T(Cd(r.content, 0, r.openStart, h), h, r.openEnd));
      }
  }
...
function Wh(n, e, t, r) {
  if (!r.isInline && e == t && n.doc.resolve(e).parent.content.size) {
    let i = Hh(n.doc, e, r.type);
    i != null && (e = t = i);
  }
  n.replaceRange(e, t, new T(x.from(r), 0, 0));
}
function _h(n, e, t) {
  let r = n.doc.resolve(e), i = n.doc.resolve(t), o = Sd(r, i);
  for (let s = 0; s < o.length; s++) {
...
class B {
  ...
  */
  constructor(e, t, r) {
    this.$anchor = e, this.$head = t, this.ranges = r || [new Md(e.min(t), e.max(t))];
  }
  /**
  ...
  */
  static findFrom(e, t, r = !1) {
    let i = e.parent.inlineContent ? new I(e) : Vn(e.node(0), e.parent, e.pos, e.index(), t, r);
    if (i)
      return i;
    for (let o = e.depth - 1; o >= 0; o--) {
      let s = t < 0 ? Vn(e.node(0), e.node(o), e.before(o + 1), e.index(o), t, r) : Vn(e.node(0), e.node(o), e.after(o + 1), e.index(o) + 1, t, r);
      if (s)
        return s;
    }
    return null;
  ...
  */
  static atEnd(e) {
    return Vn(e, e, e.content.size, e.childCount, -1) || new $e(e);
  }
  /**
...
function Vn(n, e, t, r, i, o = !1) {
  ...
  for (let s = r - (i > 0 ? 0 : 1); i > 0 ? s < e.childCount : s >= 0; s += i) {
    ...
    if (l.isAtom) {
      ...
      let a = Vn(n, l, t + i, i < 0 ? l.childCount : 0, i, o);
      if (a)
        return a;
    }
    t += l.nodeSize * i;
...
function ia(n, e, t) {
  ...
  if (r < e)
    return;
  let i = n.steps[r];
  if (!(i instanceof de || i instanceof pe))
    return;
...
class Ho {
  constructor(e, t) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = Uh.slice(), t && t.forEach((r) => {
...
class Wn {
  ...
  */
  static create(e) {
    let t = new Ho(e.doc ? e.doc.type.schema : e.schema, e.plugins), r = new Wn(t);
  ...
  */
  reconfigure(e) {
    let t = new Ho(this.schema, e.plugins), r = t.fields, i = new Wn(t);
  ...
  */
  static fromJSON(e, t, r) {
    ...
    let i = new Ho(e.schema, e.plugins), o = new Wn(i);
...
class X {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && Td(e.props, this, this.props), this.key = e.key ? e.key.key : Ad("plugin");
  }
  /**
...
function ca(n, e, t, r, i) {
  for (var o; ; ) {
    ...
    if (e == (i < 0 ? 0 : Je(n))) {
      let s = n.parentNode;
      if (!s || s.nodeType != 1 || Ur(n) || Gh.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = be(n) + (i < 0 ? 0 : 1), n = s;
...
const ft = typeof navigator < "u" ? navigator : null, da = typeof document < "u" ? document : null, Zt = ft && ft.userAgent || "", gs = /Edge\/(\d+)/.exec(Zt), Od = /MSIE \d/.exec(Zt), ys = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Zt), Le = !!(Od || ys || gs), Ut = Od ? document.documentMode : ys ? +ys[1] : gs ? +gs[1] : 0, rt = !Le && /gecko\/(\d+)/i.test(Zt);
rt && +(/Firefox\/(\d+)/.exec(Zt) || [0, 0])[1];
const vs = !Le && /Chrome\/(\d+)/.exec(Zt), Ce = !!vs, Ed = vs ? +vs[1] : 0, Ee = !Le && !!ft && /Apple Computer/.test(ft.vendor), Qn = Ee && (/Mobile\/\w+/.test(Zt) || !!ft && ft.maxTouchPoints > 2), Ue = Qn || (ft ? /Mac/.test(ft.platform) : !1), tp = ft ? /Win/.test(ft.platform) : !1, Mt = /Android \d/.test(Zt), Jr = !!da && "webkitFontSmoothing" in da.documentElement.style, np = Jr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function rp(n) {
...
function ua(n, e, t) {
  ...
  for (let s = t || n.dom; s; ) {
    ...
    let l = s, a = l == o.body, c = a ? rp(o) : ip(l), d = 0, u = 0;
    ...
    if (/^(fixed|sticky)$/.test(f))
      break;
    s = f == "absolute" ? s.offsetParent : Xn(s);
  }
}
function op(n) {
  ...
  return { refDOM: r, refTop: i, stack: Nd(n.dom) };
}
function Nd(n) {
  let e = [], t = n.ownerDocument;
  for (let r = n; r && (e.push({ dom: r, top: r.scrollTop, left: r.scrollLeft }), n != t); r = Xn(r))
    ;
  return e;
}
...
function Rd(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? ap(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: o } : Rd(t, i);
}
function ap(n, e) {
...
function dp(n, e, t) {
  let { node: r, offset: i } = Rd(e, t), o = -1;
...
function fp(n, e) {
  ...
  if (!s || !n.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
    ...
    if (!el(e, c) || (s = Id(n.dom, e, c), !s))
      return null;
  }
  if (Ee)
    for (let c = s; r && c; c = Xn(c))
  ...
  if (s = cp(s, e), r) {
    ...
    let c;
    Jr && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = up(n, r, i, e));
  }
  l == null && (l = dp(n, s, e));
...
const hp = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function Ld(n, e, t) {
  let { node: r, offset: i, atom: o } = n.docView.domFromPos(e, t < 0 ? -1 : 1), s = Jr || rt;
  if (r.nodeType == 3)
    if (s && (hp.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = Pt(Ct(r, i, i), t);
      if (rt && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let c = Pt(Ct(r, i - 1, i - 1), -1);
        if (c.top == a.top) {
          let d = Pt(Ct(r, i, i + 1), -1);
          if (d.top != a.top)
      ...
      return t < 0 && !i ? (c++, d = -1) : t >= 0 && i == r.nodeValue.length ? (a--, d = 1) : t < 0 ? a-- : c++, pr(Pt(Ct(r, a, c), d), d < 0);
    }
  ...
  if (o == null && i && (t < 0 || i == Je(r))) {
    let a = r.childNodes[i - 1], c = a.nodeType == 3 ? Ct(a, Je(a) - (s ? 0 : 1)) : a.nodeType == 1 && (a.nodeName != "BR" || !a.nextSibling) ? a : null;
    if (c)
      return pr(Pt(c, 1), !1);
  }
  if (o == null && i < Je(r)) {
  ...
  return pr(Pt(r.nodeType == 3 ? Ct(r) : r, -t), t >= 0);
}
function pr(n, e) {
  if (n.width == 0)
    return n;
...
function gp(n, e, t) {
  ...
  return l ? !mp.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? o : s : Pd(n, e, () => {
...
function yp(n, e, t) {
  return ha == e && pa == t ? ma : (ha = e, pa = t, ma = t == "up" || t == "down" ? pp(n, e, t) : gp(n, e, t));
}
...
class Gr {
  ...
  domFromPos(e, t) {
    ...
    for (let o; r && !(o = this.children[r - 1]).size && o instanceof Bd && o.side >= 0; r--)
      ;
    if (t <= 0) {
      let o, s = !0;
...
class Jt extends Gr {
  ...
  static create(e, t, r, i, o, s) {
    ...
    let f = d;
    return d = Fd(d, r, t), c ? a = new bp(e, t, r, i, d, u || null, f, c, o, s + 1) : t.isText ? new vo(e, t, r, i, d, f, o) : new Jt(e, t, r, i, d, u || null, f, o, s + 1);
  }
  parseRule() {
  ...
  matchesNode(e, t, r) {
    return this.dirty == Ge && e.eq(this.node) && Fi(t, this.outerDeco) && r.eq(this.innerDeco);
  }
  get size() {
  ...
  updateChildren(e, t) {
    ...
    Sp(this.node, this.innerDeco, (c, d, u) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == fn) && (s && this.protectLocalComposition(e, s), Hd(this.contentDOM, this.children, e), Qn && Mp(this.dom));
  }
  localCompositionInfo(e, t) {
    ...
    if (this.node.inlineContent) {
      let s = o.nodeValue, l = Tp(this.node.content, s, r - t, i - t);
  ...
  updateOuterDeco(e) {
    ...
    this.dom = Vd(this.dom, this.nodeDOM, bs(this.outerDeco, this.node, t), bs(e, this.node, t)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
function Hd(n, e, t) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (s instanceof Mn) {
      ...
      Hd(s.contentDOM, s.children, t), r = a ? a.nextSibling : n.firstChild;
    }
  }
  for (; r; )
    r = va(r), i = !0;
...
function Fd(n, e, t) {
  return Vd(n, n, hn, bs(e, t, n.nodeType != 1));
}
function Fi(n, e) {
  if (n.length != e.length)
    return !1;
...
class kp {
  constructor(e, t, r) {
    this.lock = t, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = xp(e.node.content, e);
  }
  ...
  updateNextNode(e, t, r, i, o, s) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof Jt) {
        ...
        if (c != null && c != o)
          return !1;
        let d = a.dom, u, f = this.isLocked(d) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != ht && Fi(t, a.outerDeco));
...
function tl(n, e = null) {
  ...
  if (yo(t)) {
    for (a = s; i && !i.node; )
      i = i.parent;
    let u = i.node;
    if (i && u.isAtom && L.isSelectable(u) && i.parent && !(u.isInline && Qh(t.focusNode, t.focusOffset, i.dom))) {
      let f = i.posBefore;
...
function Ot(n, e = !1) {
  ...
  if (jd(n, t), !!$d(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      ba && !(t instanceof I) && (t.$from.parent.inlineContent || (o = wa(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (s = wa(n, t.to))), n.docView.setSelection(r, i, n, e), ba && (o && ka(o), s && ka(s)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && Ap(n));
    }
    n.domObserver.setCurSelection(), n.domObserver.connectSelection();
  }
}
const ba = Ee || Ce && Ed < 63;
function wa(n, e) {
...
function Ap(n) {
  ...
  e.addEventListener("selectionchange", n.input.hideSelectionGuard = () => {
    (t.anchorNode != r || t.anchorOffset != i) && (e.removeEventListener("selectionchange", n.input.hideSelectionGuard), setTimeout(() => {
      (!$d(n) || n.state.selection.visible) && n.dom.classList.remove("ProseMirror-hideselection");
    }, 20));
  });
}
function Op(n) {
  ...
  i ? t.setStart(r.parentNode, be(r) + 1) : t.setStart(r, 0), t.collapse(!0), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && Le && Ut <= 11 && (r.disabled = !0, r.disabled = !1);
}
function jd(n, e) {
  if (e instanceof L) {
  ...
  if (r instanceof I)
    if (t.indexOf("s") > -1) {
      ...
      if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
        ...
        return o.isAtom || (s = n.docView.descAt(l)) && !s.contentDOM ? L.isSelectable(o) ? Bt(n, new L(e < 0 ? n.state.doc.resolve(i.pos - o.nodeSize) : i)) : Jr ? Bt(n, new I(n.state.doc.resolve(e < 0 ? l : l + o.nodeSize))) : !1 : !1;
      }
    } else return !1;
  else {
...
function Np(n) {
  ...
  if (!t)
    return;
  let i, o, s = !1;
  for (rt && t.nodeType == 1 && r < $i(t) && kr(t.childNodes[r], -1) && (s = !0); ; )
    if (r > 0) {
      if (t.nodeType != 1)
        break;
      {
...
function rl(n, e) {
  ...
  let s = n.someProp("clipboardSerializer") || En.fromSchema(n.state.schema), l = Yd(), a = l.createElement("div");
  a.appendChild(s.serializeFragment(r, { document: l }));
  let c = a.firstChild, d, u = 0;
  for (; c && c.nodeType == 1 && (d = Gd[c.nodeName.toLowerCase()]); ) {
...
`))), 0, 0) : T.empty;
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || Kt.fromSchema(n.state.schema)).parseSlice(s, {
    preserveWhitespace: !!(a || d),
    context: i,
    ruleFromNode(f) {
      return f.nodeName == "BR" && !f.nextSibling && f.parentNode && !zp.test(f.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), d)
    l = jp(Ea(l, +d[1], +d[2]), d[4]);
  else if (l = T.maxOpen(Hp(l.content, i), !0), l.openStart || l.openEnd) {
    let u = 0, f = 0;
...
function Hp(n, e) {
  ...
  for (let t = e.depth; t >= 0; t--) {
    ...
    if (n.forEach((l) => {
      ...
      if (!a)
        return s = null;
      if (c = s.length && o.length && Ud(a, o, l, s[s.length - 1], 0))
        s[s.length - 1] = c;
      else {
        s.length && (s[s.length - 1] = Jd(s[s.length - 1], o.length));
        let d = Kd(l, a);
...
function Ud(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    let o = Ud(n, e, t, r.lastChild, i + 1);
    if (o)
      return r.copy(r.content.replaceChild(r.childCount - 1, o));
    if (r.contentMatchAt(r.childCount).matchType(i == n.length - 1 ? t.type : n[i + 1]))
      return r.copy(r.content.append(x.from(Kd(t, n, i + 1))));
  }
}
function Jd(n, e) {
  if (e == 0)
    return n;
  let t = n.content.replaceChild(n.childCount - 1, Jd(n.lastChild, e - 1)), r = n.contentMatchAt(n.childCount).fillBefore(x.empty, !0);
...
function Fp(n) {
  ...
  let t = Yd().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(n), i;
  if ((i = r && Gd[r[1].toLowerCase()]) && (n = i.map((o) => "<" + o + ">").join("") + n + i.map((o) => "</" + o + ">").reverse().join("")), t.innerHTML = Vp(n), i)
    for (let o = 0; o < i.length; o++)
...
const Ne = {}, De = {}, Wp = { touchstart: !0, touchmove: !0 };
class _p {
  constructor() {
...
function qp(n) {
  for (let e in Ne) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      Up(n, r) && !il(n, r) && (n.editable || !(r.type in De)) && t(n, r);
    }, Wp[e] ? { passive: !0 } : void 0);
  }
...
De.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Qd(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(Mt && Ce && t.keyCode == 13)))
    ...
    } else n.someProp("handleKeyDown", (r) => r(n, t)) || Bp(n, t) ? t.preventDefault() : _t(n, "key");
};
De.keyup = (n, e) => {
...
De.keypress = (n, e) => {
  let t = e;
  if (Qd(n, t) || !t.charCode || t.ctrlKey && !t.altKey || Ue && t.metaKey)
    return;
...
function Yp(n, e) {
  ...
  return r && r.isAtom && L.isSelectable(r) ? (Gn(n, new L(t)), !0) : !1;
}
function Xp(n, e) {
  if (e == -1)
    return !1;
  ...
  return i != null ? (Gn(n, L.create(n.state.doc, i)), !0) : !1;
}
function Qp(n, e, t, r, i) {
  return ol(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? Xp(n, t) : Yp(n, t));
}
function Zp(n, e, t, r) {
  return ol(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function em(n, e, t, r) {
  return ol(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || tm(n, t, r);
}
function tm(n, e, t) {
  if (t.button != 0)
    return !1;
  let r = n.state.doc;
  if (e == -1)
    return r.inlineContent ? (Gn(n, I.create(r, 0, r.content.size)), !0) : !1;
  let i = r.resolve(e);
  for (let o = i.depth + 1; o > 0; o--) {
    let s = o > i.depth ? i.nodeAfter : i.node(o), l = i.before(o);
    if (s.inlineContent)
      Gn(n, I.create(r, l + 1, l + 1 + s.content.size));
...
const Xd = Ue ? "metaKey" : "ctrlKey";
Ne.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = sl(n), i = Date.now(), o = "singleClick";
  i - n.input.lastClick.time < 500 && Gp(t, n.input.lastClick) && !t[Xd] && n.input.lastClick.button == t.button && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o, button: t.button };
  let s = n.posAtCoords(bo(t));
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new nm(n, s, t, !!r)) : (o == "doubleClick" ? Zp : em)(n, s.pos, s.inside, t) ? t.preventDefault() : _t(n, "pointer"));
};
class nm {
  constructor(e, t, r, i) {
    this.view = e, this.pos = t, this.event = r, this.flushed = i, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!r[Xd], this.allowDefault = r.shiftKey;
    let o, s;
    if (t.inside > -1)
    ...
    }, 20), this.view.domObserver.start()), e.root.addEventListener("mouseup", this.up = this.up.bind(this)), e.root.addEventListener("mousemove", this.move = this.move.bind(this)), _t(e, "pointer");
  }
  done() {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(bo(e))), this.updateAllowDefault(e), this.allowDefault || !t ? _t(this.view, "pointer") : Qp(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    Ce && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (Gn(this.view, B.near(this.view.state.doc.resolve(t.pos))), e.preventDefault()) : _t(this.view, "pointer");
  }
  move(e) {
    this.updateAllowDefault(e), _t(this.view, "pointer"), e.buttons == 0 && this.done();
  }
...
Ne.touchstart = (n) => {
  n.input.lastTouch = Date.now(), sl(n), _t(n, "pointer");
};
Ne.touchmove = (n) => {
  n.input.lastTouch = Date.now(), _t(n, "pointer");
};
...
De.compositionstart = De.compositionupdate = (n) => {
  if (!n.composing) {
    ...
    else if (ji(n, !e.selection.empty), rt && e.selection.empty && t.parentOffset && !t.textOffset && t.nodeBefore.marks.length) {
...
const Ir = Le && Ut < 15 || Qn && np < 604;
Ne.copy = De.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let o = Ir ? null : t.clipboardData, s = r.content(), { dom: l, text: a } = rl(n, s);
  o ? (t.preventDefault(), o.clearData(), o.setData("text/html", l.innerHTML), o.setData("text/plain", a)) : sm(n, l), i && n.dispatch(n.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function lm(n) {
...
function Lr(n, e, t, r, i) {
  let o = qd(n, e, t, r, n.state.selection.$from);
  if (n.someProp("handlePaste", (a) => a(n, i, o || T.empty)))
    return !0;
  if (!o)
    return !1;
  let s = lm(o), l = s ? n.state.tr.replaceSelectionWith(s, r) : n.state.tr.replaceSelection(o);
...
De.paste = (n, e) => {
  ...
  r && Lr(n, tu(r), r.getData("text/html"), i, t) ? t.preventDefault() : am(n, t);
};
class nu {
  constructor(e, t, r) {
...
Ne.dragstart = (n, e) => {
  ...
  (!t.dataTransfer.files.length || !Ce || Ed > 120) && t.dataTransfer.clearData(), t.dataTransfer.setData(Ir ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Ir || t.dataTransfer.setData("text/plain", c), n.dragging = new nu(d, ru(n, t), s);
};
Ne.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
De.drop = (n, e) => {
  ...
  s ? n.someProp("transformPasted", (p) => {
    s = p(s, n);
  }) : s = qd(n, tu(t.dataTransfer), Ir ? null : t.dataTransfer.getData("text/html"), !1, o);
  let l = !!(r && ru(n, t));
  ...
  if (!s)
    return;
  t.preventDefault();
  let a = s ? wd(n.state.doc, o.pos, s) : o.pos;
  a == null && (a = o.pos);
  let c = n.state.tr;
  if (l) {
    let { node: p } = r;
...
Ne.beforeinput = (n, e) => {
  if (Ce && Mt && e.inputType == "deleteContentBackward") {
...
class Gt {
  ...
  eq(e) {
    return this == e || e instanceof Gt && Pr(this.attrs, e.attrs) && Pr(this.spec, e.spec);
  }
  static is(e) {
...
class Z {
  ...
  */
  static create(e, t) {
    return t.length ? _i(t, e, 0, vn) : xe;
  }
  /**
  ...
  */
  map(e, t, r) {
    return this == xe || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, r || vn);
  }
  /**
  @internal
  */
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? dm(this.children, s || [], e, t, r, i, o) : s ? new Z(s.sort(bn), Fn) : xe;
  }
  /**
  ...
  */
  add(e, t) {
    return t.length ? this == xe ? Z.create(e, t) : this.addInner(e, t, 0) : this;
  }
  addInner(e, t, r) {
    let i, o = 0;
    e.forEach((l, a) => {
      ...
      if (d = ou(t, l, c)) {
        for (i || (i = this.children.slice()); o < i.length && i[o] < a; )
          o += 3;
        i[o] == a ? i[o + 2] = i[o + 2].addInner(l, d, c + 1) : i.splice(o, 0, a, a + l.nodeSize, _i(d, l, c + 1, vn)), o += 3;
      }
    });
    let s = iu(o ? su(t) : t, -r);
    for (let l = 0; l < s.length; l++)
      s[l].type.valid(e, s[l]) || s.splice(l--, 1);
    return new Z(s.length ? this.local.concat(s).sort(bn) : this.local, i || this.children);
  }
  /**
  ...
  */
  ...
  removeInner(e, t) {
    ...
    return r == this.children && i == this.local ? this : i.length || r.length ? new Z(i, r) : xe;
  }
  forChild(e, t) {
    if (this == xe)
      return this;
...
class Vt {
  ...
  forChild(e, t) {
    ...
    for (let i = 0; i < this.members.length; i++) {
      ...
      o != xe && (o instanceof Vt ? r = r.concat(o.members) : r.push(o));
    }
    return Vt.from(r);
  }
  eq(e) {
  ...
  for (let c = 0; c < l.length; c += 3)
    if (l[c + 1] < 0) {
      ...
      if (m && g == u && g + m.nodeSize == h) {
        ...
        y != xe ? (l[c] = u, l[c + 1] = h, l[c + 2] = y) : (l[c + 1] = -2, a = !0);
      } else
        a = !0;
    }
  if (a) {
    let c = um(l, n, e, t, i, o, s), d = _i(c, r, 0, s);
    e = d.local;
...
function _i(n, e, t, r) {
  ...
  e.forEach((l, a) => {
    ...
    if (c) {
      ...
      d != xe && i.push(a, a + l.nodeSize, d);
    }
  });
  let s = iu(o ? su(n) : n, -t).sort(bn);
  for (let l = 0; l < s.length; l++)
    s[l].type.valid(e, s[l]) || (r.onRemove && r.onRemove(s[l].spec), s.splice(l--, 1));
  return s.length || i.length ? new Z(s, i) : xe;
}
function bn(n, e) {
...
class mm {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new pm(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
  ...
  start() {
    this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, fm)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection();
  }
  stop() {
    if (this.observer) {
  ...
  ignoreSelectionChange(e) {
    ...
    for (let o = e.focusNode; o; o = Xn(o))
      t.add(o);
    for (let o = e.anchorNode; o; o = Xn(o))
      if (t.has(o)) {
        r = o;
        break;
      }
  ...
  flush() {
    ...
    if (rt && a.length) {
      ...
      if (d.length == 2) {
        ...
        for (let f of d) {
          let h = f.parentNode;
          h && h.nodeName == "LI" && (!u || vm(e, u) != h) && f.remove();
        }
      }
    }
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && yo(r) && (c = tl(e)) && c.eq(B.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Ot(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), gm(e)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Ot(e), this.currentSelection.set(r));
  }
...
function bm(n, e, t) {
  ...
  if (d && n.dom.contains(d.nodeType == 1 ? d : d.parentNode) && (c = [{ node: d, offset: a.anchorOffset }], yo(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), Ce && n.input.lastKeyCode === 8)
    for (let m = o; m > i; m--) {
  ...
  let u = n.state.doc, f = n.someProp("domParser") || Kt.fromSchema(n.state.schema), h = u.resolve(s), p = null, g = f.parse(r, {
    topNode: h.parent,
...
const km = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function xm(n, e, t, r, i) {
  ...
  if (n.input.compositionPendingChanges = 0, e < 0) {
    ...
    if (E && !n.state.selection.eq(E)) {
      if (Ce && Mt && n.input.lastKeyCode === 13 && Date.now() - 100 < n.input.lastKeyCodeTime && n.someProp("handleKeyDown", ($) => $(n, ln(13, "Enter"))))
        return;
  ...
  let a = n.state.selection, c = bm(n, e, t), d = n.state.doc, u = d.slice(c.from, c.to), f, h;
  n.input.lastKeyCode === 8 && Date.now() - 100 < n.input.lastKeyCodeTime ? (f = n.state.selection.to, h = "end") : (f = n.state.selection.from, h = "start"), n.input.lastKeyCode = null;
  let p = Mm(u.content, c.doc.content, c.from, f, h);
  if (p && n.input.domChangeCount++, (Qn && n.input.lastIOSEnter > Date.now() - 225 || Mt) && i.some((A) => A.nodeType == 1 && !km.test(A.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (A) => A(n, ln(13, "Enter")))) {
  ...
  n.state.selection.from < n.state.selection.to && p.start == p.endB && n.state.selection instanceof I && (p.start > n.state.selection.from && p.start <= n.state.selection.from + 2 && n.state.selection.from >= c.from ? p.start = n.state.selection.from : p.endA < n.state.selection.to && p.endA >= n.state.selection.to - 2 && n.state.selection.to <= c.to && (p.endB += n.state.selection.to - p.endA, p.endA = n.state.selection.to)), Le && Ut <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == "  " && (p.start--, p.endA--, p.endB--);
  ...
  if ((Qn && n.input.lastIOSEnter > Date.now() - 225 && (!w || i.some((A) => A.nodeName == "DIV" || A.nodeName == "P")) || !w && g.pos < c.doc.content.size && (!g.sameParent(m) || !g.parent.inlineContent) && !/\S/.test(c.doc.textBetween(g.pos, m.pos, "", "")) && (C = B.findFrom(c.doc.resolve(g.pos + 1), 1, !0)) && C.head > g.pos) && n.someProp("handleKeyDown", (A) => A(n, ln(13, "Enter")))) {
    n.input.lastIOSEnter = 0;
    return;
  }
  if (n.state.selection.anchor > p.start && Sm(d, p.start, p.endA, g, m) && n.someProp("handleKeyDown", (A) => A(n, ln(8, "Backspace")))) {
    Mt && Ce && n.domObserver.suppressSelectionUpdates();
    return;
  }
  Ce && p.endB == p.start && (n.input.lastChromeDelete = Date.now()), Mt && !w && g.start() != m.start() && m.parentOffset == 0 && g.depth == m.depth && c.sel && c.sel.anchor == c.sel.head && c.sel.head == p.endA && (p.endB -= 2, m = c.doc.resolveNoCache(p.endB - c.from), setTimeout(() => {
  ...
  let v = p.start, M = p.endA, b = (A) => {
    ...
    if (c.sel) {
      ...
      P && !(Ce && n.composing && P.empty && (p.start != p.endB || n.input.lastChromeDelete < Date.now() - 100) && (P.head == v || P.head == E.mapping.map(M) - 1) || Le && P.empty && P.head == v) && E.setSelection(P);
    }
    return o && E.setMeta("composition", o), E.scrollIntoView();
  }, O;
  if (w) {
    if (g.pos == m.pos) {
      Le && Ut <= 11 && g.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => Ot(n), 20));
      let A = b(n.state.tr.delete(v, M)), E = d.resolve(p.start).marksAcross(d.resolve(p.endA));
      E && A.ensureMarks(E), n.dispatch(A);
    } else if (
      // Adding or removing a mark
      p.endA == p.endB && (O = Cm(g.parent.content.cut(g.parentOffset, m.parentOffset), y.parent.content.cut(y.parentOffset, p.endA - y.start())))
    ) {
      let A = b(n.state.tr);
...
class lu {
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    e.storedMarks && this.composing && (eu(this), s = !0), this.state = e;
    let l = i.plugins != e.plugins || this._props.plugins != t.plugins;
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let h = Fa(this);
      Am(h, this.nodeViews) && (this.nodeViews = h, o = !0);
    }
    ...
    let f = d == "preserve" && s && this.dom.style.overflowAnchor == null && op(this);
    if (s) {
      this.domObserver.stop();
      let h = u && (Le || Ce) && !this.composing && !i.selection.empty && !e.selection.empty && Tm(i.selection, e.selection);
      if (u) {
        let p = Ce ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = im(this)), (o || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = ya(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (h = !0);
      }
      h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && Ep(this)) ? Ot(this, h) : (jd(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((r = this.dragging) === null || r === void 0) && r.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), d == "reset" ? this.dom.scrollTop = 0 : d == "to selection" ? this.scrollToSelection() : f && sp(f);
  }
  /**
  @internal
  */
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new nu(e.slice, e.move, i < 0 ? void 0 : L.create(this.state.doc, i));
  }
  someProp(e, t) {
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && lp(this.dom), Ot(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (Kp(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], Wo(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, Jh());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return e ? Ee && this.root.nodeType === 11 && Zh(this.dom.ownerDocument) == this.dom && ym(this, e) || e : { focusNode: null, focusOffset: 0, anchorNode: null, anchorOffset: 0 };
  }
  /**
  @internal
  */
...
lu.prototype.dispatch = function(n) {
...
var Yt = {
  ...
  221: "}",
  222: '"'
}, Om = typeof navigator < "u" && /Mac/.test(navigator.platform), Em = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var we = 0; we < 10; we++) Yt[48 + we] = Yt[96 + we] = String(we);
for (var we = 1; we <= 24; we++) Yt[we + 111] = "F" + we;
for (var we = 65; we <= 90; we++)
  Yt[we] = String.fromCharCode(we + 32), qi[we] = String.fromCharCode(we);
for (var qo in Yt) qi.hasOwnProperty(qo) || (qi[qo] = Yt[qo]);
function Nm(n) {
  var e = Om && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || Em && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? qi : Yt)[n.keyCode] || n.key || "Unidentified";
  return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
const Dm = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function Rm(n) {
...
const cu = (n, e, t) => {
  ...
  let i = ul(r);
  if (!i) {
    let s = r.blockRange(), l = s && or(s);
    return l == null ? !1 : (e && e(n.tr.lift(s, l).scrollIntoView()), !0);
  }
  let o = i.nodeBefore;
  if (vu(n, i, e, -1))
    return !0;
  if (r.parent.content.size == 0 && (Zn(o, "end") || L.isSelectable(o)))
    for (let s = r.depth; ; s--) {
      let l = mo(n.doc, r.before(s), r.after(s), T.empty);
      if (l && l.slice.size < l.to - l.from) {
        if (e) {
          let a = n.tr.step(l);
          a.setSelection(Zn(o, "end") ? B.findFrom(a.doc.resolve(a.mapping.map(i.pos, -1)), -1) : L.create(a.doc, i.pos - o.nodeSize)), e(a.scrollIntoView());
        }
        return !0;
      }
...
const hu = (n, e, t) => {
  ...
  if (vu(n, i, e, 1))
    return !0;
  if (r.parent.content.size == 0 && (Zn(o, "start") || L.isSelectable(o))) {
    let s = mo(n.doc, r.before(), r.after(), T.empty);
    if (s && s.slice.size < s.to - s.from) {
      if (e) {
        let l = n.tr.step(s);
        l.setSelection(Zn(o, "start") ? B.findFrom(l.doc.resolve(l.mapping.map(i.pos)), 1) : L.create(l.doc, l.mapping.map(i.pos))), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
const zm = (n, e) => {
  ...
  let { $from: t, $to: r } = n.selection, i = t.blockRange(r), o = i && or(i);
...
function $m(n) {
  return (e, t) => {
    ...
    let u = d.mapping.map(r.pos), f = At(d.doc, u, o.length, o);
    if (f || (o[0] = l ? { type: l } : null, f = At(d.doc, u, o.length, o)), !f)
      return !1;
...
function _m(n, e, t) {
  ...
  return !r || !i || !r.type.compatibleContent(i.type) ? !1 : !r.content.size && e.parent.canReplace(o - 1, o) ? (t && t(n.tr.delete(e.pos - r.nodeSize, e.pos).scrollIntoView()), !0) : !e.parent.canReplace(o, o + 1) || !(i.isTextblock || Qt(n.doc, e.pos)) ? !1 : (t && t(n.tr.join(e.pos).scrollIntoView()), !0);
}
function vu(n, e, t, r) {
  ...
  if (c && (s = (l = i.contentMatchAt(i.childCount)).findWrapping(o.type)) && l.matchType(s[0] || o.type).validEnd) {
    if (t) {
      ...
      p = x.from(i.copy(p));
      let g = n.tr.step(new pe(e.pos - 1, h, e.pos, h, new T(p, 1, 0), s.length, !0)), m = g.doc.resolve(h + 2 * s.length);
      m.nodeAfter && m.nodeAfter.type == i.type && Qt(g.doc, m.pos) && g.join(m.pos), t(g.scrollIntoView());
    }
    return !0;
  }
  let d = o.type.spec.isolating || r > 0 && a ? null : B.findFrom(e, 1), u = d && d.$from.blockRange(d.$to), f = u && or(u);
  if (f != null && f >= e.depth)
    return t && t(n.tr.lift(u, f).scrollIntoView()), !0;
  if (c && Zn(o, "start", !0) && Zn(i, "end")) {
    let h = i, p = [];
    ...
    if (h.canReplace(h.childCount, h.childCount, g.content)) {
      if (t) {
        ...
        for (let C = p.length - 1; C >= 0; C--)
          y = x.from(p[C].copy(y));
        let w = n.tr.step(new pe(e.pos - p.length, e.pos + o.nodeSize, e.pos + m, e.pos + o.nodeSize - m, new T(y, p.length, 0), 0, !0));
        t(w.scrollIntoView());
      }
      return !0;
    }
...
function Jm(n, e = null) {
  return function(t, r) {
    let { $from: i, $to: o } = t.selection, s = i.blockRange(o);
    if (!s)
      return !1;
    let l = r ? t.tr : null;
    return Gm(l, s, n, e) ? (r && r(l.scrollIntoView()), !0) : !1;
  };
}
function Gm(n, e, t, r = null) {
  let i = !1, o = e, s = e.$from.doc;
  if (e.depth >= 2 && e.$from.node(e.depth - 1).type.compatibleContent(t) && e.startIndex == 0) {
    if (e.$from.index(e.depth - 1) == 0)
      return !1;
    let a = s.resolve(e.start - 2);
    o = new Hi(a, a, e.depth), e.endIndex < e.parent.childCount && (e = new Hi(e.$from, s.resolve(e.$to.end(e.depth)), e.depth)), i = !0;
  }
  let l = Xs(o, t, r, e);
  return l ? (n && Ym(n, e, l, i, t), !0) : !1;
}
function Ym(n, e, t, r, i) {
  let o = x.empty;
  for (let d = t.length - 1; d >= 0; d--)
    o = x.from(t[d].type.create(t[d].attrs, o));
  n.step(new pe(e.start - (r ? 2 : 0), e.end, e.start, e.end, new T(o, 0, 0), t.length, !0));
  let s = 0;
  for (let d = 0; d < t.length; d++)
    t[d].type == i && (s = d + 1);
...
function Xm(n) {
  return function(e, t) {
    ...
    return o ? t ? r.node(o.depth - 1).type == n ? Qm(e, t, n, o) : Zm(e, t, o) : !0 : !1;
  };
}
function Qm(n, e, t, r) {
  let i = n.tr, o = r.end, s = r.$to.end(r.depth);
  o < s && (i.step(new pe(o - 1, s, o, s, new T(x.from(t.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new Hi(i.doc.resolve(r.$from.pos), i.doc.resolve(s), r.depth));
  const l = or(r);
  if (l == null)
    return !1;
  i.lift(r, l);
...
function Zm(n, e, t) {
  ...
  return r.step(new pe(u - (l ? 1 : 0), f + (a ? 1 : 0), u + 1, f - 1, new T((l ? x.empty : x.from(i.copy(x.empty))).append(a ? x.empty : x.from(i.copy(x.empty))), l ? 0 : 1, a ? 0 : 1), l ? 0 : 1)), e(r.scrollIntoView()), !0;
}
function eg(n) {
  return function(e, t) {
...
function H(n, e = void 0, ...t) {
  return ku(n) ? e ? n.bind(e)(...t) : n(...t) : n;
}
function ng(n = {}) {
  ...
  return "style" in n ? n : {
    ...
    getAttrs: (t) => {
      ...
      const i = e.reduce((o, s) => {
        const l = s.attribute.parseHTML ? s.attribute.parseHTML(t) : rg(t.getAttribute(s.name));
        return l == null ? o : {
          ...o,
          [s.name]: l
        };
...
function _a(n) {
  return Object.fromEntries(
    // @ts-ignore
    Object.entries(n).filter(([e, t]) => e === "attrs" && ng(t) ? !1 : t != null)
  );
}
function ig(n, e) {
  var t;
  const r = wu(n), { nodeExtensions: i, markExtensions: o } = xo(n), s = (t = i.find((c) => N(c, "topNode"))) === null || t === void 0 ? void 0 : t.name, l = Object.fromEntries(i.map((c) => {
...
function fi(n) {
  return ag(n) !== "Object" ? !1 : n.constructor === Object && Object.getPrototypeOf(n) === Object.prototype;
}
function So(n, e) {
  const t = { ...n };
  return fi(n) && fi(e) && Object.keys(e).forEach((r) => {
    fi(e[r]) && fi(n[r]) ? t[r] = So(n[r], e[r]) : t[r] = e[r];
  }), t;
}
class ze {
  constructor(e = {}) {
...
function hg(n) {
  ...
  return t.map((d) => new X({
    ...
    view(u) {
      const f = (p) => {
        var g;
        r = !((g = u.dom.parentElement) === null || g === void 0) && g.contains(p.target) ? u.dom.parentElement : null, r && (hi = e);
      }, h = () => {
        hi && (hi = null);
      };
    ...
    appendTransaction: (u, f, h) => {
      ...
      if (w) {
        ...
        const { from: b } = y, O = b + M.length, A = fg(M);
        return a({
          rule: d,
          state: h,
          from: b,
...
class _n {
  constructor(e, t) {
    this.splittableMarks = [], this.editor = t, this.extensions = _n.resolve(e), this.schema = ig(this.extensions, t), this.setupExtensions();
  }
  /**
   ...
   */
  static resolve(e) {
    const t = _n.sort(_n.flatten(e)), r = pg(t.map((i) => i.name));
   ...
   */
  get plugins() {
    const { editor: e } = this, t = _n.sort([...this.extensions].reverse()), r = [], i = [], o = t.map((s) => {
      const l = {
        name: s.name,
        options: s.options,
        storage: s.storage,
      ...
      new X({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: n } = this, { state: e, schema: t } = n, { doc: r, selection: i } = e, { ranges: o } = i, s = Math.min(...o.map((d) => d.$from.pos)), l = Math.max(...o.map((d) => d.$to.pos)), a = Su(t);
            return Cu(r, { from: s, to: l }, {
...
}), gg = () => ({ editor: n, view: e }) => (requestAnimationFrame(() => {
  var t;
  n.isDestroyed || (e.dom.blur(), (t = window == null ? void 0 : window.getSelection()) === null || t === void 0 || t.removeAllRanges());
}), !0), yg = (n = !1) => ({ commands: e }) => e.setContent("", n), vg = () => ({ state: n, tr: e, dispatch: t }) => {
...
}, bg = (n) => (e) => n(e), wg = () => ({ state: n, dispatch: e }) => gu(n, e), kg = (n, e) => ({ editor: t, tr: r }) => {
...
}, Mg = () => ({ state: n, dispatch: e }) => dl(n, e), Tg = () => ({ commands: n }) => n.keyboardShortcut("Enter"), Ag = () => ({ state: n, dispatch: e }) => Fm(n, e);
function Ki(n, e, t = { strict: !0 }) {
  const r = Object.keys(e);
  return r.length ? r.every((i) => t.strict ? e[i] === n[i] : gl(e[i]) ? e[i].test(n[i]) : e[i] === n[i]) : !0;
}
function Mu(n, e, t = {}) {
  return n.find((r) => r.type === e && Ki(
...
function yl(n, e, t) {
  ...
  if ((!i.node || !i.node.marks.some((d) => d.type === e)) && (i = n.parent.childBefore(n.parentOffset)), !i.node || !i.node.marks.some((d) => d.type === e) || (t = t || ((r = i.node.marks[0]) === null || r === void 0 ? void 0 : r.attrs), !Mu([...i.node.marks], e, t)))
    return;
...
const Og = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
...
function Tu(n, e = null) {
  ...
  return e === "all" ? I.create(n, Tt(0, i, o), Tt(n.content.size, i, o)) : I.create(n, Tt(e, i, o), Tt(e, i, o));
}
function Ng() {
...
const Dg = (n = null, e = {}) => ({ editor: t, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
  const s = () => {
    (bl() || Ng()) && r.dom.focus(), requestAnimationFrame(() => {
  ...
  if (o && n === null && !vl(t.state.selection))
    return s(), !0;
  const l = Tu(i.doc, n) || t.state.selection, a = t.state.selection.eq(l);
  return o && (a || i.setSelection(l), a && i.storedMarks && i.setStoredMarks(i.storedMarks), s()), !0;
}, Rg = (n, e) => (t) => n.every((r, i) => e(r, { ...t, index: i })), Ig = (n, e) => ({ tr: t, commands: r }) => r.insertContentAt({ from: t.selection.from, to: t.selection.to }, n, e), Au = (n) => {
  const e = n.childNodes;
  for (let t = e.length - 1; t >= 0; t -= 1) {
    const r = e[t];
    r.nodeType === 3 && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? n.removeChild(r) : r.nodeType === 1 && Au(r);
  }
  return n;
};
function pi(n) {
...
function Br(n, e, t) {
  ...
  if (i) {
    if (t.errorOnInvalidContent) {
      ...
      if (t.slice ? Kt.fromSchema(a).parseSlice(pi(n), t.parseOptions) : Kt.fromSchema(a).parse(pi(n), t.parseOptions), t.errorOnInvalidContent && s)
...
const Pg = (n) => !("type" in n), Bg = (n, e, t) => ({ tr: r, dispatch: i, editor: o }) => {
  var s;
  if (i) {
    t = {
    ...
    t.updateSelection && Lg(r, r.steps.length - 1, -1), t.applyInputRules && r.setMeta("applyInputRules", { from: d, text: g }), t.applyPasteRules && r.setMeta("applyPasteRules", { from: d, text: g });
  }
  return !0;
}, zg = () => ({ state: n, dispatch: e }) => zm(n, e), Hg = () => ({ state: n, dispatch: e }) => Hm(n, e), Vg = () => ({ state: n, dispatch: e }) => cu(n, e), Fg = () => ({ state: n, dispatch: e }) => hu(n, e), $g = () => ({ state: n, dispatch: e, tr: t }) => {
  try {
...
}, Wg = () => ({ state: n, dispatch: e }) => Pm(n, e), _g = () => ({ state: n, dispatch: e }) => Bm(n, e);
function Ou() {
...
const Kg = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
  const o = qg(n).split(/-(?!$)/), s = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
function zr(n, e, t = {}) {
  ...
  const a = i - r, c = l.filter((u) => s ? s.name === u.node.type.name : !0).filter((u) => Ki(u.node.attrs, t, { strict: !1 }));
  return o ? !!c.length : c.reduce((u, f) => u + f.to - f.from, 0) >= a;
}
const Ug = (n, e = {}) => ({ state: t, dispatch: r }) => {
  const i = ge(n, t.schema);
  return zr(t, i, e) ? Vm(t, r) : !1;
}, Jg = () => ({ state: n, dispatch: e }) => yu(n, e), Gg = (n) => ({ state: e, dispatch: t }) => {
  const r = ge(n, e.schema);
  return Xm(r)(e, t);
}, Yg = () => ({ state: n, dispatch: e }) => mu(n, e);
function Mo(n, e) {
...
const Xg = (n, e) => ({ tr: t, state: r, dispatch: i }) => {
  let o = null, s = null;
...
}, Qg = () => ({ tr: n, dispatch: e }) => (e && n.scrollIntoView(), !0), Zg = () => ({ tr: n, dispatch: e }) => {
  if (e) {
    const t = new $e(n.doc);
    n.setSelection(t);
  }
  return !0;
}, e1 = () => ({ state: n, dispatch: e }) => uu(n, e), t1 = () => ({ state: n, dispatch: e }) => pu(n, e), n1 = () => ({ state: n, dispatch: e }) => Wm(n, e), r1 = () => ({ state: n, dispatch: e }) => Km(n, e), i1 = () => ({ state: n, dispatch: e }) => qm(n, e);
function Ts(n, e, t = {}, r = {}) {
  return Br(n, e, {
    slice: !1,
    parseOptions: t,
...
const o1 = (n, e = !1, t = {}, r = {}) => ({ editor: i, tr: o, dispatch: s, commands: l }) => {
  var a, c;
  const { doc: d } = o;
...
function Nu(n, e) {
  ...
  return t === "node" ? d1(n, e) : t === "mark" ? To(n, e) : {};
}
function u1(n, e = JSON.stringify) {
  const t = {};
  return n.filter((r) => {
    const i = e(r);
...
function As(n, e, t = {}) {
  ...
  if (r)
    return !!(n.storedMarks || n.selection.$from.marks()).filter((u) => o ? o.name === u.type.name : !0).find((u) => Ki(u.attrs, t, { strict: !1 }));
  let s = 0;
  const l = [];
  if (i.forEach(({ $from: u, $to: f }) => {
    ...
    return !1;
  const a = l.filter((u) => o ? o.name === u.mark.type.name : !0).filter((u) => Ki(u.mark.attrs, t, { strict: !1 })).reduce((u, f) => u + f.to - f.from, 0), c = l.filter((u) => o ? u.mark.type !== o && u.mark.type.excludes(o) : !0).reduce((u, f) => u + f.to - f.from, 0);
  return (a > 0 ? a + c : a) >= s;
}
function p1(n, e, t = {}) {
  if (!e)
...
function Du(n, e, t) {
  const i = n.state.doc.content.size, o = Tt(e, 0, i), s = Tt(t, 0, i), l = n.coordsAtPos(o), a = n.coordsAtPos(s, -1), c = Math.min(l.top, a.top), d = Math.max(l.bottom, a.bottom), u = Math.min(l.left, a.left), f = Math.max(l.right, a.right), h = f - u, p = d - c, y = {
    top: c,
    bottom: d,
    left: u,
    right: f,
...
const y1 = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return g1(r, t, a);
}, v1 = (n, e) => ({ tr: t }) => (t.setMeta(n, e), !0), b1 = (n, e = {}) => ({ state: t, dispatch: r, chain: i }) => {
...
}, w1 = (n) => ({ tr: e, dispatch: t }) => {
  if (t) {
    const { doc: r } = e, i = Tt(n, 0, r.content.size), o = L.create(r, i);
    e.setSelection(o);
  }
  return !0;
}, k1 = (n) => ({ tr: e, dispatch: t }) => {
  if (t) {
    const { doc: r } = e, { from: i, to: o } = typeof n == "number" ? { from: n, to: n } : n, s = I.atStart(r).from, l = I.atEnd(r).to, a = Tt(i, s, l), c = Tt(o, s, l), d = I.create(r, a, c);
    e.setSelection(d);
  }
  return !0;
}, x1 = (n) => ({ state: e, dispatch: t }) => {
  const r = ge(n, e.schema);
  return eg(r)(e, t);
};
function Ga(n, e) {
...
const C1 = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  const { selection: o, doc: s } = e, { $from: l, $to: a } = o, c = i.extensionManager.attributes, d = Oi(c, l.node().type.name, l.node().attrs);
  if (o instanceof L && o.node.isBlock)
    return !l.parentOffset || !At(s, l.pos) ? !1 : (r && (n && Ga(t, i.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
  if (!l.parent.isBlock)
    return !1;
  const u = a.parentOffset === a.parent.content.size, f = l.depth === 0 ? void 0 : l1(l.node(-1).contentMatchAt(l.indexAfter(-1)));
  let h = u && f ? [
    {
      type: f,
      attrs: d
  ...
  if (!h && !p && At(e.doc, e.mapping.map(l.pos), 1, f ? [{ type: f }] : void 0) && (p = !0, h = f ? [
    {
      type: f,
      attrs: d
    }
  ...
  return p;
}, S1 = (n, e = {}) => ({ tr: t, state: r, dispatch: i, editor: o }) => {
  var s;
  ...
  if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
    ...
    if (i) {
      ...
      const C = a.indexAfter(-1) < a.node(-2).childCount ? 1 : a.indexAfter(-2) < a.node(-3).childCount ? 2 : 3, v = {
        ...Oi(f, a.node().type.name, a.node().attrs),
        ...e
...
}, M1 = (n, e, t, r = {}) => ({ editor: i, tr: o, state: s, dispatch: l, chain: a, commands: c, can: d }) => {
...
}, R1 = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  let o = null, s = null;
  const l = Mo(typeof n == "string" ? n : n.name, r.schema);
  return l ? (l === "node" && (o = ge(n, r.schema)), l === "mark" && (s = en(n, r.schema)), i && t.selection.ranges.forEach((a) => {
...
var P1 = /* @__PURE__ */ Object.freeze({
  ...
  scrollIntoView: Qg,
  selectAll: Zg,
  selectNodeBackward: e1,
  selectNodeForward: t1,
  selectParentNode: n1,
  selectTextblockEnd: r1,
  selectTextblockStart: i1,
  setContent: o1,
  setMark: y1,
  setMeta: v1,
  setNode: b1,
...
}), V1 = new se("focusEvents"), F1 = ee.create({
  name: "focusEvents",
  addProseMirrorPlugins() {
    const { editor: n } = this;
    return [
...
let K1 = class extends tg {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = q1(_1, this.options.injectNonce));
  }
  /**
   ...
   */
  registerPlugin(e, t) {
    const r = ku(t) ? t(e, [...this.state.plugins]) : [...this.state.plugins, e], i = this.state.reconfigure({ plugins: r });
  ...
  createView() {
    ...
    const r = Tu(t, this.options.autofocus);
    this.view = new lu(this.options.element, {
...
var Pe = "top", Xe = "bottom", Qe = "right", Be = "left", Cl = "auto", Yr = [Pe, Xe, Qe, Be], er = "start", Vr = "end", G1 = "clippingParents", Iu = "viewport", mr = "popper", Y1 = "reference", Ya = /* @__PURE__ */ Yr.reduce(function(n, e) {
  return n.concat([e + "-" + er, e + "-" + Vr]);
}, []), Lu = /* @__PURE__ */ [].concat(Yr, [Cl]).reduce(function(n, e) {
  return n.concat([e, e + "-" + er, e + "-" + Vr]);
}, []), X1 = "beforeRead", Q1 = "read", Z1 = "afterRead", e0 = "beforeMain", t0 = "main", n0 = "afterMain", r0 = "beforeWrite", i0 = "write", o0 = "afterWrite", s0 = [X1, Q1, Z1, e0, t0, n0, r0, i0, o0];
function pt(n) {
...
var wn = Math.max, Ui = Math.min, tr = Math.round;
function Es() {
...
function nr(n, e, t) {
  ...
  e && Ye(n) && (i = n.offsetWidth > 0 && tr(r.width) / n.offsetWidth || 1, o = n.offsetHeight > 0 && tr(r.height) / n.offsetHeight || 1);
  var s = An(n) ? je(n) : window, l = s.visualViewport, a = !Bu() && t, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, d = (r.top + (a && l ? l.offsetTop : 0)) / o, u = r.width / i, f = r.height / o;
  return {
    width: u,
    height: f,
    top: d,
...
function Xr(n) {
  for (var e = je(n), t = Xa(n); t && c0(t) && Et(t).position === "static"; )
    t = Xa(t);
  return t && (pt(t) === "html" || pt(t) === "body" && Et(t).position === "static") ? e : t || d0(n) || e;
}
function Tl(n) {
...
var f0 = function(e, t) {
  ...
  })) : e, Vu(typeof e != "number" ? e : Fu(e, Yr));
};
function h0(n) {
  ...
  if (!(!o || !s)) {
    var u = f0(i.padding, t), f = Ml(o), h = a === "y" ? Pe : Be, p = a === "y" ? Xe : Qe, g = t.rects.reference[d] + t.rects.reference[a] - s[a] - t.rects.popper[d], m = s[a] - t.rects.reference[a], y = Xr(o), w = y ? a === "y" ? y.clientHeight || 0 : y.clientWidth || 0 : 0, C = g / 2 - m / 2, v = u[h], M = w - f[d] - u[p], b = w / 2 - f[d] / 2 + C, O = xr(v, b, M), A = a;
    t.modifiersData[r] = (e = {}, e[A] = O, e.centerOffset = O - b, e);
  }
}
function p0(n) {
  var e = n.state, t = n.options, r = t.element, i = r === void 0 ? "[data-popper-arrow]" : r;
  i != null && (typeof i == "string" && (i = e.elements.popper.querySelector(i), !i) || zu(e.elements.popper, i) && (e.elements.arrow = i));
}
const m0 = {
  name: "arrow",
  enabled: !0,
...
function Qa(n) {
  ...
  if (c) {
    var b = Xr(t), O = "clientHeight", A = "clientWidth";
    if (b === je(t) && (b = tn(t), Et(b).position !== "static" && l === "absolute" && (O = "scrollHeight", A = "scrollWidth")), b = b, i === Pe || (i === Be || i === Qe) && o === Vr) {
      v = Xe;
  ...
  if (h = j.x, g = j.y, a) {
    var W;
    return Object.assign({}, $, (W = {}, W[v] = w ? "0" : "", W[C] = y ? "0" : "", W.transform = (M.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + g + "px)" : "translate3d(" + h + "px, " + g + "px, 0)", W));
  }
  return Object.assign({}, $, (e = {}, e[v] = w ? g + "px" : "", e[C] = y ? h + "px" : "", e.transform = "", e));
}
function v0(n) {
...
function Ol(n) {
  return nr(tn(n)).left + Al(n).scrollLeft;
}
function S0(n, e) {
  var t = je(n), r = tn(n), i = t.visualViewport, o = r.clientWidth, s = r.clientHeight, l = 0, a = 0;
  if (i) {
...
function M0(n) {
  var e, t = tn(n), r = Al(n), i = (e = n.ownerDocument) == null ? void 0 : e.body, o = wn(t.scrollWidth, t.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0), s = wn(t.scrollHeight, t.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0), l = -r.scrollLeft + Ol(n), a = -r.scrollTop;
  return Et(i || t).direction === "rtl" && (l += wn(t.clientWidth, i ? i.clientWidth : 0) - o), {
    width: o,
    height: s,
    x: l,
    y: a
...
function $u(n) {
  return ["html", "body", "#document"].indexOf(pt(n)) >= 0 ? n.ownerDocument.body : Ye(n) && El(n) ? n : $u(Ao(n));
}
function Cr(n, e) {
  var t;
  e === void 0 && (e = []);
  var r = $u(n), i = r === ((t = n.ownerDocument) == null ? void 0 : t.body), o = je(r), s = i ? [o].concat(o.visualViewport || [], El(r) ? r : []) : r, l = e.concat(s);
  return i ? l : (
...
function ec(n, e, t) {
  return e === Iu ? Ns(S0(n, t)) : An(e) ? T0(e, t) : Ns(M0(tn(n)));
}
function A0(n) {
  var e = Cr(Ao(n)), t = ["absolute", "fixed"].indexOf(Et(n).position) >= 0, r = t && Ye(n) ? Xr(n) : n;
  return An(r) ? e.filter(function(i) {
    return An(i) && zu(i, r) && pt(i) !== "body";
  }) : [];
}
function O0(n, e, t, r) {
  var i = e === "clippingParents" ? A0(n) : [].concat(e), o = [].concat(i, [t]), s = o[0], l = o.reduce(function(a, c) {
    var d = ec(n, c, r);
    return a.top = wn(d.top, a.top), a.right = Ui(d.right, a.right), a.bottom = Ui(d.bottom, a.bottom), a.left = wn(d.left, a.left), a;
  }, ec(n, s, r));
  return l.width = l.right - l.left, l.height = l.bottom - l.top, l.x = l.left, l.y = l.top, l;
}
function ju(n) {
  var e = n.reference, t = n.element, r = n.placement, i = r ? ut(r) : null, o = r ? rr(r) : null, s = e.x + e.width / 2 - t.width / 2, l = e.y + e.height / 2 - t.height / 2, a;
  switch (i) {
    case Pe:
      a = {
        x: s,
...
function Fr(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, o = t.strategy, s = o === void 0 ? n.strategy : o, l = t.boundary, a = l === void 0 ? G1 : l, c = t.rootBoundary, d = c === void 0 ? Iu : c, u = t.elementContext, f = u === void 0 ? mr : u, h = t.altBoundary, p = h === void 0 ? !1 : h, g = t.padding, m = g === void 0 ? 0 : g, y = Vu(typeof m != "number" ? m : Fu(m, Yr)), w = f === mr ? Y1 : mr, C = n.rects.popper, v = n.elements[p ? w : f], M = O0(An(v) ? v : v.contextElement || tn(n.elements.popper), a, d, s), b = nr(n.elements.reference), O = ju({
    reference: b,
    element: C,
    placement: i
  ...
  if (f === mr && $) {
    ...
    Object.keys(P).forEach(function(W) {
      var ae = [Qe, Xe].indexOf(W) >= 0 ? 1 : -1, Q = [Pe, Xe].indexOf(W) >= 0 ? "y" : "x";
      P[W] += j[Q] * ae;
    });
  }
  return P;
...
function E0(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = t.boundary, o = t.rootBoundary, s = t.padding, l = t.flipVariations, a = t.allowedAutoPlacements, c = a === void 0 ? Lu : a, d = rr(r), u = d ? l ? Ya : Ya.filter(function(p) {
    return rr(p) === d;
...
function D0(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, d = t.boundary, u = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, g = t.allowedAutoPlacements, m = e.options.placement, y = ut(m), w = y === m, C = a || (w || !p ? [Ei(m)] : N0(m)), v = [m].concat(C).reduce(function(gt, Ze) {
      return gt.concat(ut(Ze) === Cl ? E0(e, {
        placement: Ze,
        boundary: d,
        rootBoundary: u,
        padding: c,
      ...
      var $ = v[P], j = ut($), W = rr($) === er, ae = [Pe, Xe].indexOf(j) >= 0, Q = ae ? "width" : "height", U = Fr(e, {
        placement: $,
        boundary: d,
        rootBoundary: u,
        altBoundary: f,
        padding: c
      }), J = ae ? W ? Qe : Be : W ? Xe : Pe;
      M[Q] > b[Q] && (J = Ei(J));
      var F = Ei(J), le = [];
      if (o && le.push(U[j] <= 0), l && le.push(U[J] <= 0, U[F] <= 0), le.every(function(gt) {
        return gt;
      })) {
        E = $, A = !1;
        break;
    ...
    if (A)
      for (var ne = p ? 3 : 1, Re = function(Ze) {
        var yt = v.find(function(Nn) {
          var vt = O.get(Nn);
          if (vt)
            return vt.slice(0, Ze).every(function(Dn) {
              return Dn;
            });
        });
        if (yt)
...
function B0(n) {
  var e = n.state, t = n.options, r = n.name, i = t.offset, o = i === void 0 ? [0, 0] : i, s = Lu.reduce(function(d, u) {
    return d[u] = P0(u, e.rects, o), d;
...
function $0(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, d = t.altBoundary, u = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, g = p === void 0 ? 0 : p, m = Fr(e, {
    ...
    padding: u,
    altBoundary: d
  }), y = ut(e.placement), w = rr(e.placement), C = !w, v = Tl(y), M = F0(v), b = e.modifiersData.popperOffsets, O = e.rects.reference, A = e.rects.popper, E = typeof g == "function" ? g(Object.assign({}, e.rects, {
    placement: e.placement
  })) : g, P = typeof E == "number" ? {
    mainAxis: E,
    altAxis: E
    ...
    mainAxis: 0,
    altAxis: 0
  }, E), $ = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, j = {
    x: 0,
    y: 0
  };
  if (b) {
    if (o) {
      var W, ae = v === "y" ? Pe : Be, Q = v === "y" ? Xe : Qe, U = v === "y" ? "height" : "width", J = b[v], F = J + m[ae], le = J - m[Q], ne = h ? -A[U] / 2 : 0, Re = w === er ? O[U] : A[U], fe = w === er ? -A[U] : -O[U], We = e.elements.arrow, gt = h && We ? Ml(We) : {
        width: 0,
        height: 0
      }, Ze = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Hu(), yt = Ze[ae], Nn = Ze[Q], vt = xr(0, O[U], gt[U]), Dn = C ? O[U] / 2 - ne - vt - yt - P.mainAxis : Re - vt - yt - P.mainAxis, Nt = C ? -O[U] / 2 + ne + vt + Nn + P.mainAxis : fe + vt + Nn + P.mainAxis, Rn = e.elements.arrow && Xr(e.elements.arrow), Qr = Rn ? v === "y" ? Rn.clientTop || 0 : Rn.clientLeft || 0 : 0, ar = (W = $ == null ? void 0 : $[v]) != null ? W : 0, Zr = J + Dn - ar - Qr, ei = J + Nt - ar, cr = xr(h ? Ui(F, Zr) : F, J, h ? wn(le, ei) : le);
      b[v] = cr, j[v] = cr - J;
    }
    if (l) {
      var dr, ti = v === "x" ? Pe : Be, ni = v === "x" ? Xe : Qe, bt = b[M], Dt = M === "y" ? "height" : "width", ur = bt + m[ti], nn = bt - m[ni], fr = [Pe, Be].indexOf(y) !== -1, ri = (dr = $ == null ? void 0 : $[M]) != null ? dr : 0, ii = fr ? ur : bt - O[Dt] - A[Dt] - ri + P.altAxis, oi = fr ? bt + O[Dt] + A[Dt] - ri - P.altAxis : nn, si = h && fr ? u0(ii, bt, oi) : xr(h ? ii : ur, bt, h ? oi : nn);
      b[M] = si, j[M] = si - bt;
    }
    e.modifiersData[r] = j;
  }
...
function _0(n) {
  return n === je(n) || !Ye(n) ? Al(n) : W0(n);
}
function q0(n) {
  var e = n.getBoundingClientRect(), t = tr(e.width) / n.offsetWidth || 1, r = tr(e.height) / n.offsetHeight || 1;
  return t !== 1 || r !== 1;
}
function K0(n, e, t) {
  t === void 0 && (t = !1);
  var r = Ye(e), i = Ye(e) && q0(e), o = tn(e), s = nr(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  El(o)) && (l = _0(e)), Ye(e) ? (a = nr(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = Ol(o))), {
  ...
  return function(l, a, c) {
    ...
    var d = {
      ...
      setOptions: function(y) {
        ...
        var C = J0(Y0([].concat(r, d.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (ic(w, C)) {
            d.rects = {
              reference: K0(w, Xr(C), d.options.strategy === "fixed"),
              popper: Ml(C)
...
var Q0 = [k0, V0, b0, Pu, z0, R0, j0, m0, L0], Z0 = /* @__PURE__ */ X0({
  defaultModifiers: Q0
}), ey = "tippy-box", Wu = "tippy-content", ty = "tippy-backdrop", _u = "tippy-arrow", qu = "tippy-svg-arrow", sn = {
  passive: !0,
  capture: !0
}, Ku = function() {
...
function dy(n) {
  return $r(n) ? [n] : ly(n) ? Ji(n) : Array.isArray(n) ? n : Ji(document.querySelectorAll(n));
}
function Xo(n, e) {
...
function fy(n, e) {
  ...
  return n.every(function(i) {
    var o = i.popperRect, s = i.popperState, l = i.props, a = l.interactiveBorder, c = sy(s.placement), d = s.modifiersData.offset;
    if (!d)
      return !0;
...
function hy() {
  ct.isTouch || (ct.isTouch = !0, window.performance && document.addEventListener("mousemove", Ju));
}
function Ju() {
  var n = performance.now();
  n - dc < 20 && (ct.isTouch = !1, document.removeEventListener("mousemove", Ju)), dc = n;
}
function py() {
...
function my() {
  document.addEventListener("touchstart", hy, sn), window.addEventListener("blur", py);
}
...
function St(n, e) {
  if (n && !jr.has(e)) {
    var t;
    jr.add(e), (t = console).warn.apply(t, Gu(e));
  }
}
function Ds(n, e) {
  if (n && !jr.has(e)) {
    var t;
    jr.add(e), (t = console).error.apply(t, Gu(e));
  }
}
function wy(n) {
...
var Yu = {
  ...
  triggerTarget: null
}, Yu, ky), xy = Object.keys(Ve), Cy = function(e) {
...
function Sy(n, e) {
  var t = e ? Object.keys(Xu(Object.assign({}, Ve, {
    plugins: e
  }))) : xy, r = t.reduce(function(i, o) {
...
function fc(n, e) {
  ...
  }, e.ignoreAttributes ? {} : Sy(n, e.plugins));
...
function Qu(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = ry(Ve, Object.keys(Yu)), o = !ny(i, r);
...
function hc(n) {
  var e = Sr();
  return n === !0 ? e.className = _u : (e.className = qu, $r(n) ? e.appendChild(n) : Rs(e, n)), e;
}
function pc(n, e) {
  $r(e.content) ? (Rs(n, ""), n.appendChild(e.content)) : typeof e.content != "function" && (e.allowHTML ? Rs(n, e.content) : n.textContent = e.content);
}
function Is(n) {
  var e = n.firstElementChild, t = Ji(e.children);
  return {
    box: e,
    content: t.find(function(r) {
      return r.classList.contains(Wu);
    }),
    arrow: t.find(function(r) {
      return r.classList.contains(_u) || r.classList.contains(qu);
    }),
    backdrop: t.find(function(r) {
      return r.classList.contains(ty);
    })
  };
}
function Zu(n) {
  var e = Sr(), t = Sr();
  t.className = ey, t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1");
  var r = Sr();
  r.className = Wu, r.setAttribute("data-state", "hidden"), pc(r, n.props), e.appendChild(t), t.appendChild(r), i(n.props, n.props);
  function i(o, s) {
...
var Ty = 1, gi = [], Zo = [];
function Ay(n, e) {
  var t = fc(n, Object.assign({}, Ve, Xu(lc(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, d, u, f, h = [], p = oc(Zr, t.interactiveDebounce), g, m = Ty++, y = null, w = oy(t.plugins), C = {
  ...
  return Rn(), ne(), J(), F("onCreate", [v]), t.showOnCreate && ur(), b.addEventListener("mouseenter", function() {
  ...
  function F(k, D, z) {
    if (z === void 0 && (z = !0), A.forEach(function(V) {
      V[k] && V[k].apply(V, D);
    }), z) {
      var K;
  ...
  function le() {
    var k = v.props.aria;
    if (k.content) {
      var D = "aria-" + k.content, z = b.id, K = $n(v.props.triggerTarget || n);
      K.forEach(function(V) {
        var Te = V.getAttribute(D);
        if (v.state.isVisible)
          V.setAttribute(D, Te ? Te + " " + z : z);
        else {
          var _e = Te && Te.replace(z, "").trim();
          _e ? V.setAttribute(D, _e) : V.removeAttribute(D);
        }
      });
    }
  }
  function ne() {
    if (!(E || !v.props.aria.expanded)) {
      var k = $n(v.props.triggerTarget || n);
      k.forEach(function(D) {
        v.props.interactive ? D.setAttribute("aria-expanded", v.state.isVisible && D === W() ? "true" : "false") : D.removeAttribute("aria-expanded");
      });
    }
  }
  function Re() {
    ae().removeEventListener("mousemove", p), gi = gi.filter(function(k) {
      return k !== p;
    });
  }
  function fe(k) {
    if (!(ct.isTouch && (a || k.type === "mousedown"))) {
      ...
      if (!(v.props.interactive && cc(b, D))) {
        if ($n(v.props.triggerTarget || n).some(function(z) {
          return cc(z, D);
        })) {
          if (ct.isTouch || v.state.isVisible && v.props.trigger.indexOf("click") >= 0)
            return;
        } else
          F("onClickOutside", [v, k]);
  ...
  function Ze() {
    var k = ae();
    k.addEventListener("mousedown", fe, !0), k.addEventListener("touchend", fe, sn), k.addEventListener("touchstart", gt, sn), k.addEventListener("touchmove", We, sn);
  }
  function yt() {
    var k = ae();
    k.removeEventListener("mousedown", fe, !0), k.removeEventListener("touchend", fe, sn), k.removeEventListener("touchstart", gt, sn), k.removeEventListener("touchmove", We, sn);
  }
  function Nn(k, D) {
    Dn(k, function() {
  ...
  function Nt(k, D, z) {
    ...
    var K = $n(v.props.triggerTarget || n);
    K.forEach(function(V) {
      V.addEventListener(k, D, z), h.push({
        node: V,
        eventType: k,
        handler: D,
        options: z
  ...
  function Rn() {
    $() && (Nt("touchstart", ar, {
      ...
      passive: !0
    })), iy(v.props.trigger).forEach(function(k) {
      if (k !== "manual")
        switch (Nt(k, ar), k) {
          case "mouseenter":
            Nt("mouseleave", ei);
  ...
  function Qr() {
    h.forEach(function(k) {
      var D = k.node, z = k.eventType, K = k.handler, V = k.options;
      D.removeEventListener(z, K, V);
    }), h = [];
  }
  function ar(k) {
    var D, z = !1;
    if (!(!v.state.isEnabled || dr(k) || l)) {
      ...
      d = k, g = k.currentTarget, ne(), !v.state.isVisible && ay(k) && gi.forEach(function(V) {
        return V(k);
      }), k.type === "click" && (v.props.trigger.indexOf("mouseenter") < 0 || s) && v.props.hideOnClick !== !1 && v.state.isVisible ? z = !0 : ur(k), k.type === "click" && (s = !z), z && !K && nn(k);
    }
  }
  function Zr(k) {
    var D = k.target, z = W().contains(D) || b.contains(D);
    if (!(k.type === "mousemove" && z)) {
      var K = Dt().concat(b).map(function(V) {
        var Te, _e = V._tippy, In = (Te = _e.popperInstance) == null ? void 0 : Te.state;
        return In ? {
  ...
  function cr(k) {
    v.props.trigger.indexOf("focusin") < 0 && k.target !== W() || v.props.interactive && k.relatedTarget && b.contains(k.relatedTarget) || nn(k);
  }
  function dr(k) {
    return ct.isTouch ? $() !== k.type.indexOf("touch") >= 0 : !1;
  }
  function ti() {
    ni();
    var k = v.props, D = k.popperOptions, z = k.placement, K = k.offset, V = k.getReferenceClientRect, Te = k.moveTransition, _e = j() ? Is(b).arrow : null, In = V ? {
      getBoundingClientRect: V,
      contextElement: V.contextElement || W()
    } : n, $l = {
      name: "$$tippy",
      enabled: !0,
      phase: "beforeWrite",
      ...
      fn: function(li) {
        ...
        if (j()) {
          ...
          ["placement", "reference-hidden", "escaped"].forEach(function(ai) {
            ai === "placement" ? Do.setAttribute("data-placement", Ln.placement) : Ln.attributes.popper["data-popper-" + ai] ? Do.setAttribute("data-" + ai, "") : Do.removeAttribute("data-" + ai);
    ...
    }), rn.push.apply(rn, (D == null ? void 0 : D.modifiers) || []), v.popperInstance = Z0(In, b, Object.assign({}, D, {
      placement: z,
      onFirstUpdate: f,
      modifiers: rn
    }));
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function Dt() {
    return Ji(b.querySelectorAll("[data-tippy-root]"));
  }
  function ur(k) {
    v.clearDelayTimeouts(), k && F("onTrigger", [v, k]), Ze();
    var D = U(!0), z = P(), K = z[0], V = z[1];
    ct.isTouch && K === "hold" && V && (D = V), D ? r = setTimeout(function() {
      v.show();
    }, D) : v.show();
  }
  function nn(k) {
    if (v.clearDelayTimeouts(), F("onUntrigger", [v, k]), !v.state.isVisible) {
      yt();
      return;
    }
  ...
  function oi(k) {
    if (process.env.NODE_ENV !== "production" && St(v.state.isDestroyed, zn("setProps")), !v.state.isDestroyed) {
      F("onBeforeUpdate", [v, k]), Qr();
      var D = v.props, z = fc(n, Object.assign({}, D, lc(k), {
        ignoreAttributes: !0
      }));
      v.props = z, Rn(), D.interactiveDebounce !== z.interactiveDebounce && (Re(), p = oc(Zr, z.interactiveDebounce)), D.triggerTarget && !z.triggerTarget ? $n(D.triggerTarget).forEach(function(K) {
        K.removeAttribute("aria-expanded");
      }) : z.triggerTarget && n.removeAttribute("aria-expanded"), ne(), J(), O && O(D, z), v.popperInstance && (ti(), Dt().forEach(function(K) {
  ...
  function Tf() {
    process.env.NODE_ENV !== "production" && St(v.state.isDestroyed, zn("show"));
    var k = v.state.isVisible, D = v.state.isDestroyed, z = !v.state.isEnabled, K = ct.isTouch && !v.props.touch, V = Yo(v.props.duration, 0, Ve.duration);
    if (!(k || D || z || K) && !W().hasAttribute("disabled") && (F("onShow", [v], !1), v.props.onShow(v) !== !1)) {
      if (v.state.isVisible = !0, j() && (b.style.visibility = "visible"), J(), Ze(), v.state.isMounted || (b.style.transition = "none"), j()) {
        var Te = Q(), _e = Te.box, In = Te.content;
        Xo([_e, In], 0);
      }
      f = function() {
        var rn;
        if (!(!v.state.isVisible || c)) {
          if (c = !0, b.offsetHeight, b.style.transition = v.props.moveTransition, j() && v.props.animation) {
            var No = Q(), li = No.box, Ln = No.content;
            Xo([li, Ln], V), ac([li, Ln], "visible");
          }
          le(), ne(), sc(Zo, v), (rn = v.popperInstance) == null || rn.forceUpdate(), F("onMount", [v]), v.props.animation && j() && vt(V, function() {
            v.state.isShown = !0, F("onShown", [v]);
          });
        }
      }, bt();
    }
  ...
  function Af() {
    process.env.NODE_ENV !== "production" && St(v.state.isDestroyed, zn("hide"));
    var k = !v.state.isVisible, D = v.state.isDestroyed, z = !v.state.isEnabled, K = Yo(v.props.duration, 1, Ve.duration);
    if (!(k || D || z) && (F("onHide", [v], !1), v.props.onHide(v) !== !1)) {
      if (v.state.isVisible = !1, v.state.isShown = !1, c = !1, s = !1, j() && (b.style.visibility = "hidden"), Re(), yt(), J(!0), j()) {
        var V = Q(), Te = V.box, _e = V.content;
        v.props.animation && (Xo([Te, _e], K), ac([Te, _e], "hidden"));
      }
      le(), ne(), v.props.animation ? j() && Nn(K, v.unmount) : v.unmount();
    }
  }
  function Of(k) {
    process.env.NODE_ENV !== "production" && St(v.state.isDestroyed, zn("hideWithInteractivity")), ae().addEventListener("mousemove", p), sc(gi, p), p(k);
  }
  function Ef() {
    process.env.NODE_ENV !== "production" && St(v.state.isDestroyed, zn("unmount")), v.state.isVisible && v.hide(), v.state.isMounted && (ni(), Dt().forEach(function(k) {
      k._tippy.unmount();
    }), b.parentNode && b.parentNode.removeChild(b), Zo = Zo.filter(function(k) {
      return k !== v;
    }), v.state.isMounted = !1, F("onHidden", [v]));
  }
  function Nf() {
    process.env.NODE_ENV !== "production" && St(v.state.isDestroyed, zn("destroy")), !v.state.isDestroyed && (v.clearDelayTimeouts(), v.unmount(), Qr(), delete n._tippy, v.state.isDestroyed = !0, F("onDestroy", [v]));
  }
}
function sr(n, e) {
  e === void 0 && (e = {});
  var t = Ve.plugins.concat(e.plugins || []);
  process.env.NODE_ENV !== "production" && (wy(n), Qu(e, t)), my();
...
class Dy extends K1 {
  constructor(e = {}) {
    return super(e), this.vueRenderers = zf(/* @__PURE__ */ new Map()), this.contentComponent = null, this.reactiveState = mc(this.view.state), this.reactiveExtensionStorage = mc(this.extensionStorage), this.on("transaction", () => {
...
const Ry = Kr({
  ...
  setup(n) {
    ...
    return Lf(() => {
      const r = n.editor;
      r && r.options.element && e.value && Pf(() => {
...
const Iy = /^\s*>\s$/, nf = oe.create({
...
}), Ly = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, Py = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, By = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, zy = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, Hy = ze.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Vy.name, this.editor.getAttributes(gc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), $y = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))$/, jy = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))/g, Wy = ze.create({
  name: "code",
  addOptions() {
    return {
      HTMLAttributes: {}
...
class re extends B {
  ...
  */
  ...
  map(e, t) {
    let r = e.resolve(t.map(this.head));
    return re.valid(r) ? new re(r) : B.near(r);
  }
  content() {
    return T.empty;
  }
...
class Dl {
  ...
  resolve(e) {
    ...
    return re.valid(t) ? new re(t) : B.near(t);
  }
}
function Xy(n) {
...
function Zy() {
  return new X({
    props: {
      ...
      handleClick: tv,
      handleKeyDown: ev,
      handleDOMEvents: { beforeinput: nv }
    }
  });
}
const ev = cl({
...
var Gi = 200, me = function() {
};
me.prototype.append = function(e) {
  return e.length ? (e = me.from(e), !this.length && e || e.length < Gi && this.leafAppend(e) || this.length < Gi && e.leafPrepend(this) || this.appendInner(e)) : this;
};
me.prototype.prepend = function(e) {
  return e.length ? me.from(e).append(this) : this;
};
me.prototype.appendInner = function(e) {
  return new lv(this, e);
};
...
me.from = function(e) {
  return e instanceof me ? e : e && e.length ? new rf(e) : me.empty;
};
var rf = /* @__PURE__ */ function(n) {
  function e(r) {
...
class nt {
  ...
  addTransform(e, t, r, i) {
    ...
    let c = s - r.depth;
    return c > dv && (l = cv(l, c), s -= c), new nt(l.append(o), s);
  }
  remapping(e, t) {
    let r = new Dr();
  ...
  rebased(e, t) {
    ...
    return u.emptyItemCount() > av && (u = u.compress(this.items.length - r.length)), u;
  }
  emptyItemCount() {
    let e = 0;
  ...
  compress(e = this.items.length) {
    ...
    }, this.items.length, 0), new nt(me.from(i.reverse()), o);
  }
}
nt.empty = new nt(me.empty, 0);
function cv(n, e) {
  let t;
...
function uv(n, e, t, r) {
  ...
  t.getMeta(pv) && (n = new zt(n.done, n.undone, null, 0, -1));
  let s = t.getMeta("appendedTransaction");
  if (t.steps.length == 0)
    return n;
  if (s && s.getMeta(kn))
    return s.getMeta(kn).redo ? new zt(n.done.addTransform(t, void 0, r, Ni(e)), n.undone, vc(t.mapping.maps), n.prevTime, n.prevComposition) : new zt(n.done, n.undone.addTransform(t, void 0, r, Ni(e)), null, n.prevTime, n.prevComposition);
  if (t.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !s && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !fv(t, n.prevRanges)), c = s ? es(n.prevRanges, t.mapping) : vc(t.mapping.maps);
    return new zt(n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, Ni(e)), nt.empty, c, t.time, l ?? n.prevComposition);
...
function hv(n, e, t) {
  let r = Ni(e), i = kn.get(e).spec.config, o = (t ? n.undone : n.done).popEvent(e, r);
  if (!o)
    return null;
...
const kn = new se("history"), pv = new se("closeHistory");
function mv(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let r = t.inputType, i = r == "historyUndo" ? sf : r == "historyRedo" ? lf : null;
...
const sf = of(!1, !0), lf = of(!0, !0), gv = ee.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
  ...
  addCommands() {
    return {
      undo: () => ({ state: n, dispatch: e }) => sf(n, e),
      redo: () => ({ state: n, dispatch: e }) => lf(n, e)
    };
  },
  addProseMirrorPlugins() {
    return [
...
}), vv = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, bv = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, wv = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, kv = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, xv = ze.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Sv.name, this.editor.getAttributes(wc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), Av = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, Ov = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, Ev = ze.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addExtensions() {
    ...
    const w = [];
    return this.options.blockquote !== !1 && w.push(nf.configure((n = this.options) === null || n === void 0 ? void 0 : n.blockquote)), this.options.bold !== !1 && w.push(Hy.configure((e = this.options) === null || e === void 0 ? void 0 : e.bold)), this.options.bulletList !== !1 && w.push(Fy.configure((t = this.options) === null || t === void 0 ? void 0 : t.bulletList)), this.options.code !== !1 && w.push(Wy.configure((r = this.options) === null || r === void 0 ? void 0 : r.code)), this.options.codeBlock !== !1 && w.push(Ky.configure((i = this.options) === null || i === void 0 ? void 0 : i.codeBlock)), this.options.document !== !1 && w.push(Uy.configure((o = this.options) === null || o === void 0 ? void 0 : o.document)), this.options.dropcursor !== !1 && w.push(Yy.configure((s = this.options) === null || s === void 0 ? void 0 : s.dropcursor)), this.options.gapcursor !== !1 && w.push(iv.configure((l = this.options) === null || l === void 0 ? void 0 : l.gapcursor)), this.options.hardBreak !== !1 && w.push(ov.configure((a = this.options) === null || a === void 0 ? void 0 : a.hardBreak)), this.options.heading !== !1 && w.push(sv.configure((c = this.options) === null || c === void 0 ? void 0 : c.heading)), this.options.history !== !1 && w.push(gv.configure((d = this.options) === null || d === void 0 ? void 0 : d.history)), this.options.horizontalRule !== !1 && w.push(yv.configure((u = this.options) === null || u === void 0 ? void 0 : u.horizontalRule)), this.options.italic !== !1 && w.push(xv.configure((f = this.options) === null || f === void 0 ? void 0 : f.italic)), this.options.listItem !== !1 && w.push(Cv.configure((h = this.options) === null || h === void 0 ? void 0 : h.listItem)), this.options.orderedList !== !1 && w.push(Mv.configure((p = this.options) === null || p === void 0 ? void 0 : p.orderedList)), this.options.paragraph !== !1 && w.push(Tv.configure((g = this.options) === null || g === void 0 ? void 0 : g.paragraph)), this.options.strike !== !1 && w.push(Ev.configure((m = this.options) === null || m === void 0 ? void 0 : m.strike)), this.options.text !== !1 && w.push(Nv.configure((y = this.options) === null || y === void 0 ? void 0 : y.text)), w;
  }
}), Rv = "ö", Iv = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5تصالات6رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", ir = (n, e) => {
  for (const t in e)
    n[t] = e[t];
  return n;
}, Ls = "numeric", Ps = "ascii", Bs = "alpha", Di = "asciinumeric", vi = "alphanumeric", zs = "domain", af = "emoji", Lv = "scheme", Pv = "slashscheme", xc = "whitespace";
function Bv(n, e) {
  return n in e || (e[n] = []), e[n];
}
function pn(n, e, t) {
  e[Ls] && (e[Di] = !0, e[vi] = !0), e[Ps] && (e[Di] = !0, e[Bs] = !0), e[Di] && (e[vi] = !0), e[Bs] && (e[vi] = !0), e[vi] && (e[zs] = !0), e[af] && (e[zs] = !0);
  for (const r in e) {
    const i = Bv(r, t);
...
Ie.prototype = {
  ...
  tt(n, e, t, r) {
    ...
    const o = e;
    let s, l = i.go(n);
    if (l ? (s = new Ie(), ir(s.j, l.j), s.jr.push.apply(s.jr, l.jr), s.jd = l.jd, s.t = l.t) : s = new Ie(), o) {
      if (r)
        if (s.t && typeof s.t == "string") {
          const a = ir(zv(s.t, r), t);
          pn(o, a, r);
        } else t && pn(o, t, r);
      s.t = o;
    }
...
const R = (n, e, t, r, i) => n.ta(e, t, r, i), Ke = (n, e, t, r, i) => n.tr(e, t, r, i), Cc = (n, e, t, r, i) => n.ts(e, t, r, i), S = (n, e, t, r, i) => n.tt(e, t, r, i), kt = "WORD", Hs = "UWORD", Wr = "LOCALHOST", Vs = "TLD", Fs = "UTLD", Ri = "SCHEME", jn = "SLASH_SCHEME", Rl = "NUM", cf = "WS", Il = "NL", qn = "OPENBRACE", Mr = "OPENBRACKET", Tr = "OPENANGLEBRACKET", Ar = "OPENPAREN", cn = "CLOSEBRACE", Kn = "CLOSEBRACKET", Un = "CLOSEANGLEBRACKET", dn = "CLOSEPAREN", Yi = "AMPERSAND", Xi = "APOSTROPHE", Qi = "ASTERISK", Ht = "AT", Zi = "BACKSLASH", eo = "BACKTICK", to = "CARET", Ft = "COLON", Ll = "COMMA", no = "DOLLAR", st = "DOT", ro = "EQUALS", Pl = "EXCLAMATION", lt = "HYPHEN", io = "PERCENT", oo = "PIPE", so = "PLUS", lo = "POUND", ao = "QUERY", Bl = "QUOTE", zl = "SEMI", at = "SLASH", Or = "TILDE", co = "UNDERSCORE", df = "EMOJI", uo = "SYM";
...
const Hn = /[a-z]/, ns = new RegExp("\\p{L}", "u"), rs = new RegExp("\\p{Emoji}", "u"), is = /\d/, Sc = /\s/, Mc = `
`, Hv = "️", Vv = "‍";
let bi = null, wi = null;
function Fv(n) {
  n === void 0 && (n = []);
  ...
  Ie.groups = e;
  const t = new Ie();
  bi == null && (bi = Tc(Rv)), wi == null && (wi = Tc(Iv)), S(t, "'", Xi), S(t, "{", qn), S(t, "[", Mr), S(t, "<", Tr), S(t, "(", Ar), S(t, "}", cn), S(t, "]", Kn), S(t, ">", Un), S(t, ")", dn), S(t, "&", Yi), S(t, "*", Qi), S(t, "@", Ht), S(t, "`", eo), S(t, "^", to), S(t, ":", Ft), S(t, ",", Ll), S(t, "$", no), S(t, ".", st), S(t, "=", ro), S(t, "!", Pl), S(t, "-", lt), S(t, "%", io), S(t, "|", oo), S(t, "+", so), S(t, "#", lo), S(t, "?", ao), S(t, '"', Bl), S(t, "/", at), S(t, ";", zl), S(t, "~", Or), S(t, "_", co), S(t, "\\", Zi);
  const r = Ke(t, is, Rl, {
    [Ls]: !0
  });
  Ke(r, is, r);
  ...
  pn(Vs, {
    ...
    utld: !0,
    alpha: !0
  }, e), Lt(t, "file", Ri, kt, c), Lt(t, "mailto", Ri, kt, c), Lt(t, "http", jn, kt, c), Lt(t, "https", jn, kt, c), Lt(t, "ftp", jn, kt, c), Lt(t, "ftps", jn, kt, c), pn(Ri, {
    scheme: !0,
    ascii: !0
  }, e), pn(jn, {
    slashscheme: !0,
  ...
  for (let u = 0; u < n.length; u++) {
    ...
    f.indexOf("-") >= 0 ? p[zs] = !0 : Hn.test(f) ? is.test(f) ? p[Di] = !0 : p[Ps] = !0 : p[Ls] = !0, Cc(t, f, f, p);
  }
...
function $v(n, e) {
  const t = jv(e.replace(/[A-Z]/g, (l) => l.toLowerCase())), r = t.length, i = [];
  let o = 0, s = 0;
  for (; s < r; ) {
...
function Hl(n, e) {
  e === void 0 && (e = null);
  let t = ir({}, _r);
  n && (t = ir(t, n instanceof Hl ? n.o : n));
...
ff.prototype = {
  ...
  */
  ...
  render(n) {
    ...
    return s.href = r, l && (s.class = l), a && (s.target = a), c && (s.rel = c), d && ir(s, d), {
      tagName: i,
      attributes: s,
      content: o,
      eventListeners: u
...
function _v(n) {
  ...
  const t = e.domain.concat([Yi, Qi, Ht, Zi, eo, to, no, ro, lt, Rl, io, oo, so, lo, at, uo, Or, co]), r = [Xi, Un, cn, Kn, dn, Ft, Ll, st, Pl, Tr, qn, Mr, Ar, ao, Bl, zl], i = [Yi, Xi, Qi, Zi, eo, to, cn, no, ro, lt, qn, io, oo, so, lo, ao, at, uo, Or, co], o = he(), s = S(o, Or);
  ...
  const v = S(C, Ft), M = he(on);
  R(v, e.numeric, M);
  const b = he(on), O = he();
  R(b, t, b), R(b, r, O), R(O, t, b), R(O, r, O), S(C, at, b), S(M, at, b);
  const A = S(a, Ft), E = S(c, Ft), P = S(E, at), $ = S(P, at);
  R(a, e.domain, l), S(a, st, w), S(a, lt, y), R(c, e.domain, l), S(c, st, w), S(c, lt, y), R(A, e.domain, b), S(A, at, b), R($, e.domain, b), R($, t, b), S($, at, b);
  const j = S(b, qn), W = S(b, Mr), ae = S(b, Tr), Q = S(b, Ar);
  S(O, qn, j), S(O, Mr, W), S(O, Tr, ae), S(O, Ar, Q), S(j, cn, b), S(W, Kn, b), S(ae, Un, b), S(Q, dn, b), S(j, cn, b);
  const U = he(on), J = he(on), F = he(on), le = he(on);
  R(j, t, U), R(W, t, J), R(ae, t, F), R(Q, t, le);
  const ne = he(), Re = he(), fe = he(), We = he();
  return R(j, r), R(W, r), R(ae, r), R(Q, r), R(U, t, U), R(J, t, J), R(F, t, F), R(le, t, le), R(U, r, U), R(J, r, J), R(F, r, F), R(le, r, le), R(ne, t, ne), R(Re, t, J), R(fe, t, F), R(We, t, le), R(ne, r, ne), R(Re, r, Re), R(fe, r, fe), R(We, r, We), S(J, Kn, b), S(F, Un, b), S(le, dn, b), S(U, cn, b), S(Re, Kn, b), S(fe, Un, b), S(We, dn, b), S(ne, dn, b), S(o, Wr, C), S(o, Il, Wv), {
    start: o,
    tokens: uf
  };
}
...
const Kv = typeof console < "u" && console && console.warn || (() => {
}), Uv = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", te = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function Jv() {
  Ie.groups = {}, te.scanner = null, te.parser = null, te.tokenQueue = [], te.pluginQueue = [], te.customSchemes = [], te.initialized = !1;
}
function Nc(n, e) {
  if (e === void 0 && (e = !1), te.initialized && Kv(`linkifyjs: already initialized - will not register custom scheme "${n}" ${Uv}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function Gv() {
  te.scanner = Fv(te.customSchemes);
  for (let n = 0; n < te.tokenQueue.length; n++)
    te.tokenQueue[n][1]({
      scanner: te.scanner
    });
  te.parser = _v(te.scanner.tokens);
...
function hf(n) {
  return te.initialized || Gv(), qv(te.parser.start, n, $v(te.scanner.start, n));
}
function pf(n, e, t) {
...
function Xv(n) {
  return new X({
    ...
    appendTransaction: (e, t, r) => {
      ...
      if (!i || o)
        return;
      const { tr: s } = r, l = s1(t.doc, [...e]);
      if (h1(l).forEach(({ newRange: c }) => {
        const d = a1(r.doc, c, (h) => h.isTextblock);
        let u, f;
    ...
    props: {
      handleClick: (e, t, r) => {
        ...
        if (!l.find((f) => f.nodeName === "A"))
          return !1;
        const a = Nu(e.state, n.type.name), c = r.target, d = (i = c == null ? void 0 : c.href) !== null && i !== void 0 ? i : a.href, u = (o = c == null ? void 0 : c.target) !== null && o !== void 0 ? o : a.target;
  ...
  return new X({
    ...
    props: {
      handlePaste: (e, t, r) => {
        ...
        const a = pf(l).find((c) => c.isLink && c.value === l);
...
const eb = ze.create({
    ...
    return [
      Xt({
        find: (n) => {
          const e = [];
          if (n) {
            const t = pf(n).filter((r) => r.isLink);
  ...
  addProseMirrorPlugins() {
    ...
    })), this.options.openOnClick && n.push(Qv({
      type: this.type,
...
var Y = class xt extends B {
  ...
  getBookmark() {
    return new db(this.$anchorCell.pos, this.$headCell.pos);
  }
};
...
var db = class yf {
  ...
  map(e) {
    return new yf(e.map(this.anchor), e.map(this.head));
  }
  resolve(e) {
...
function pb(n, e, t) {
  ...
  } else r instanceof I && fb(r) ? o = I.create(i, r.from) : r instanceof I && hb(r) && (o = I.create(i, r.$from.start(), r.$from.end()));
  return o && (e || (e = n.tr)).setSelection(o), e;
}
var mb = new se("fix-tables");
function vf(n, e, t, r) {
  ...
  e: for (let s = 0, l = 0; s < o; s++) {
    ...
    r(a, t), l < i && n.child(l).sameMarkup(a) ? vf(n.child(l), a, t + 1, r) : a.nodesBetween(0, a.content.size, r, t + 1), t += a.nodeSize;
  }
}
function bf(n, e) {
  let t;
  const r = (i, o) => {
    i.type.spec.tableRole == "table" && (t = gb(n, i, o, t));
  };
  return e ? e.doc != n.doc && vf(e.doc, n.doc, 0, r) : n.doc.descendants(r), t;
}
function gb(n, e, t, r) {
  const i = ie.get(e);
  ...
  return r.setMeta(mb, { fixTables: !0 });
}
function mt(n) {
  const e = n.selection, t = Eo(n), r = t.node(-1), i = t.start(-1), o = ie.get(r);
  return { ...e instanceof Y ? o.rectBetween(
    e.$anchorCell.pos - i,
    e.$headCell.pos - i
  ) : o.findCell(t.pos - i), tableStart: i, map: o, table: r };
}
function wf(n, { map: e, tableStart: t, table: r }, i) {
  let o = i > 0 ? -1 : 0;
  cb(e, r, i + o) && (o = i == 0 || i == e.width ? null : 0);
...
function bb(n, { map: e, table: t, tableStart: r }, i) {
...
function wb(n, e) {
  ...
  if (e) {
    ...
    for (let i = t.right - 1; bb(r, t, i), i != t.left; i--) {
...
function kf(n, { map: e, tableStart: t, table: r }, i) {
  var o;
  let s = t;
  ...
  for (let c = 0, d = e.width * i; c < e.width; c++, d++)
    if (i > 0 && i < e.height && e.map[d] == e.map[d - e.width]) {
      ...
      const u = a == null ? Se(r.type.schema).cell : (o = r.nodeAt(e.map[d + a * e.width])) == null ? void 0 : o.type, f = u == null ? void 0 : u.createAndFill();
      f && l.push(f);
    }
...
function Tb({ width: n, height: e, map: t }, r) {
...
function Ic(n, e) {
  const t = Se(n.schema);
  return Ab(({ node: r }) => t[r.type.spec.tableRole])(n, e);
}
function Ab(n) {
  return (e, t) => {
    var r;
...
function qr(n, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? Eb(n) : function(t, r) {
    if (!it(t)) return !1;
    if (r) {
      const i = Se(t.schema), o = mt(t), s = t.tr, l = Lc("row", o, i), a = Lc(
        "column",
        o,
        i
...
function Pc(n) {
  return function(e, t) {
    ...
    if (t) {
      ...
      t(
        e.tr.setSelection(I.between(i, ab(i))).scrollIntoView()
      );
    }
    return !0;
  };
...
function Pb({ width: n, height: e, rows: t }, r, i) {
  if (n != r) {
    const o = [], s = [];
...
function Hc(n, e, t, r, i) {
  ...
  Bb(u, s, o, t, c, d, f) && h(), Bc(u, s, o, t, a, c, l, f) && h(), Bc(u, s, o, t, a, c, d, f) && h(), zc(u, s, o, t, l, d, a, f) && h(), zc(u, s, o, t, l, d, c, f) && h();
  for (let p = l; p < d; p++) {
...
function xi(n, e) {
  return (t, r, i) => {
    ...
    {
      const l = t.doc.resolve(s), a = mf(l, n, e);
      let c;
      return a ? c = B.near(a, 1) : e < 0 ? c = B.near(t.doc.resolve(l.before(-1)), -1) : c = B.near(t.doc.resolve(l.after(-1)), 1), Ii(t, r, c);
    }
  };
}
function Ci(n, e) {
...
function Vb(n, e, t) {
  ...
  if (i instanceof Y) {
    ...
    return r = Pb(r, l.right - l.left, l.bottom - l.top), Hc(n.state, n.dispatch, s, l, r), !0;
  } else if (r) {
...
function jb({
  ...
  const o = new X({
    ...
    state: {
      init(s, l) {
        var a, c;
        const d = (c = (a = o.spec) == null ? void 0 : a.props) == null ? void 0 : c.nodeViews, u = Se(l.schema).table.name;
        return r && d && (d[u] = (f, h) => new r(f, t, h)), new Wb(-1, !1);
      },
      apply(s, l) {
        return l.apply(s);
      }
...
var Wb = class Li {
  ...
  apply(e) {
    ...
    if (r && r.setHandle != null)
      return new Li(r.setHandle, !1);
    if (r && r.setDragging !== void 0)
      return new Li(t.activeHandle, r.setDragging);
    if (t.activeHandle > -1 && e.docChanged) {
      let i = e.mapping.map(t.activeHandle, -1);
      return Ws(e.doc.resolve(i)) || (i = -1), new Li(i, t.dragging);
    }
    return t;
  }
};
function _b(n, e, t, r) {
  ...
  if (i && !i.dragging) {
    ...
    if (s != i.activeHandle) {
      if (!r && s !== -1) {
        const l = n.state.doc.resolve(s), a = l.node(-1), c = ie.get(a), d = l.start(-1);
...
function qb(n) {
  ...
  e && e.activeHandle > -1 && !e.dragging && Cf(n, -1);
}
function Kb(n, e, t, r) {
  var i;
  ...
  if (!s || s.activeHandle == -1 || s.dragging)
    return !1;
  const l = n.state.doc.nodeAt(s.activeHandle), a = Ub(n, s.activeHandle, l.attrs);
  n.dispatch(
...
function Ub(n, e, { colspan: t, colwidth: r }) {
...
function Xb(n, e) {
  ...
  if (!o)
    return Z.empty;
  const s = ie.get(o), l = i.start(-1), a = s.colCount(i.pos - l) + i.nodeAfter.attrs.colspan - 1;
...
const Si = ({ editor: n }) => {
  ...
  if (!rw(e))
    return !1;
  let t = 0;
  const r = Eu(e.ranges[0].$from, (o) => o.type.name === "table");
  ...
  renderHTML({ node: n, HTMLAttributes: e }) {
    const { colgroup: t, tableWidth: r, tableMinWidth: i } = ew(n, this.options.cellMinWidth);
    return [
      "table",
      q(this.options.HTMLAttributes, e, {
  ...
  addCommands() {
    return {
      ...
      addColumnBefore: () => ({ state: n, dispatch: e }) => yb(n, e),
      addColumnAfter: () => ({ state: n, dispatch: e }) => vb(n, e),
      deleteColumn: () => ({ state: n, dispatch: e }) => wb(n, e),
      addRowBefore: () => ({ state: n, dispatch: e }) => xb(n, e),
      addRowAfter: () => ({ state: n, dispatch: e }) => Cb(n, e),
      deleteRow: () => ({ state: n, dispatch: e }) => Mb(n, e),
      deleteTable: () => ({ state: n, dispatch: e }) => Rb(n, e),
      ...
      toggleHeaderCell: () => ({ state: n, dispatch: e }) => Nb(n, e),
      ...
      fixTables: () => ({ state: n, dispatch: e }) => (e && bf(n), !0),
...
}), uw = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, fw = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, hw = ze.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
...
}, ww = function({ view: n, dir: e, currentResolved: t }) {
  if (!t)
    return !1;
  let r = n.state.tr;
  const i = e === "DOWN", o = t.node(1) || t.nodeAfter, s = 0, l = t.node(s), a = t.start(s), c = Sf(l, (m) => m);
  let d = c.indexOf(o);
  if (d == -1)
    return !1;
  let u = i ? d + 1 : d - 1;
...
function Mf(n, e) {
  if (as(n) && as(e))
    for (const t in e)
      as(e[t]) ? (n[t] || Object.assign(n, { [t]: {} }), Mf(n[t], e[t])) : kw(e[t]) ? (n[t] || (n[t] = []), Ks(n[t], e[t])) : Object.assign(n, { [t]: e[t] });
  return n;
}
const Ks = function(n, e) {
  return e.forEach((t, r) => {
    !n || !n.find((i) => i.name == t.name) ? n.push(t) : Mf(
...
}), Cw = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/, Sw = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/g, Mw = (n) => n.match(Cw), qc = (n) => n ? "https://www.youtube-nocookie.com/embed/" : "https://www.youtube.com/embed/", Tw = (n) => {
  const {
    url: e,
    allowFullscreen: t,
    autoplay: r,
  ...
  addCommands() {
    return {
      setYoutubeVideo: (n) => ({ commands: e }) => Mw(n.src) ? e.insertContent({
        type: this.name,
        attrs: n
      }) : !1
    };
...
function Dw(n) {
  var e;
  const { char: t, allowSpaces: r, allowedPrefixes: i, startOfLine: o, $position: s } = n, l = U1(t), a = new RegExp(`\\s${l}$`), c = o ? "^" : "", d = r ? new RegExp(`${c}${l}.*?(?=\\s${l}|$)`, "gm") : new RegExp(`${c}(?:^)?${l}[^\\s${l}]*`, "gm"), u = ((e = s.nodeBefore) === null || e === void 0 ? void 0 : e.isText) && s.nodeBefore.text;
  if (!u)
    return null;
...
const Rw = new se("suggestion");
function Iw({ pluginKey: n = Rw, editor: e, char: t = "@", allowSpaces: r = !1, allowedPrefixes: i = [" "], startOfLine: o = !1, decorationTag: s = "span", decorationClass: l = "suggestion", command: a = () => null, items: c = () => [], render: d = () => ({}), allow: u = () => !0, findSuggestionMatch: f = Dw }) {
  let h;
  const p = d == null ? void 0 : d(), g = new X({
    ...
    view() {
      return {
        update: async (m, y) => {
          var w, C, v, M, b, O, A;
          const E = (w = this.key) === null || w === void 0 ? void 0 : w.getState(y), P = (C = this.key) === null || C === void 0 ? void 0 : C.getState(m.state), $ = E.active && P.active && E.range.from !== P.range.from, j = !E.active && P.active, W = E.active && !P.active, ae = !j && !W && E.query !== P.query, Q = j || $, U = ae && !$, J = W || $;
          if (!Q && !U && !J)
            return;
          const F = J && !Q ? E : P, le = m.dom.querySelector(`[data-decoration-id="${F.decorationId}"]`);
          h = {
            editor: e,
            range: F.range,
            query: F.query,
            ...
            clientRect: le ? () => {
              var ne;
              const { decorationId: Re } = (ne = this.key) === null || ne === void 0 ? void 0 : ne.getState(e.state), fe = m.dom.querySelector(`[data-decoration-id="${Re}"]`);
    ...
    state: {
      ...
      apply(m, y, w, C) {
        ...
        if (E.composing = M, v && (O || e.view.composing)) {
          ...
          P && u({ editor: e, state: C, range: P.range }) ? (E.active = !0, E.decorationId = y.decorationId ? y.decorationId : $, E.range = P.range, E.query = P.query, E.text = P.text) : E.active = !1;
        } else
          E.active = !1;
...
const Vw = {
  ...
  data() {
    return {
      ...
      editor: null,
      allBlockTools: Ks(Lw(), this.blockTools),
      allInlineTools: Ks(Pw(), this.inlineTools),
      allAlignmentTools: this.alignmentTools.length ? this.alignmentTools : Bw(),
      tableRowTools: zw(),
      tableColumnTools: Hw(),
  ...
  mounted() {
    this.editor = new Dy({
      extensions: [
        ...
        dw,
        hw,
        mw.configure({ inline: !1, allowBase64: !1 }),
        // Commands.configure({
  ...
  methods: {
    ...
    async handleFileInput(n) {
      ...
      if (e && this.onImageSelected) {
        let r = await this.onImageSelected(e, this.editor);
        alert("uploaded", r), r && this.editor.chain().focus().setImage({ src: r }).run();
      }
    },
    handleTyping() {
    ...
    getMenuCoords() {
      return gw(this.editor.view);
    },
    getTableRowMenuCoords() {
      return yw(this.editor.view);
    },
    getTableColumnMenuCoords() {
      return vw(this.editor.view);
    },
    startDragging(n) {
...
}, Fw = { class: "gutentap" }, $w = { class: "flex flex-row" }, jw = /* @__PURE__ */ ve("svg", {
  width: "24",
  height: "24",
  ...
  /* @__PURE__ */ ve("path", { d: "M8 7h2V5H8v2zm0 6h2v-2H8v2zm0 6h2v-2H8v2zm6-14v2h2V5h-2zm0 8h2v-2h-2v2zm0 6h2v-2h-2v2z" })
], -1), Ww = [
  jw
], _w = {
  key: 0,
  class: "py-1 md:py-2 group relative"
}, qw = /* @__PURE__ */ ve("div", { class: "p-3 uppercase text-gray-600 text-xs pb-1 tracking-wide" }, " Transform to ", -1), Kw = {
  key: 1,
  class: "pr-2 flex flex-col"
}, Uw = ["disabled"], Jw = /* @__PURE__ */ ve("svg", {
  width: "24",
  height: "24",
  ...
  /* @__PURE__ */ ve("path", { d: "M6.5 12.4L12 8l5.5 4.4-.9 1.2L12 10l-4.5 3.6-1-1.2z" })
], -1), Gw = [
  Jw
], Yw = ["disabled"], Xw = /* @__PURE__ */ ve("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "24",
  height: "24",
  fill: "currentColor",
  ...
  /* @__PURE__ */ ve("path", { d: "M17.5 11.6 12 16l-5.5-4.4.9-1.2L12 14l4.5-3.6 1 1.2z" })
], -1), Qw = [
  Xw
], Zw = {
  key: 0,
  class: "flex gap-1 items-center hide-empty flex-row p-1 md:p-2"
}, e2 = ["disabled"], t2 = /* @__PURE__ */ ve("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  ...
  /* @__PURE__ */ ve("path", { d: "m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" })
], -1), n2 = [
  t2
], r2 = {
  key: 1,
...
function l2(n, e, t, r, i, o) {
  ...
  return _(), ce("div", Fw, [
    i.editor && i.tableRowTools ? (_(), et(c, {
      key: 0,
      editor: i.editor,
      ...
      default: Ae(() => [
        qe(a, null, {
          dropdown: Ae(() => [
            (_(!0), ce(Rt, null, It(i.tableRowTools, (u) => (_(), et(l, {
              innerHTML: u.icon + " " + u.title,
              key: u.title,
              label: u.title,
              onClick: Oe((f) => u.command(i.editor), ["prevent"])
    ...
    i.editor && i.tableColumnTools ? (_(), et(c, {
      key: 1,
      editor: i.editor,
      ...
      default: Ae(() => [
        qe(a, null, {
          dropdown: Ae(() => [
            (_(!0), ce(Rt, null, It(i.tableColumnTools, (u) => (_(), et(l, {
    ...
    i.editor ? (_(), et(c, {
      ...
      class: un(["text-sm bg-white max-w-screen flex divide-x max-w-full divide-slate-400 flex-row border-slate-400 md:rounded border-t md:border", {
        ...
        return [
          ve("div", $w, [
            ve("button", {
              ...
              class: un(["hidden md:block ml-1 my-2 hover:bg-slate-100 rounded", {
            ...
            !i.dragging && i.currentBlockTool ? (_(), ce("div", _w, [
              qe(a, null, Ff({
                default: Ae(() => {
                  var m, y, w;
                  return [
                ...
                (u = i.currentBlockTool) != null && u.canBeConverted ? {
                  ...
                  fn: Ae(() => [
                    qw,
                    (_(!0), ce(Rt, null, It(i.allBlockTools.filter(
                      (m) => m.convertCommand
                    ), (m) => (_(), et(l, {
                      content: m.icon + " " + m.title,
                      key: m.title,
                      label: m.title,
                      onClick: Oe((y) => m.convertCommand(i.editor), ["prevent"]),
                      activeClass: "hidden",
            ...
            i.dragging ? tt("", !0) : (_(), ce("div", Kw, [
              ve("button", {
                onClick: e[4] || (e[4] = Oe((m) => o.moveNode("UP"), ["prevent"])),
                disabled: !o.canMoveNodeUp(),
                "data-tooltip": "Move up",
                class: "mt-1 md:mt-2"
              }, Gw, 8, Uw),
              ve("button", {
                onClick: e[5] || (e[5] = Oe((m) => o.moveNode("DOWN"), ["prevent"])),
          ...
          i.dragging ? tt("", !0) : (_(), ce("div", Zw, [
            ve("button", {
              onClick: e[6] || (e[6] = Oe((...m) => o.triggerImagePicker && o.triggerImagePicker(...m), ["prevent"])),
              disabled: !i.editor,
          ...
          i.dragging ? tt("", !0) : (_(), ce("div", r2, [
            (_(!0), ce(Rt, null, It(o.activeAlignmentTools, (m, y) => (_(), et(a, { key: y }, {
              dropdown: Ae(() => [
                (_(!0), ce(Rt, null, It(m, (w) => (_(), et(l, {
                  key: w.title,
                  content: w.icon + " " + w.title,
                  label: w.title,
                  onClick: Oe((C) => w.command(i.editor), ["prevent"]),
          ...
          !i.dragging && ((h = (f = i.currentBlockTool) == null ? void 0 : f.tools) != null && h.length) ? (_(), ce("div", i2, [
            (_(!0), ce(Rt, null, It((p = i.currentBlockTool) == null ? void 0 : p.tools, (m) => {
              var y, w;
              return _(), et(s, {
                key: m.name,
                content: m.icon,
                ...
                onClick: Oe((C) => m.command.call(0, i.editor), ["prevent"]),
          ...
          (g = i.currentBlockTool) != null && g.hasInlineTools && !i.dragging ? (_(), ce("div", o2, [
            (_(!0), ce(Rt, null, It(i.allInlineTools, (m) => (_(), et(a, {
              align: "right",
              key: m.title
            }, {
              dropdown: Ae(() => [
                (_(!0), ce(Rt, null, It(m.tools, (y) => (_(), et(l, {
                  key: y.name,
                  content: y.icon + " " + y.title,
                  onClick: Oe((w) => y.command(i.editor), ["prevent"]),
              ...
              default: Ae(() => [
                qe(s, {
                  ...
                  label: m.title,
                  activeClass: m.isActiveClass,
                  onClick: Oe((y) => m.command(i.editor), ["prevent"]),
                  active: m.isActiveTest(i.editor)
          ...
          i.editor && i.editor.can().deleteNode(i.topLevelNodeType) && !i.dragging ? (_(), ce("div", s2, [
            qe(a, { align: "right" }, {
              dropdown: Ae(() => [
                qe(l, {
                  ref: "deleteButton",
                  ...
                  label: "Delete block",
                  onClick: e[10] || (e[10] = Oe((m) => o.deleteNode(i.topLevelNodeType), ["prevent"]))
                }, null, 8, ["content"])
              ]),
              default: Ae(() => [
                qe(s, {
    ...
    qe(d, {
      class: un(t.editorClass ?? "prose"),
      onKeydown: o.handleTyping,
      onKeyup: e[12] || (e[12] = $f((u) => i.isTyping = !1, ["esc"])),
      ref: "editor",
      editor: i.editor
    }, null, 8, ["class", "onKeydown", "editor"])
  ]);
}
const a2 = /* @__PURE__ */ fo(Vw, [["render", l2]]), f2 = a2;
export {
  f2 as GutenTap
};
